...
fx = {
	...
	property_20 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/ION_BEAM/ION_BEAM_KPR_GLOW_BALL.TGA"},
	property_12 = {name = "Duration", type = "VARTYPE_FLOAT", value = 4}, --was 0.25
	property_00 = {name = "Radius", type = "VARTYPE_ARRAY_TIMEFLOAT", value = { 0,0,0.1,6, 0.76525, 5, 0.8375, 4, 0.86375, 0, 1, 0, }, }, 
