...
fx = {
	...
	property_05 = {name = "Colour", type = "VARTYPE_ARRAY_TIMECOLOUR", value = {entry_00 = {0, 0.5, 0.5, 0.5, 0.5}, entry_01 = {1, 0, 0, 0, 0},},},
	...
	property_20 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/CLOUDS/MASSIVE_FIRE_SPHERE_RING_SOFT.TGA"}, --MUZZLE_FLASHES/BIG_FLASH_WHITE.TGA
	property_12 = {name = "Duration", type = "VARTYPE_FLOAT", value = 2}, --was 0.25
	property_00 = {name = "Radius", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 15, 0.15, 35, 1, 0},}, --was 7 initially
