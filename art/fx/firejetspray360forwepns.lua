...
fx = {
	...
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0,80, 0.1725, 80, 0.18, 0, 1, 0},},
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "firejet"},
	property_14 = {name = "Particle_Dynamics", type = "VARTYPE_INT", value = 0},
	property_11 = {name = "Particle_Speed", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 7, 1, 7},},
	property_12 = {name = "Emitter_RotRate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 0, 1, 0},},
	property_00 = {name = "Emitter_Duration", type = "VARTYPE_FLOAT", value = 0.5}, --was 1
