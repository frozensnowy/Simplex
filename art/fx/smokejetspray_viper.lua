...
fx = {
	...
	property_16 = {name = "Particle_Scale", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0,9, 1, 9},},
	...
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0,350, 0.225, 0, 1, 0},},
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "smokejet_viper"},
	property_14 = {name = "Particle_Dynamics", type = "VARTYPE_INT", value = 0},
	property_11 = {name = "Particle_Speed", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 5*1.86667, 1, 5*0.1},},
