...
fx = {
	...
	property_20 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/MAC/TEXTURES/FIRE_SMOKE.TGA"},
	property_12 = {name = "Duration", type = "VARTYPE_FLOAT", value = 3},
	property_00 = {name = "Radius", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 14.6667, 1, 37.3333},},
