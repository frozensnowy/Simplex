fx = {
	...
	property_20 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/MAC/TEXTURES/FIERY_HEAD_RING_WHITE.TGA"},
	property_12 = {name = "Duration", type = "VARTYPE_FLOAT", value = 1.2},
	property_00 = {name = "Radius", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 5.86, 0.01375, 11.35, 0.05001, 17.47, 0.12625, 21.07, 0.62375, 25.6, 1, 34.54},},
