...
--For some reason this fucking piece of shit no longer works. Enable it in flaregunhit_combo and it will fill the entire gameworld. -\(o_o)/-
fx = {
	...
	property_05 = {name = "Colour", type = "VARTYPE_ARRAY_TIMECOLOUR", value = {entry_00 = {0, 0.3, 1, 0.2, 1}, entry_01 = {1, 0, 0, 0, 0},},},
	...
	property_20 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/PROJECTILES/greendrip.tga"},
	property_12 = {name = "Duration", type = "VARTYPE_FLOAT", value = 0.75}, --was 0.25
	property_00 = {name = "Radius", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 3, 0.4, 9, 1, 0},}, --was 7 initially
