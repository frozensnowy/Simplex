...
fx = {
	...
	property_24 = {name = "BirthSpawn_Fx", type = "VARTYPE_STRING", value = ""}, --superenergycannonsteam is a bit too noisy for now
	property_23 = {name = "Spawn_Fx", type = "VARTYPE_STRING", value = ""},
	property_22 = {name = "Mesh", type = "VARTYPE_STRING", value = "Data:art/fx/box.hod"},
	property_21 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/ZEROG_EXPLOSIONS/ZEROG5.ANIM"}, --DATA:ART/FX/ZEROG_EXPLOSIONS/ZEROG5.ANIM
	...
	property_05 = {name = "Colour", type = "VARTYPE_ARRAY_TIMECOLOUR", value = {entry_02 = {1, 0, 0, 0, 0}, entry_00 = {0, 0.3, 0.4, 0.3, 0.5}, entry_01 = {0.22239, 0.18, 0.24, 0.18, 0.25},},},
