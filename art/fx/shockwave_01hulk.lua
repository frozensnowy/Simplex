fx = {
	...
	property_23 = {name = "BirthSpawn_Fx", type = "VARTYPE_STRING", value = "repair_spark_combo"},	--muzzle_spittle_spray
	...
	property_21 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/shockwave/shockwave01hulk.ANIM"},
	property_12 = {name = "Duration", type = "VARTYPE_FLOAT", value = 3.26},
	property_00 = {name = "Radius", type = "VARTYPE_ARRAY_TIMEFLOAT", value = 
	{0, 3,  
	1, 3},},
