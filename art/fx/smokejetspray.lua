...
fx = {
	...
	property_16 = {name = "Particle_Scale", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 1.2, 1, 1.2},},
	...
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0,64, 0.1725, 0, 1, 0},},
