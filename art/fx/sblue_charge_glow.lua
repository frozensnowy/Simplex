fx = {
	...
	property_21 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/Beam_Charge/BIG_FLASH_RING_Blue.TGA"},
	...
	property_12 = {name = "Duration", type = "VARTYPE_FLOAT", value = 9.65},
