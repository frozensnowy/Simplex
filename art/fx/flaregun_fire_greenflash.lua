...
fx = {
	...
	property_12 = {name = "Duration", type = "VARTYPE_FLOAT", value = 0.4}, --was 0.25
	property_00 = {name = "Radius", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 6, 0.4, 9, 1, 0},}, --was 7 initially
