...
{ 
    ...
    { 
        ...
        { 
            ...
            value = 
                { 0, 30*0.275, 0.5, 30*0.3, 1, 30*0.085, }, },  --the entire effect is entity scaled for a higaaran assault frigate. We'll see how that holds up.
        property_15 = 
        { 
        ...
        { 
            ...
            type = "VARTYPE_ARRAY_TIMEFLOAT", 
            value = 
                { 0, 18, 0.2, 0, 1, 0, }, }, --emitter rate tweaks shouldn't change the timeframe
        property_05 = 
        { 
            name = "Emitter_Drag", 
            type = "VARTYPE_FLOAT", 
        ...
        { 
            name = "Particle_Fx", 
            type = "VARTYPE_STRING", 
            value = "explosionjetparticle_railgun", }, 
        property_14 = 
        { 
