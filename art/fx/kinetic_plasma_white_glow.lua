...
fx = {
	...
	property_20 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/MUZZLE_FLASHES/big_flash_smoke.TGA"},		--"DATA:ART/FX/MUZZLE_FLASHES/BIG_FLASH.TGA"},
	property_12 = {name = "Duration", type = "VARTYPE_FLOAT", value = 5},
	property_00 = {name = "Radius", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 12, 1, 12},},		--{0, 8, 1, 8},},
