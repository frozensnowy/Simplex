...
fx = {
	...
	property_20 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/MOD/NAVWHITE.DDS"},
	property_12 = {name = "Duration", type = "VARTYPE_FLOAT", value = 5}, --was 0.25
	property_00 = {name = "Radius", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 5, 0.02, 0, 0.1, 5, 0.12, 0, 1, 0},}, --two tenth-second pulses per five seconds, ideally. may double length.
