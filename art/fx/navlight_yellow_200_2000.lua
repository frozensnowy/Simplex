fx = {
	...
	property_21 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/navlights/Yellow_Glow.tga"},
	...
	property_02 = {name = "SpinX", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 0.5, 1, 0.5},},
	...
	property_12 = {name = "Duration", type = "VARTYPE_FLOAT", value = 2.2},
