...
fx = {
	...
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 200, 1, 200},},
	property_05 = {name = "Emitter_Drag", type = "VARTYPE_FLOAT", value = 0.875}, --was 0.75, let's slow down the slowing down
	property_08 = {name = "Emitter_Deviation", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 90, 1, 90},},
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "flarespark"}, --DMG_CLOUD_EXPLOSION_CLOUD_RING
	property_14 = {name = "Particle_Dynamics", type = "VARTYPE_INT", value = 0},
	property_11 = {name = "Particle_Speed", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 120, 1, 120},},
	property_12 = {name = "Emitter_RotRate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 0, 1, 0},},
	property_00 = {name = "Emitter_Duration", type = "VARTYPE_FLOAT", value = 5}, --was 1
