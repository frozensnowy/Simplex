...
fx = {
	...
	property_01 = {name = "Offset", type = "VARTYPE_ARRAY_TIMEVECTOR3", value = {entry_00 = {0, 0, 0, 200}, entry_01 = {1, 0, 0, 200},},},
	property_13 = {name = "UseMesh", type = "VARTYPE_BOOL", value = 0},
	property_14 = {name = "UseDepthTest", type = "VARTYPE_BOOL", value = 0},
	property_20 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/MUZZLE_FLASHES/big_flash_plasma.TGA"},
	property_12 = {name = "Duration", type = "VARTYPE_FLOAT", value = 5},
	property_00 = {name = "Radius", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 160, 1, 160},},		--{0, 8, 1, 8},},
