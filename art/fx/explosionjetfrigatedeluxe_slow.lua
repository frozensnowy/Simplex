...
{ 
    ...
    { 
        ...
        { 
            ...
            value = 
                { 0, 0.03*0.275, 0.5, 0.03*0.3, 1, 0.03*0.085, }, },  --the entire effect is entity scaled for a higaaran assault frigate. We'll see how that holds up.
        property_15 = 
        { 
        ...
        { 
            ...
            type = "VARTYPE_ARRAY_TIMEFLOAT", 
            value = 
                { 0, 100, 0.2, 50, 1, 0, }, }, --emitter rate tweaks shouldn't change the timeframe
        property_05 = 
        { 
            name = "Emitter_Drag", 
            type = "VARTYPE_FLOAT", 
        ...
        { 
            name = "Particle_Fx", 
            type = "VARTYPE_STRING", 
            value = "explosionjetfrigateparticledeluxe_slow", }, 
        property_14 = 
        { 
