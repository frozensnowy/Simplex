...
--basic colours
FriendlyColour = {0,1,0,0.67}	--{0,1,0,1.0}
AlliedColour = {1,1,0,0.67}	--{1,1,0,1.0}
EnemyColour = {1,0,0,0.67}	--{1,0,0,1.0}
ResourceTOColour = {1,1,1,0.67}	--{1,1,1,1.0}
Procedural = {0,0,0,0}
...
friendlies =
{
    colourNear       		= {0.5, 0.5, 0.5, 0.5}, --{0.008, 0.2, 1.0, 1.0}, --{0, 0.2, 0.78, 1.0},
    colourFar        		= {0.25, 0.25, 0.25, 0.5}, --{0, 0.0274, 0.25, 1.0}, --{0, 0, .18, 1.0},
    colourMouseOverNear     = {0.5, 0.5, 0.5, 0.5},	--{0.008, 0.2, 1.0, 1.0}, --{0, 0.2, 0.78, 1.0},
    colourMouseOverFar      = {0.25, 0.25, 0.25, 0.5}, --{0, 0.0274, 0.25, 1.0}, --{0, 0, .18, 1.0},
    colourFootNear          = {0.5, 0.5, 0.5, 0.5}, --{0.38, 0.45, 1, 1}, --{0, 0, 1, 1},
    colourFootFar           = {0.25, 0.25, 0.2, 0.5}, --{0.38, 0.45, 1, 1}, -- {0, 0, .5, 1},
    colourMouseOverFootNear = {0.5, 0.5, 0.5, 0.5}, --{0,1,1,1}, -- {1,1,0,1},
    colourMouseOverFootFar  = {0.25, 0.25, 0.2, 0.5}, --{0,1,1,1}, --{0.6,0.6,0,1},
    colourEquatorNear       = {1, 1, 1, 0.67}, --{0.38, 0.45, 1, 1}, --{0, 1, 1, 1},
    colourEquatorFar        = {1, 1, 1, 0.25}, --{0.38, 0.45, 1, 1}, --{0, 1, 1, 1},
    equatorScale            = 0.98,
    protrude                = 0.40,
    borderPadding           = 200,
...
allies =
{
    colourNear       		= {0.5, 0.5, 0.4, 0.5}, --{0.008, 0.2, 1.0, 1.0}, --{0, 0.2, 0.78, 1.0},
    colourFar        		= {0.25, 0.25, 0.2, 0.5}, --{0, 0.0274, 0.25, 1.0}, --{0, 0, .18, 1.0},
    colourMouseOverNear     = {0.5, 0.5, 0.4, 0.5},	--{0.008, 0.2, 1.0, 1.0}, --{0, 0.2, 0.78, 1.0},
    colourMouseOverFar      = {0.25, 0.25, 0.2, 0.5}, --{0, 0.0274, 0.25, 1.0}, --{0, 0, .18, 1.0},
    colourFootNear          = {0.5, 0.5, 0.4, 0.5}, --{0.38, 0.45, 1, 1}, --{0, 0, 1, 1},
    colourFootFar           = {0.25, 0.25, 0.2, 0.5}, --{0.38, 0.45, 1, 1}, -- {0, 0, .5, 1},
    colourMouseOverFootNear = {0.5, 0.5, 0.4, 0.5}, --{0,1,1,1}, -- {1,1,0,1},
    colourMouseOverFootFar  = {0.25, 0.25, 0.2, 0.5}, --{0,1,1,1}, --{0.6,0.6,0,1},
    colourEquatorNear       = {1, 1, 0.8, 0.67}, --{0.38, 0.45, 1, 1}, --{0, 1, 1, 1},
    colourEquatorFar        = {1, 1, 0.8, 0.25}, --{0.38, 0.45, 1, 1}, --{0, 1, 1, 1},
    equatorScale            = 0.98,
    protrude                = 0.40,
    borderPadding           = 200,
    metaSelPriority         = NoPriority,
...
resources =
{
    colourNear       		= {1, 1, 1, 0.5},	--{0.55, 0.29, 0.03, 0.5},
    colourFar        		= {1, 1, 1, 0.2},	--{0.55, 0.29, 0.03, 0.2},
    colourMouseOverNear     = {1, 1, 1, 0.8},	--{0.55, 0.29, 0.03, 1.0}, -- {1,1,1,0.35},
    colourMouseOverFar      = {1, 1, 1, 0.8},	--{0.55, 0.29, 0.03, 1.0},--{.8, .8, .8, 0.35},
    colourFootNear          = {1, 1, 1, 0.8},	--{0.55, 0.29, 0.03, 1.0}, --{0.55, 0.29, 0.03, 1.0},
    colourFootFar           = {1, 1, 1, 0.5},	--{0.55, 0.29, 0.03, 0.5}, --{0.55, 0.29, 0.03, 0.5},
