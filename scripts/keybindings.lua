...
keys = 
    ...
    { 
        ...
        { 113, eShiftModifier, INKE_KeyDown, INKE_KeyDown, "$5401", 
            { keyAddModifier, }, 
        }, 
        { 114, eShiftModifier, INKE_KeyUp, INKE_KeyUp, "$5402", 
            { keyAddModifier, }, 
        }, 
        ...
        { 137, "UI_ToggleScreenGameRubrick( 'InGameMenu', 'ObjectivesList', 0, gr_all)", INKE_KeyDown, 0, "$5423", 	--gr_campaign
            { OKEY, }, 
        }, 
        ...
        { 141, "UI_ToggleScreenGameRubrick( 'InGameMenu', 'DiplomacyScreen', 0, gr_all)", INKE_KeyDown, 0, "$5427", 	--gr_multiplayer
            { KKEY, }, 
        }, 
        { 142, "UI_ToggleScreenGameRubrick( 'InGameMenu', 'SpeechRecall', 0, gr_all)", INKE_KeyDown, 0, "$5428", 		--gr_campaign
            { CONTROLKEY, KKEY, }, 
        }, 
    ...
    { 146, "UI_ToggleScreenGameRubrick( 'InGameMenu','UnitCapInfoPopup1', 0, gr_all)", INKE_KeyDown, 0, "$5434", 		--"MainUI_UserEventData2( eSpecialAttack, 0, 2)"
        { EKEY, }, 
    , 
