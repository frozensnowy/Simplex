...
function repairingExecute(number, numberIndex, Group, distance) 
  if number > 0 then                 
	  for i = 0,number-1,1 do   
	    if SobGroup_AreAnyOfTheseTypes(Group..i, "hgn_mothership, hgn_shipyard, hgn_shipyard_elohim, hgn_battleshipyard, hgn_shipyard_g, hgn_commandfortress, hgn_tanker, vgr_shipyard, vgr_mothership_makaan, vgr_mothership, vgr_heavycruiser, vgr_commandfortress") == 1 then
