--
GameRulesName = "Simplex Tactical"
Description = "This game mode highlights unique starting fleets for stylish tactical match! Lots of ships and lots of KABOOMs, along with lots of fun!" 
Directories =
{
...
---STARTING FLEET--------------------
  {
   ...
   tooltip = "CHOOSE WHAT SHIPS YOU WANT TO MESS AROUND WITH (Default: Builder)",
   default = 0,		--3
   visible = 1,
   choices =
   {
    ...
    "Frigates",  "102", 
    "Destroyers",  "103",
    "Capital Army Group",  "104",
    "Carrier Battle Group",  "105",
    "Exotic",  "106",
   },
  },    
---STARTING HONOUR-------------
