...
function SetupTerritoryTables()
	...
	--child territories
	Territories[26] = { 13, { 0, 3000, 0 }, RESOURCE_ONLY, 1000 }
	Territories[27] = { 13, { 0, -3000, 0 }, RESOURCE_ONLY, 1000 }	
	
	
	
	
	--temp
	--ChangeTerritoryValues(BUILDTYPE, {5}, RESOURCE_ONLY)
