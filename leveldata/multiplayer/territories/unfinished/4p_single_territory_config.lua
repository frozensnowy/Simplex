...
AuditMap = 1 --INFORMATION ABOUT THE MAP WILL BE PRINTED OUT (Possible values: 1 or 2, for level of detail)
...
function SetupTerritoryTables()
	...
	Territories[1] = { PARENT, { 0, 0, 0 }, EMPTY, 0, 50000 }
	
	Territories[2] = { 1, { 35000, 0, 0 }, FIGHTER, 500 }
	Territories[3] = { 1, { -35000, 0, 0 }, FIGHTER, 500 }
	Territories[4] = { 1, { 0, 0, 35000 }, FIGHTER, 500 }
	Territories[5] = { 1, { 0, 0, -35000 }, FIGHTER, 500 }
	...
	PlayerStartTerritories[0] = 2
	PlayerStartTerritories[1] = 4
	PlayerStartTerritories[2] = 3
	PlayerStartTerritories[3] = 5
