--
GameRulesName = "Complex Evolution"
Description = "Explore, survive, evolve, fight and defend your race through the Solar System, extremly slow and tactical, based on planet management" 
Directories =
{
  Levels = "data:LevelData\\Multiplayer\\complexevolutionlevels\\",  
}
---GAME SETUP----------------------------------------------------------------------------------------------
GameSetupOptions =
{
...
---STARTING FLEET--------------------
  {
   ...
   tooltip = "CHOOSE THE NUMBER OF STARTING SHIPS, FEW SHIPS CAUSE A TACTICAL MATCH (Default: Mothership, 3 Collectors)",
   default = 7,
   visible = 0,   
   choices =
   {
...
---AI--------------------------
  {
   name = "aiaids",
   locName = "AI Aids",
   tooltip = "CHOOSE THE FREQUENCY OF ARTIFICIAL INTELLIGENT AIDS, FEW AIDS CAUSE A TACTICAL MATCH (Default: None)",
   default = 1,
   visible = 0,
   choices =
   {
