--
GameRulesName = "<c=c2c2c2>Simplex</c> <c=c2c2c2>Normal</c>"
Description = "Settings are fixed for a balanced match, suitable for most noobs" 
Directories =
{
...
---AI--------------------------
  {
   name = "aiaids",
   locName = "AI Humdrum",
   tooltip = "CHOOSE THE BORINGNESS OF ARTIFICIAL INTELLIGENT, FEW BORINGNESS CAUSE A TACTICAL MATCH (Default: Normal)",
   default = 1,
   visible = 0,
   choices =
   {
