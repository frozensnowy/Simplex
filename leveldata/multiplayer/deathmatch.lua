--
GameRulesName = "Simplex Custom"
Description = "You can set your game parameters as you want, default settings cause a balanced match" 
Directories =
{
...
---STARTING FLEET--------------------
  {
   ...
   tooltip = "CHOOSE FLEET ON START, THIS WILL DETERMINE PLAY STYLE AS WELL (Default: Standard)",
   default = 4,
   visible = 1,
   choices =
   {
