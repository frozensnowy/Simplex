GameRulesName="<c=c2c2c2>Simplex</c> <c=c2c2c2>Screensaver</c>"
Description = "Settings are fixed to minimize CPU and GPU use in a prolonged game, specifically designed to kill boringness when you have other programs running in the background..." 
Directories =
{
...
---AI--------------------------
  {
   name = "aiaids",
   locName = "AI Humdrum",
   tooltip = "CHOOSE THE BORINGNESS OF ARTIFICIAL INTELLIGENT, FEW BORINGNESS CAUSE A TACTICAL MATCH (Default: High)",
   default = 1,
   visible = 0,
   choices =
   {
