  ...
  survival_wavecount = GetGameSettingAsNumber("survival_wavecount")
    ...
    --starting collectors
        ...
        Rule_AddInterval("buildonstartextra", 35) --ok				
		  ...
		  elseif startwith == 101 then
		    SetStartFleetSuffix("t_strike")
		  elseif startwith == 102 then
		    SetStartFleetSuffix("t_frigate")
		  elseif startwith == 103 then
		    SetStartFleetSuffix("t_destroyer")
		  elseif startwith == 104 then
		    SetStartFleetSuffix("t_capital")
		  elseif startwith == 105 then
		    SetStartFleetSuffix("t_carrier")
		  elseif startwith == 106 then
		    SetStartFleetSuffix("t_exotic")
		  end
