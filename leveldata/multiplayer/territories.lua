...
--Territories Mod for Homeworld 2
--scripted by Jeff McConville, 2006


GameRulesName = "Simplex Territories"
Description = "The map is divided into territories and you can only move from one territory to another using existing jump gates. To function properly, CPU 4 and CPU 5 mustn't occupy any existing start location"


Directories =
{
    Levels = "data:LevelData/Multiplayer/territories/",
}



dofilepath("Data:leveldata/multiplayer/territories/territories_common.lua")
dofilepath("Data:leveldata/multiplayer/territories/territories_options.lua")
dofilepath("data:leveldata/multiplayer/lib/TerritoryMod.lua")
dofilepath("Data:ai/territories_cpu_military.lua")
dofilepath("Data:ai/territories_cpu_build.lua")
...
--*********** GLOBAL VARIABLES ***********
LevelName = ""
gGameTime = 0 --variable to store the game time (not the same as Universe_GameTime)
gWorldBounds = {}
gGameRubric = 0
gWinCondition = 0
gFogOfWarSetting = ""
gShieldSetting = ""
gBuildSpeedSetting = 0
gMaxHealthMultiplier = 0
gShipSpeedSetting = 0
gGrantAllResearch = ""
gPlayerRaces = {}
gPlayersToKill = {}
gRestrictedResearches = {}
gGameOver = 0
gDynamicMusicSetting = 0
gUnitCapSetting = ""
gStartingResources = 0
gPlayerCount = 0
gChallengeMode = 0
gJumpGateOwnership = 0
gJumpCost = 0
gPayoutMultiplier = 0
gResourceCap = 0
gRUsGivenOut = 0
gPayoutDisabled = 0
PlayerCommandPostCounts = {} --stores the counts of command posts each player owns (not including RU generators)
gShipTypes_count = 0
gCommandPostShipNames = {} --stores the name of hgn or vgr command posts
gPlayerToCheck = 0 --for killing ships in between territories
gTerritoryStatsIsSetUp = 0

TerritoryStats = {} --main stats table for all territories
gParentTerritoryIDs = {}
gCapturableTerritoryIDs = {}
gChildTerritoryIDs = {}
gResourceGeneratorIDs = {}

--overall stats on the whole level are stored here
BoardStats = 
{
	numTerritories = 0,
	numParents = 0,
...
PingDescriptions = 
{
	[FIGHTER] = "Produces: Fighters",
	[CORVETTE] = "Produces: Corvettes",
	[FRIGATE] = "Produces: Frigates",
	[CAPITAL] = "Produces: Capital ships",
	[RESOURCE_ONLY] = "",
}
