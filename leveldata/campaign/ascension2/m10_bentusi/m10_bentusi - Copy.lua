...
Events.intelevent_pulledout = 
    { 
        { 
            ...
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_LocationCardEvent("$44510", 6), }, 
        { HW2_Wait(3), }, 
        { 
            { "Sound_MusicPlayType( 'data:sound/music/staging/STAGING_08', MUS_Staging )", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$44540", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$44541", 5), }, 
        { HW2_Letterbox(1), 
        ...
        { 
            { "Camera_Interpolate( 'here', 'Camera_MassiveAnomaly', 2)", "", }, HW2_Wait(2), }, 
        { 
            { "g_pointer_default_1 = HW2_CreateEventPointerVolume( 'Keeper_1_Entry' )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44542", 5), }, 
        { 
            ...
            { "Rule_Add('Rule_Open_Droid_Wings_1')", "", }, HW2_Wait(2), 
            { "Player_SetDefaultShipTactic( 1, PassiveTactics )", "", }, 
        }, 
        { 
            { "Camera_Interpolate( 'here', 'Camera_Keeper_1_Closeup', 3)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44543", 5), }, 
        { HW2_Wait(1), }, 
        { 
            { "Camera_Interpolate( 'here', 'Camera_Keeper_2_Incoming', 3)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44545", 5), }, 
        { 
            ...
            { "Player_SetDefaultShipTactic( 1, PassiveTactics )", "", }, HW2_Wait(3), }, 
        { 
            { "Camera_Interpolate( 'here', 'Camera_Keeper_Both', 4)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44547", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44548", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44549", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44550", 5), }, 
        { 
            { "Initial_Intel_Keeper_Build()", "", }, HW2_Wait(2), }, 
        { 
            { "Player_SetDefaultShipTactic( 1, AggressiveTactics )", "", }, 
            { "Sound_MusicPlayType( 'data:sound/music/battle/Battle_Keeper', MUS_Battle )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44551", 5), }, 
        { 
            { "SobGroup_AttackPlayer( 'Droid_1', 0 )", "", }, 
            { "SobGroup_AttackPlayer( 'Droid_2', 0 )", "", }, 
            { "Keeper_Select_Attack_Target(1)", "", }, 
            { "Keeper_Select_Attack_Target(2)", "", }, HW2_Wait(1), }, 
        { 
            { "Camera_FocusSobGroupWithBuffer( 'Keeper_1', 600, 0, 3)", "", }, HW2_Wait(3), }, 
        { 
            { "Camera_UseCameraPoint( 'Camera_Recede' )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44552", 5), }, 
        ...
        { 
            { "Campaign_QuickSaveNb( g_save_id, '$6440' )", "", }, 
        }, 
    }
Events.intelevent_onedown = 
    { 
        { HW2_Letterbox(1), 
            ...
            { "Universe_EnableSkip(1)", "", }, HW2_Wait(2), }, 
        { 
            { "Sensors_EnableCameraZoom( 1 )", "", }, 
        ...
        { 
            { "Sensors_Toggle( 1 )", "", }, HW2_Pause(1), HW2_SubTitleEvent(Actor_FleetIntel, "$44555", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44556", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44557", 5), }, 
        { HW2_Pause(0), 
            { "Sensors_Toggle( 0 )", "", }, 
            { "SobGroup_SetInvulnerability (g_Keeper_Alive, 0)", "", }, HW2_Letterbox(0), 
            { "Universe_EnableSkip(0)", "", }, HW2_Wait(2), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_stunned = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44560", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_captureattempt = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44565", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44566", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_capturesuccess = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44570", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44571", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_recapture = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44575", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_keepershields = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44580", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44581", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.intelevent_secondkeeperdestroyed = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Letterbox(1), HW2_Wait(3), }, 
        { 
            { "Universe_EnableSkip(1)", "", }, 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Sensors_EnableCameraZoom( 0 )", "", }, 
            { "Camera_FocusSobGroupWithBuffer( g_Keeper_Alive, 300, 100, 3 )", "", }, HW2_Wait(3), }, 
        { 
            { "Sensors_EnableCameraZoom( 1 )", "", }, 
            ...
            { "SobGroup_Despawn('Droid_2')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44585", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44586", 5), 
            { "SobGroup_Clear('All_Drones')", "", }, 
        }, 
        { HW2_Letterbox(0), 
            { "Universe_EnableSkip(0)", "", }, HW2_Wait(3), 
...
Events.intelevent_bentusiarrive = 
    { 
        ...
        { 
            { "Sensors_EnableCameraZoom( 1 )", "", }, 
            { "Sound_MusicPlayType( 'data:sound/music/battle/BENTUS_ARRIVAL', MUS_Staging )", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$44587", 5), }, 
        { HW2_Wait(1), }, 
        { 
            { "SobGroup_ExitHyperSpace('Bentus', 'bentus_spawn' )", "", }, 
            { "FOW_RevealGroup('Bentus', 1)", "", }, 
            { "Camera_Interpolate( 'here', 'Camera_Bentusi', 6)", "", }, HW2_Wait(28), }, 
        { HW2_SubTitleEvent(Actor_Bentusi, "$44588", 5), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_Bentusi, "$44589", 5), }, 
        { HW2_Wait(1), }, 
        { 
            { "Sensors_Toggle( 1 )", "", }, 
            { "Sensors_EnableCameraZoom( 0 )", "", }, 
            ...
            { "g_pointer_default_2 = HW2_CreateEventPointerSobGroup( Dreadnaught )", "", }, HW2_SubTitleEvent(Actor_Bentusi, "$44590", 5), }, 
        { HW2_Wait(1), }, 
        { 
            { "Sensors_Toggle( 0 )", "", }, 
            { "EventPointer_Remove(g_pointer_default_1)", "", }, 
            ...
            { "Objective_AddDescription( obj_prim_repairdread_id, '$44681')", "", }, HW2_Wait(2), }, 
        { 
            { "Sensors_EnableCameraZoom( 1 )", "", }, HW2_Letterbox(0), HW2_Wait(2), 
            { "Universe_EnableSkip(0)", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        ...
        { 
            { "Campaign_QuickSaveNb( g_save_id, '$6441' )", "", }, 
        }, 
    }
Events.intelevent_dreadrepairstart = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44645", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.intelevent_morekeepers = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44600", 5), 
        ...
        { 
            ...
            { "g_pointer_default_4 = HW2_CreateEventPointerSobGroup( 'Keeper_4' )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44601", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44602", 5), }, 
        { 
            { "Universe_EnableSkip(0)", "", }, 
...
Events.intelevent_dreadrepaired = 
    { 
        ...
        { 
            { "Universe_EnableSkip(1)", "", }, HW2_Letterbox(1), HW2_Pause(1), HW2_Wait(2), }, 
        { 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Sensors_EnableCameraZoom( 0 )", "", }, 
            { "Camera_Interpolate( 'here', 'Camera_Dread_Repairs', 3)", "", }, HW2_SubTitleEvent(Actor_Bentusi, "$44622", 5), }, 
        { 
            { "SobGroup_Launch(Dreadnaught, 'Bentus')", "", }, HW2_SubTitleEvent(Actor_Bentusi, "$44623", 5), }, 
        { 
            { "Universe_EnableSkip(0)", "", }, HW2_Letterbox(0), HW2_Wait(3), }, 
        { HW2_Pause(0), }, 
        { 
            { "Sensors_EnableCameraZoom( 1 )", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
        ...
        { 
            { "Campaign_QuickSaveNb( g_save_id, '$6442' )", "", }, 
        }, 
        { 
...
Events.speechevent_keepersphase_1 = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44655", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44656", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44667", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_keepersphase_4 = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44668", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_keepersphase_3 = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44615", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_keepersphase_2 = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44692", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_keepers_cannot_be_stopped = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44669", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.intelevent_dreaddestroyed = 
    { 
        ...
        { 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Sensors_EnableCameraZoom( 0 )", "", }, 
            { "Camera_FocusSobGroupWithBuffer( Dreadnaught, 100, 100, 1 )", "", }, HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44691", 5), }, 
        { HW2_Wait(2), }, 
        { HW2_Wait(1), HW2_Fade(1), }, 
...
Events.intelevent_bentusdestroyed = 
    { 
        ...
        { 
            { "Camera_Interpolate( 'here', 'Camera_Final_Bentus', 3)", "", }, HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44640", 5), }, 
        { HW2_Fade(1), }, 
...
Events.speechevent_bentusscratched = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44603", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44606", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_dreaddamaged = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44690", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_bentusdamaged = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44610", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.intelevent_missioncomplete = 
    { 
        ...
        { 
            ...
            { "Camera_Interpolate( 'here', 'Camera_Final_Bentus', 3)", "", }, HW2_SubTitleEvent(Actor_Bentusi, "$44625", 5), }, 
        { 
            ...
            { "SobGroup_Spawn('Keeper_4', 'Keeper_Spawn_Finale_4' )", "", }, HW2_Wait(0.2), }, 
        { 
            ...
            { "SobGroup_AttackPlayer( 'Keeper_4', 2 )", "", }, HW2_SubTitleEvent(Actor_Bentusi, "$44626", 5), }, 
        { HW2_Wait(2), }, 
        { HW2_SubTitleEvent(Actor_Bentusi, "$44627", 5), }, 
        { HW2_Wait(2), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$44630", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$44631", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44640", 5), 
            { "Player_InstantlyGatherAllResources( 0 )", "", }, 
            { "SP_SobGroup_DockOrParadeSobGroupAtEnd( 'Player_Ships0', Players_Mothership)", "", }, 
        }, 
        { 
            { "Camera_Interpolate( 'here', 'camera_MSExitsMap', 0)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$44632", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$44641", 5), 
...
Events.speechevent_playerloses = 
    { 
        { HW2_Pause(1), HW2_Letterbox(1), HW2_Wait(1), }, 
        { HW2_Fade(1), HW2_Wait(1.2), }, 
...
function Rule_Init()
	...
	SobGroup_Create("g_KeeperMoverLastBuilt")
    ...
    SetAlliance(0, 2)
    SetAlliance(2, 0)
    Player_SetBadgeTexture(1, "DATA:badges/crab.TGA")
    SobGroup_ChangePower(Dreadnaught, "Weapon_Triton1", 0)
    Player_SetPlayerNameAdvanced(0, "Hiigaran Navy")
    Player_SetPlayerNameAdvanced(1, "Progenitor")
    Player_SetPlayerNameAdvanced(2, "Bentusi")
    Rule_Add("Rule_PlayerLose")
    Rule_Add("Rule_Dreadnaught_Destroyed")
    Rule_Add("Rule_Dreadnaught_Damaged")
    Rule_Add("Rule_Start")
    Rule_Add("Rule_DebugCheats")
    Rule_Remove("Rule_Init")
end

function Rule_DebugCheats()
	local PlayerID_Keeper = 1
	local hp_threshold = 0.15
	local timer = Universe_GameTime()
	if timer < 50 then
		powerListStored[PlayerID_Keeper + 1] = LastpowerListMax[PlayerID_Keeper+1]	--fill energy
		hp_threshold = 0.7
	end
	local damage_taken = 0
	for i=1,4,1 do
		if SobGroup_HealthPercentage("Keeper_"..i)<hp_threshold and SobGroup_HealthPercentage("Keeper_"..i)>0 then
			SobGroup_SetHealth("Keeper_"..i, hp_threshold)		--keep keepers alive
			damage_taken = damage_taken + 1
		end
	end
	local bounty = (g_difficulty+1-timer/300)^3 + (g_difficulty+1)*damage_taken*100
	if bounty > 0 then
		AccoladesAddRU(PlayerID_Keeper, bounty)	--RU hax
	end
end
...
function Rule_Keeper_1_Act()
    ...
    if  g_Keeper_1_Tally_Before_Hyperspace==g_Keeper_Hyperspace_Out_Frequency then
        ...
        SobGroup_SetInvulnerability("Keeper_1", 1)
        SobGroup_Stop(SobGroup_OwnedBy("Keeper_1"), "Keeper_1")
        SP_SobGroup_EnterHyperSpaceOffMapAndRecaharge("Keeper_1")
...
function Rule_Keeper_2_Act()
    ...
    if  g_Keeper_2_Tally_Before_Hyperspace==g_Keeper_Hyperspace_Out_Frequency then
        ...
        SobGroup_SetInvulnerability("Keeper_2", 1)
        SobGroup_Stop(SobGroup_OwnedBy("Keeper_2"), "Keeper_2")
        SP_SobGroup_EnterHyperSpaceOffMapAndRecaharge("Keeper_2")
        g_Keeper_2_Tally_Before_Hyperspace = 0
    else
...
function Rule_Keeper_3_Act()
    ...
    if  g_Keeper_3_Tally_Before_Hyperspace==g_Keeper_Hyperspace_Out_Frequency then
        ...
        SobGroup_Stop(SobGroup_OwnedBy("Keeper_3"), "Keeper_3")
        SP_SobGroup_EnterHyperSpaceOffMapAndRecaharge("Keeper_3")
...
function Rule_Keeper_4_Act()
    ...
    if  g_Keeper_4_Tally_Before_Hyperspace==g_Keeper_Hyperspace_Out_Frequency then
        ...
        SobGroup_Stop(SobGroup_OwnedBy("Keeper_4"), "Keeper_4")
        SP_SobGroup_EnterHyperSpaceOffMapAndRecaharge("Keeper_4")
...
function Keeper_Behaviour_Core(Keeper_Number)
    ...
    if  SobGroup_Count("All_Movers")<g_mover_cap then
        Keeper_Build_Movers(Keeper_Number)
        print("Keeper_"..Keeper_Number.." Building Movers")
    end 
  end
end
...
function Keeper_Select_Attack_Target(Keeper_Number)
    ...
    Get_Players_Fleet_Groups()
    for i = 1,getn(KeeperTargetList),1 do
...
function Keeper_Build_Drones(Keeper_Number)
    for i = 1,g_drones_per_build,1 do
        SobGroup_Clear(g_KeeperDroneLastBuilt)
        g_KeeperDroneLastBuilt = SobGroup_CreateShip("Keeper_"..Keeper_Number, "Kpr_AttackDroid")
        SobGroup_SetHealth_UpgradeOnly(g_KeeperDroneLastBuilt, 1)
        SobGroup_SobGroupAdd("All_Drones", g_KeeperDroneLastBuilt)
        SobGroup_AttackPlayer("All_Drones", 0)
    end 
end

function Keeper_Build_Movers(Keeper_Number)
    for i = 1,g_movers_per_build,1 do
        SobGroup_Clear(g_KeeperMoverLastBuilt)
        g_KeeperMoverLastBuilt = SobGroup_CreateShip("Keeper_"..Keeper_Number, "kpr_mover_capture")
        SobGroup_SobGroupAdd("All_Movers", g_KeeperMoverLastBuilt)
        SobGroup_CaptureSobGroup("All_Movers", "Dreadnaught_Sob")
    end 
end
...
function Keeper_Build_Movers(random_location)
    for i = 1,g_movers_per_build,1 do
        ...
        CPU_RemoveSobGroup(SobGroup_OwnedBy("g_MoverLastBuilt"), "g_MoverLastBuilt")
...
function Initial_Intel_Keeper_Build()
    ...
    for i = 1,2,1 do
	    ...
	    for i = 1,2,1 do
        g_KeeperMoverLastBuilt = SobGroup_CreateShip("Keeper_1", "kpr_mover_capture")
        SobGroup_SetHealth_UpgradeOnly(g_KeeperMoverLastBuilt, 1)
        FOW_RevealGroup("g_KeeperMoverLastBuilt", 1)
        SobGroup_SobGroupAdd("All_Movers", "g_KeeperMoverLastBuilt")
    end 
    for i = 1,2,1 do
        SobGroup_Clear(g_KeeperMoverLastBuilt)
        g_KeeperMoverLastBuilt = SobGroup_CreateShip("Keeper_2", "kpr_mover_capture")
        SobGroup_SetHealth_UpgradeOnly(g_KeeperMoverLastBuilt, 1)
        FOW_RevealGroup("g_KeeperMoverLastBuilt", 1)
        SobGroup_SobGroupAdd("All_Movers", "g_KeeperMoverLastBuilt")
    end
...
function Set_Keepers_Hard()
    ...
    Player_GrantResearchOption(1, "KeeperHealthUpgradeSPGAME_M10_LVL_3")
    Player_GrantResearchOption(1, "KeeperWeaponUpgradeSPGAME_M10_LVL_3")
    Player_GrantResearchOption(1, "AttackDroidHealthUpgradeSPGAME_HIGH")
		Player_GrantResearchOption(1, "AttackDroidWeaponUpgradeSPGAME_HIGH")
end
