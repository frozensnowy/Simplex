...
Events.intelevent_eliminatemakaan = 
    { 
        ...
        { 
            ...
            { "Campaign_QuickSaveNb( g_save_id, '$6455' )", "", }, 
        }, 
        { HW2_Wait(2), }, 
        { HW2_LocationCardEvent("$46520", 6), }, 
        { 
            { "Sound_EnableAllSpeech( 1 )", "", }, HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$46525", 3), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$46526", 3), }, 
        { HW2_Wait(0.5), }, 
        { HW2_Letterbox(1), 
        ...
        { HW2_Wait(1), }, 
        { 
            { "Camera_FocusSobGroup( 'Vgr_Group_1', 1, 3500, 1.5 )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$46527", 3), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46528", 3), 
        ...
        { HW2_Wait(1), }, 
        { 
            { "Universe_EnableSkip(0)", "", }, HW2_Letterbox(0), }, 
        { 
...
Events.intelevent_makaansLastWords = 
    { 
        ...
        { HW2_Wait(3), }, 
        { 
            { "Camera_FocusSobGroup( 'Vgr_Makaan', 1, 1500, 1 )", "", }, 
            { "RemoveKamikazeRule = 1", "", }, 
        }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_Makaan, "$46570", 4), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_Makaan, "$46571", 4), }, 
        { HW2_Wait(1), }, 
        { 
            { "KillMakaan = 1", "", }, 
        }, 
...
Events.intelevent_makaanHasBeenDefeated = 
    { 
        { 
            { "SobGroup_Spawn( 'HSCore', 'HSCoreSpawnSphere' )", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$46572", 4), 
            { "Objective_SetState( obj_prim_destroymakaan_id, OS_Complete )", "", }, 
        }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$46573", 4), 
            { "Camera_FocusSobGroup( 'HSCore', 1, 300, 1 )", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$46574", 4), }, 
        { HW2_Wait(0.5), }, 
        { 
            { "Universe_Fade( 1, 3 )", "", }, 
        }, 
        ...
        { 
            ...
            { "Player_InstantDockAndParade( 0, 'Sajuuk', 0)", "", }, 
            ...
            { "SobGroup_SwitchOwner( Players_Mothership, 3 )", "", }, 
            { "NISLoad( 'nis/NIS14B' )", "", }, 
        }, 
        { HW2_Wait(3), }, 
        { 
            { "n_currentNISPlaying_id = NISPlay( 'nis/NIS14B' )", "", }, 
...
Events.intelevent_desperateMakaan = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46530", 10), 
            { "pointer_makaan_id = HW2_CreateEventPointerSobGroup('Vgr_Makaan')", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { 
            { "ping_makaan_id = HW2_PingCreateWithLabel( ping_makaan, 'Vgr_Makaan' )", "", }, 
            { "Ping_AddDescription(ping_makaan_id, 0, '$46500')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$46531", 10), 
        ...
        { 
            { "EventPointer_Remove(pointer_makaan_id)", "", }, HW2_Wait(2), }, 
        { HW2_Letterbox(0), 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Camera_FocusRestore()", "", }, 
        ...
        { 
            { "g_save_id = g_save_id + 1", "", }, 
            { "Campaign_QuickSaveNb( g_save_id, '$6456' )", "", }, 
        }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.intelevent_makaanDamaged = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46533", 10), }, 
        { HW2_Wait(1), }, 
        { 
            { "Rule_Add ('Rule_PlaySaveGameLocationCard')", "", }, HW2_Wait(1), }, 
        { 
            { "g_save_id = g_save_id + 1", "", }, 
            { "Campaign_QuickSaveNb( g_save_id, '$6457' )", "", }, 
        }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.intelevent_makaanCriticallyDamaged = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46535", 10), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46536", 10), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_makaanRepairing = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46540", 10), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46541", 10), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_shipyardDiscovered = 
    { 
        ...
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46545", 10), 
        ...
        { 
            ...
            { "Ping_AddDescription(ping_shipyard_id, 0, '$46501')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$46546", 10), 
        ...
        { 
            { "EventPointer_Remove(pointer_shipyard_id)", "", }, HW2_Wait(2), }, 
        { HW2_Letterbox(0), 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Camera_FocusRestore()", "", }, 
            { "Universe_EnableSkip(0)", "", }, HW2_Pause(0), }, 
        ...
        { 
            { "g_save_id = g_save_id + 1", "", }, 
            { "Campaign_QuickSaveNb( g_save_id, '$6458' )", "", }, 
        }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.speechevent_shipyardDestroyed = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46547", 5), }, 
        { 
            { "Rule_Add ('Rule_PlaySaveGameLocationCard')", "", }, HW2_Wait(1), }, 
        { 
            { "g_save_id = g_save_id + 1", "", }, 
            { "Campaign_QuickSaveNb( g_save_id, '$6459' )", "", }, 
        }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.intelevent_carrierDiscovered = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46550", 10), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_kamikazeAttack = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46555", 10), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46556", 10), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46558", 10), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
function OnInit()
    ...
    SobGroup_SetTeamColours("Vgr_Makaan", 
    { 0.9, 0.9, 0.9, } , 
...
function Rule_Init_1()
    ...
    Rule_AddInterval("SP_GlobalInvincibility", 2.51689)
end
...
function Rule_Init()
    ...
    Player_SetPlayerNameAdvanced(2, "Vaygr")
    Player_SetPlayerNameAdvanced(3, "Progenitor")
    HW2_SetResearchLevel(14)
    SobGroup_CreateSubSystem_OnStart("Vgr_Makaan", "FighterProduction")
    SobGroup_CreateSubSystem_OnStart("Vgr_Makaan", "CorvetteProduction")
    SobGroup_CreateSubSystem_OnStart("Vgr_Makaan", "FrigateProduction")
    SobGroup_CreateSubSystem_OnStart("Vgr_Makaan", "CapShipProduction")
    SobGroup_CreateSubSystem_OnStart("Vgr_Makaan", "PlatformProduction")
    SobGroup_CreateSubSystem_OnStart("Vgr_Makaan", "Research")
    SobGroup_CreateSubSystem_OnStart("Vgr_Makaan", "AdvancedArray")
    SobGroup_CreateSubSystem_OnStart("Vgr_Makaan", "vgr_mothership_shield")
    SobGroup_CreateSubSystem_OnStart("Vgr_Makaan", "vgr_mothership_shield1")
    SobGroup_CreateSubSystem_OnStart("Vgr_Makaan", "vgr_heavyfusionmissilelauncherbcsmallMS1")
    SobGroup_CreateSubSystem_OnStart("Vgr_Makaan", "vgr_ms_plasma")
    SobGroup_CreateSubSystem_OnStart("Vgr_Makaan", "vgr_qje_quadflechette_stbdF")
    SobGroup_CreateSubSystem_OnStart("Vgr_Makaan", "vgr_ms_armor")
    SobGroup_CreateSubSystem_OnStart("Vgr_Sob_Shipyard", "FighterProduction")
    SobGroup_CreateSubSystem_OnStart("Vgr_Sob_Shipyard", "CorvetteProduction")
    SobGroup_CreateSubSystem_OnStart("Vgr_Sob_Shipyard", "FrigateProduction")
    SobGroup_CreateSubSystem_OnStart("Vgr_Sob_Shipyard", "CapShipProduction")
    SobGroup_CreateSubSystem_OnStart("Vgr_Sob_Shipyard", "PlatformProduction")
    SobGroup_CreateSubSystem_OnStart("Vgr_Sob_Shipyard", "Research")
    SobGroup_CreateSubSystem_OnStart("Vgr_Sob_Shipyard", "Vgr_MS_Module_Hyperspace")
    SobGroup_CreateSubSystem_OnStart("Vgr_Sob_Shipyard", "AdvancedArray")
    SobGroup_CreateSubSystem_OnStart("Vgr_Sob_Shipyard", "vgr_magnetron1")
    SobGroup_CreateSubSystem_OnStart("Vgr_Sob_Shipyard", "vgr_magnetron2")
    SobGroup_CreateSubSystem_OnStart("Vgr_Sob_Shipyard", "vgr_ms_plasma")
    SobGroup_CreateSubSystem_OnStart("Vgr_Sob_Shipyard", "vgr_power_sy")
    SobGroup_CreateSubSystem_OnStart("Vgr_Sob_Shipyard", "Vgr_MS_Module_Defensefield")
    SobGroup_CreateSubSystem_OnStart("Vgr_Sob_Shipyard", "vgr_shipyard_shield")
    SobGroup_CreateSubSystem_OnStart("Vgr_Sob_Shipyard", "vgr_shipyard_shield1")
    SobGroup_SetTactics("Vgr_Sob_Shipyard", AggressiveTactics)
    SobGroup_SetInvulnerability("Vgr_Sob_Shipyard", 1)
    ...
    Player_GrantResearchOption(1, "VaygrFrigateHealthUpgradeSPGAME")
    Player_GrantResearchOption(1, "CorvetteHealthUpgradeSPGAME")
    Player_GrantResearchOption(2, "VaygrFrigateHealthUpgradeSPGAME")
    Player_GrantResearchOption(2, "CorvetteHealthUpgradeSPGAME")
    --Player_GrantResearchOption(2, "SuperCapHealthUpgradeSPGAME")
    Player_GrantResearchOption(2, "SP_ShipyardHealthUpgrade")
    CPU_Enable(1, 1)
...
function Rule_Shipyard_Warning()
    if  EventPlaying==0 and PlayerHasDiscoveredShipyard==1 then
        ...
        SobGroup_SetInvulnerability("Vgr_Sob_Shipyard", 0)
...
function Rule_makaanDamaged()
    if  EventPlaying==0 and SobGroup_HealthPercentage("Vgr_Makaan")<0.65 then
        ...
        if SobGroup_HealthPercentage("Vgr_Makaan")>0 then
...
function Rule_CheckForShipsNearShipyard()
    Player_FillProximitySobGroup("tempSobGroup_SP", 0, "Vgr_Sob_Shipyard", 5000)
...
function Rule_makaanKamikazeDefense()
    ...
    elseif  SobGroup_HealthPercentage("Vgr_Makaan")<0.75 and SobGroup_UnderAttack("Vgr_Makaan")==1 then
        ...
        SobGroup_Create("AttackingMakaan")
        SobGroup_GetAttackers("Vgr_Makaan", "AttackingMakaan")
        SobGroup_FillShipsByType("tempSobGroup_SP", "AttackingMakaan", "Hgn_AssaultFrigate")
        if  SobGroup_Empty("tempSobGroup_SP")==0 then
            print("MakaanKamikazeDefense found some Assault Frigates!")
            SobGroup_SobGroupAdd("KamikazeTargets", "tempSobGroup_SP")
        end 

        SobGroup_FillShipsByType("tempSobGroup_SP", "AttackingMakaan", "Hgn_TorpedoFrigate")
        if  SobGroup_Empty("tempSobGroup_SP")==0 then
            print("MakaanKamikazeDefense found some Torpedo Frigates!")
            SobGroup_SobGroupAdd("KamikazeTargets", "tempSobGroup_SP")
        end 

        SobGroup_FillShipsByType("tempSobGroup_SP", "AttackingMakaan", "Hgn_MarineFrigate")
        if  SobGroup_Empty("tempSobGroup_SP")==0 then
            print("MakaanKamikazeDefense found some Marine Frigates!")
            SobGroup_SobGroupAdd("KamikazeTargets", "tempSobGroup_SP")
        end 

        SobGroup_FillShipsByType("tempSobGroup_SP", "AttackingMakaan", "Hgn_IonCannonFrigate")
        if  SobGroup_Empty("tempSobGroup_SP")==0 then
            print("MakaanKamikazeDefense found some Ion Cannon Frigates!")
            SobGroup_SobGroupAdd("KamikazeTargets", "tempSobGroup_SP")
        end 

        SobGroup_FillShipsByType("tempSobGroup_SP", "AttackingMakaan", "Hgn_DefenseFieldFrigate")
        if  SobGroup_Empty("tempSobGroup_SP")==0 then
            print("MakaanKamikazeDefense found some Defense Field Frigates!")
            SobGroup_SobGroupAdd("KamikazeTargets", "tempSobGroup_SP")
        end 

        SobGroup_FillShipsByType("tempSobGroup_SP", "AttackingMakaan", "Hgn_Destroyer")
        if  SobGroup_Empty("tempSobGroup_SP")==0 then
            print("MakaanKamikazeDefense found some Destroyers!")
            SobGroup_SobGroupAdd("KamikazeTargets", "tempSobGroup_SP")
        end 

        SobGroup_FillShipsByType("tempSobGroup_SP", "AttackingMakaan", "Hgn_BattleCruiser")
        if  SobGroup_Empty("tempSobGroup_SP")==0 then
            print("MakaanKamikazeDefense found some Battlecruisers!")
            SobGroup_SobGroupAdd("KamikazeTargets", "tempSobGroup_SP")
        end 

        SobGroup_FillShipsByType("tempSobGroup_SP", "AttackingMakaan", "Hgn_IonTurret")
        if  SobGroup_Empty("tempSobGroup_SP")==0 then
