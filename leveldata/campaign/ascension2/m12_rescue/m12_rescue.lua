...
g_save_id = 0
SP_abilityList = 
    { AB_Move, AB_Attack, AB_Guard, AB_Stop, AB_Hyperspace, AB_Retire, AB_Scuttle, AB_Capture, AB_Parade }
Events = {}
Events.intelevent_savesoban = 
    { 
        ...
        { HW2_Wait(1), }, 
        { 
            { "g_pointer_default = HW2_CreateEventPointerSobGroup('Vaygr_Carrier')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45532", 10), }, 
        { HW2_Wait(1), }, 
        { 
            { "EventPointer_Remove(g_pointer_default)", "", }, 
            { "g_pointer_default = HW2_CreateEventPointerSobGroup('Command_Station')", "", }, 
            { "Camera_Interpolate( 'here', 'camera_openingFocusOnStation', 2 )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45533", 10), }, 
        { HW2_Wait(1), }, 
        { 
            ...
            { "Ping_AddDescription(ping_commandstation_id, 0, '$45900')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45534", 10), }, 
        { 
            { "Camera_Interpolate( 'here', 'camera_openingFocusOnFleet', 2 )", "", }, HW2_Wait(2), }, 
        { 
            { "EventPointer_Remove(g_pointer_default)", "", }, 
...
Events.intelevent_sobanescapes = 
    { 
        ...
        { 
            { "Sensors_EnableCameraZoom( 0 )", "", }, 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Camera_Interpolate( 'here', 'camera_focusOnSobanEscape', 2 )", "", }, HW2_Wait(2), }, 
        { 
            { "Camera_FocusSobGroupWithBuffer( g_talornsship, 800, 100, 2) ", "", }, HW2_SubTitleEvent(Actor_Talorn, "$45560", 8), }, 
        ...
        { 
            ...
            { "SobGroup_DockSobGroup(g_talornsship, Players_Mothership)", "", }, HW2_Wait(2), }, 
        { 
            { "Sensors_EnableCameraZoom( 1 )", "", }, HW2_Letterbox(0), HW2_Wait(2), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
...
Events.intelevent_escortsoban = 
    { 
        ...
        { 
            { "SobGroup_SetTactics (g_talornsship, PassiveTactics)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45570", 8), 
...
Events.intelevent_followmakaan = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$45610", 6), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$45611", 6), }, 
        { HW2_Wait(2), 
            { "Universe_Fade( 1, 1.5 )", "", }, 
        }, 
        { 
            ...
            { "Camera_FocusSobGroupWithBuffer( Players_Mothership, 4000,100, 0 )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45612", 6), }, 
        { 
            { "Universe_Fade( 0, 1.5 )", "", }, HW2_Wait(2), }, 
        { HW2_Wait(1.5), }, 
        { 
...
Events.intelevent_makaanisfleeing = 
    { 
        ...
        { 
            { "Sensors_EnableCameraZoom( 0 )", "", }, 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Camera_FocusSobGroupWithBuffer( 'Vaygr_MakaanMothership', 2000, 2000, 2 )", "", }, HW2_Wait(2), }, 
...
Events.speechevent_playerloses = 
    { 
        { 
            { "g_eventplaying = 1", "", }, HW2_Pause(1), HW2_Letterbox(1), HW2_Fade(1), HW2_Wait(2), }, 
...
function Rule_NISComplete()
    if  NISComplete(g_nisstate)==1 then
        ...
        if SobGroup_GetHardPointHealth("Command_Station", "Production 1") == 0 then
		    	SobGroup_CreateSubSystem_OnStart("Command_Station", "hgn_commandfortress_comunicationfacility")
		    end
		    SobGroup_CreateSubSystem_OnStart("Command_Station", "hgn_commandfortress_defencefacility")
		    SobGroup_CreateSubSystem_OnStart("Command_Station", "vgr_qje_quadflechette_stbd_cf")
		    SobGroup_CreateSubSystem_OnStart("Command_Station", "vgr_ion1")
		    SobGroup_CreateSubSystem_OnStart("Command_Station", "missile_box")
		    SobGroup_CreateSubSystem_OnStart("Command_Station", "vgr_dt3_turret")
		    SobGroup_CreateSubSystem_OnStart("Command_Station", "Vgr_MS_Module_FireControl")
		    SobGroup_CreateSubSystem_OnStart("Command_Station", "Vgr_MS_Production_Fighter")
		    SobGroup_CreateSubSystem_OnStart("Command_Station", "Vgr_MS_Production_Corvette")
        Player_SetRU(1, 3000)
        Player_SetRU(2, 3000)
        HW2_InitializeBuilder("Vgr_Shipyard_1", "tempSobGroup_SP")
        HW2_InitializeBuilder("Vgr_Shipyard_2", "tempSobGroup_SP")
        HW2_InitializeBuilder("Vgr_Shipyard_3", "tempSobGroup_SP")
		    SobGroup_CreateSubSystem_OnStart("Vgr_Shipyard_1", "Vgr_MS_Module_Defensefield")
		    SobGroup_CreateSubSystem_OnStart("Vgr_Shipyard_1", "vgr_shipyard_shield")
		    SobGroup_CreateSubSystem_OnStart("Vgr_Shipyard_1", "vgr_shipyard_shield1")
		    SobGroup_CreateSubSystem_OnStart("Vgr_Shipyard_2", "Vgr_MS_Module_Defensefield")
		    SobGroup_CreateSubSystem_OnStart("Vgr_Shipyard_2", "vgr_shipyard_shield")
		    SobGroup_CreateSubSystem_OnStart("Vgr_Shipyard_2", "vgr_shipyard_shield1")
		    SobGroup_CreateSubSystem_OnStart("Vgr_Shipyard_3", "Vgr_MS_Module_Defensefield")
		    SobGroup_CreateSubSystem_OnStart("Vgr_Shipyard_3", "vgr_shipyard_shield")
		    SobGroup_CreateSubSystem_OnStart("Vgr_Shipyard_3", "vgr_shipyard_shield1")
        ...
        SobGroup_DockSobGroup("Vaygr_Carrier", "Command_Station")
		    SobGroup_CreateSubSystem_OnStart("Vaygr_Carrier", "vgr_carrier_shield")
		    SobGroup_CreateSubSystem_OnStart("Vaygr_Carrier", "vgr_carrier_shield1")
		    SobGroup_CreateSubSystem_OnStart("Vaygr_Carrier", "Vgr_C_Module_Defensefield")
        Player_SetPlayerNameAdvanced(0, "Hiigaran Navy")
        Player_SetPlayerNameAdvanced(1, "Makaan Elite Guard")
...
function Rule_PlayEliminateMakaan()
    if  NISComplete(g_nisState)==1 then
        ...
        SobGroup_CreateSubSystem_OnStart("Vaygr_MakaanMothership", "vgr_heavyfusionmissilelauncherbcsmallMS1")
        SobGroup_CreateSubSystem_OnStart("Vaygr_MakaanMothership", "vgr_ms_plasma")
        SobGroup_CreateSubSystem_OnStart("Vaygr_MakaanMothership", "vgr_qje_quadflechette_stbdF")
        SobGroup_CreateSubSystem_OnStart("Vaygr_MakaanMothership", "vgr_ms_armor")
        SobGroup_CreateSubSystem_OnStart("Vaygr_MakaanMothership", "vgr_mothership_shield")
        SobGroup_CreateSubSystem_OnStart("Vaygr_MakaanMothership", "vgr_mothership_shield1")
        SobGroup_SetHealth("Vaygr_MakaanMothership", 1)
        SobGroup_SetTactics("Vaygr_MakaanMothership", AggressiveTactics)
        FOW_RevealGroup("Vaygr_MakaanMothership", 1)
        ...
        HW2_InitializeBuilder("Vaygr_MakaanMothership", "tempSobGroup_SP")
    end 
...
function Rule_DockMarines()
    if  Player_FillProximitySobGroup("tempSobGroup_SP", 0, "Command_Station", 10000)==1 and g_eventplaying==0 then
...
function Rule_DontDestroyCommStation()
    if  SobGroup_HealthPercentage("Command_Station")<=0.5 and g_eventplaying==0 then
    		SobGroup_SetHealth("Command_Station", 0.5)
    		SobGroup_SetTactics("Command_Station", AggressiveTactics)
...
function Rule_SobanSaved()
    if  SobGroup_OwnedBy("Command_Station")==0 and g_eventplaying==0 then
        ...
        SobGroup_SetTactics(g_talornsship, PassiveTactics)
        SobGroup_SetTeamColours(g_talornsship, 
    { 0, 0, 0, } , 
    { 1, 0, 0, }, "DATA:Badges/Soban.tga")
        for j = 1,getn(SP_abilityList),1 do
            SobGroup_AbilityActivate(g_talornsship, SP_abilityList[j], 0)
        end 
...
function Rule_SobanIsSafe()
    if  (SobGroup_IsDockedSobGroup(g_talornsship, Players_Mothership)==1 or SobGroup_IsDockedSobGroup(g_talornsship, "Player_Ships0")==1 or SobGroup_IsDockedSobGroup(g_talornsship, "hgn_shipyard0")==1) and g_eventplaying==0 then
        Objective_SetState(obj_prim_rescuesoban_id, OS_Complete)
        Event_Start("intelevent_sobanissafe")
        Rule_Add("Rule_SaveAfterSobanDock")
        for j = 1,getn(SP_abilityList),1 do
            SobGroup_AbilityActivate(g_talornsship, SP_abilityList[j], 1)
        end 
...
function Rule_VaygrDestroyed()
    if  SobGroup_HealthPercentage("Vaygr_MakaanMothership")<=0.2 and g_eventplaying==0 then
        ...
        SobGroup_Stop( SobGroup_OwnedBy("Vaygr_MakaanMothership"), "Vaygr_MakaanMothership" )
...
function Rule_PlayerLose()
	if (SobGroup_Empty(Players_Mothership) == 1) or (SobGroup_Empty(Players_Dreadnaught) == 1) then
