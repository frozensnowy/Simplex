...
Events.intelevent_scoutdebris = 
    { 
        ...
        { 
            { "Camera_FocusSave()", "", }, HW2_LocationCardEvent("$45020", 6), }, 
        { HW2_Wait(4), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$45030", 10), }, 
        { 
            { "Universe_EnableSkip(1)", "", }, HW2_Letterbox(1), HW2_Wait(2), }, 
        { 
            { "Sensors_Toggle( 1 )", "", }, HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$45031", 10), }, 
        { HW2_Wait(1), }, 
        { 
            ...
            { "g_pointer_default_3 = HW2_CreateEventPointerSobGroup('Core_Piece_3')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45032", 10), }, 
        { HW2_Wait(1), }, 
        { 
            ...
            { "EventPointer_Remove(g_pointer_default_3)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45033", 10), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$45034", 10), 
        ...
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$45035", 10), }, 
        { HW2_Wait(1), }, 
        { 
            { "Camera_Interpolate( 'here', 'cmr_introposition', 2 )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45037", 10), 
        ...
        { 
            { "Campaign_QuickSaveNb( g_save_id, '$6443' )", "", }, 
        }, 
    }
Events.intelevent_foundcorepieces = 
    { 
        ...
        { 
            { "Sensors_Toggle( 1 )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45040", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$45041", 10), 
            { "g_pointer_default_1 = HW2_CreateEventPointerSobGroup('Core_Piece_1')", "", }, 
            { "g_pointer_default_2 = HW2_CreateEventPointerSobGroup('Core_Piece_2')", "", }, 
        ...
        { 
            { "EventPointer_Remove(g_pointer_default_1)", "", }, 
            { "EventPointer_Remove(g_pointer_default_2)", "", }, 
            { "EventPointer_Remove(g_pointer_default_3)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45042", 10), }, 
        { HW2_Wait(1), }, 
        { 
            ...
            { "Objective_AddDescription( obj_prim_retrievefragments_id, '$45206')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45043", 10), }, 
        { HW2_Wait(0.3), 
            { "Sensors_Toggle( 0 )", "", }, 
        }, 
        { HW2_Letterbox(0), 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, HW2_Pause(0), HW2_Wait(2), 
            { "Universe_EnableSkip(0)", "", }, 
        }, 
    }
Events.speechevent_firstpiecesalvaged = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45075", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$45076", 10), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_secondpiecesalvaged = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45080", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$45081", 10), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.intelevent_vaygrarrived = 
    { 
        ...
        { 
            ...
            { "Sound_MusicPlayType( 'data:sound/music/battle/Battle_04_ALT', MUS_Battle )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45045", 10), }, 
        { HW2_Wait(1), 
        ...
        { 
            ...
            { "FOW_RevealGroup('Vaygr_Time_Attack_1', 1)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45046", 10), }, 
        { HW2_Wait(1), 
            { "EventPointer_Remove(g_pointer_default_1)", "", }, 
        }, 
        { 
        ...
        { 
            ...
            { "Campaign_QuickSaveNb( g_save_id, '$6444' )", "", }, 
        }, 
    }
Events.speechevent_shieldedcarriers = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45050", 10), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.intelevent_eliminatevaygr = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$45085", 10), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$45086", 10), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$45087", 10), }, 
        { 
            { "Rule_Add ('Rule_PlaySaveGameLocationCard')", "", }, HW2_Wait(1), 
            { "g_save_id = g_save_id + 1", "", }, 
        }, 
        { 
            { "Campaign_QuickSaveNb( g_save_id, '$6445' )", "", }, 
        }, 
    }
Events.speechevent_vaygrgotcore = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45055", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$45056", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$45057", 10), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_salvagerdestroyed = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45060", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$45061", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$45062", 10), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_coreoncarrier = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45065", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$45066", 10), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_coreescaped = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45070", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$45071", 10), }, 
...
Events.intelevent_hsout = 
    { 
        { 
            { "Sound_SetMuteActor('Fleet')", "", }, 
            { "Sound_EnterIntelEvent()", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$45090", 10), }, 
        { HW2_Letterbox(1), HW2_Wait(3), 
            { "Sensors_EnableCameraZoom( 0 )", "", }, 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Camera_FocusSobGroupWithBuffer( Players_Mothership, 3000, 3000,0 )", "", }, 
        }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$45092", 10), }, 
        { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$45091", 10), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$45093", 10), }, 
        { 
...
function Rule_Init()
    ...
    Player_SetPlayerNameAdvanced(1, "Bentusi Relic")
    Player_SetPlayerNameAdvanced(2, "Vaygr Forces")
    Player_SetPlayerNameAdvanced(3, "Vaygr Forces")
...
function Rule_Setup_AI()
    ...
    SobGroup_CreateSubSystem("Vaygr_AI_Carrier", "Vgr_MS_Module_Hyperspace")
    ...
    SobGroup_CreateSubSystem("Vaygr_Time_Attack_1_Carrier", "vgr_carrier_shield")
    SobGroup_CreateSubSystem("Vaygr_Time_Attack_2_Carrier", "vgr_carrier_shield")
    SobGroup_CreateSubSystem("Vaygr_Time_Attack_1_Carrier", "vgr_carrier_shield1")
    SobGroup_CreateSubSystem("Vaygr_Time_Attack_2_Carrier", "vgr_carrier_shield1")
    SobGroup_CreateSubSystem("Vaygr_Time_Attack_1_Carrier", "Vgr_C_Module_Defensefield")
    SobGroup_CreateSubSystem("Vaygr_Time_Attack_2_Carrier", "Vgr_C_Module_Defensefield")
...
function Rule_PlayerHasScoutedACore()
    if  Player_FillProximitySobGroup("tempSobGroup_SP", 0, "Core_Piece_1", 8000) + 
    Player_FillProximitySobGroup("tempSobGroup_SP", 0, "Core_Piece_2", 8000) +
    Player_FillProximitySobGroup("tempSobGroup_SP", 0, "Core_Piece_3", 8000)>=1 then

        Player_UnrestrictResearchOption(0, "RadiationDefenseField")
        Player_UnrestrictResearchOption(0, "MSRadiationDefenseField")
				Player_UnrestrictResearchOption(0, "CFRadiationDefenseField")
				Player_UnrestrictResearchOption(0, "SRadiationDefenseField")
				Player_UnrestrictResearchOption(0, "RadiationDefenseFieldTurret")
...
function Rule_PlayerSalvagedCorePiece()
    for i = 1,getn(g_CoreStates),1 do
...
function Rule_PlayerHasAllCorePieces()
    if  g_cores_retrieved==3 then
        ...
        if  HW2_PlayerHasMilitary(2)==0 and HW2_PlayerHasMilitary(3)==0 then
            ...
            if SobGroup_Empty("Player_Ships2") == 0 then
	            SobGroup_MoveToSobGroup("Player_Ships2", "Player_Ships0")
	            SobGroup_Kamikaze("Player_Ships2", "Player_Ships0")
	            FOW_RevealGroup("Player_Ships2", 1)
	          end
	          if SobGroup_Empty("Player_Ships2") == 0 then
            	SobGroup_MoveToSobGroup("Player_Ships3", "Player_Ships0")
            	SobGroup_Kamikaze("Player_Ships3", "Player_Ships0")
