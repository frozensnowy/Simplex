...
Events.intelevent_beginharvesting = 
    { 
        { 
            { "Universe_EnableSkip(1)", "", }, HW2_LocationCardEvent("$40520", 4), }, 
        { 
        ...
        { 
            ...
            { "g_pointer_default1 = HW2_CreateEventPointerSobGroup( 'tempSobGroup_SP' )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$40536", 10), }, 
        { HW2_Wait(1), }, 
        { 
...
Events.intelevent_movetochimera = 
    { 
        ...
        { 
            ...
            { "Rule_AddInterval( 'SwitchOwnerDrones', 1.5 )", "", }, 
...
Events.intelevent_chimeraissafe = 
    { 
        ...
        { 
            { "Timer_Start( 0, 180 )", "", }, 
            { "Timer_Pause( 0 )", "", }, 
            { "Subtitle_TimeCounter( 0, 40521 )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$40692", 8), }, 
...
Events.intelevent_mothershipjumps = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetCommand, "$40670", 8), }, 
        { HW2_Wait(1), }, 
        { 
...
function Rule_Init()
    ...
    Player_SetPlayerNameAdvanced(1, "Mothership Defense Force")
...
function Rule_OpeningIntelEventComplete()
    if  Event_IsDone("intelevent_beginharvesting")==1 then
        ...
        Player_RestrictBuildOption(0, "Hgn_MS_Production_CorvetteMover")
		    ...
		    Player_RestrictBuildOption(0, "FighterProduction")
...
function Rule_PlayerHasBegunBuildingInterceptors()
    if  Player_HasQueuedBuild(g_playerID, "Hgn_Interceptor")==1 or Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(g_playerID, "hgn_interceptor")>=1 then
        Rule_AddInterval("Rule_DeployDrones", 0.1)
...
function Rule_DeployDrones()
    ...
    DeployDrones()
    Rule_AddInterval("MoveDrones", 0.1)
...
function SwitchOwnerDrones()
    if  g_currentdronebeingswitched>=16 then
...
function MoveDrones()
    ...
    for i = 1,16,1 do
        if  g_dronemoved[i]~=0 and SobGroup_IsDockedSobGroup(g_drone[i], "Station_Chimera")==0 then
            SobGroup_Move(1, g_drone[i], "vol_TargetDrone_"..i)
            g_dronemoved[i] = 1
            droneslaunched = (droneslaunched + 1)
        end 

    end 
    if  droneslaunched==16 then
...
function Rule_HasBuiltInterceptors()
    if  droneslaunched==16 and Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(g_playerID, "hgn_interceptor")>=2 then		--Stats_ShipsCreated(g_playerID)>=5 then
...
function Rule_PlayNIS01B()
	if (Event_IsDone("speechevent_attackcomplete")==1) then
		if (Event_IsDone("speechevent_chimerareporting")==1) then
...
function Rule_CreateMothershipAttackers()
	...
	SobGroup_Create("MothershipAttackers_Bombers_3")
    SobGroup_Create("MothershipAttackers_Bombers_4")
    SobGroup_Create("MothershipAttackers_Bombers_5")
    SobGroup_Create("MothershipAttackers_Bombers_a")
    SobGroup_Create("MothershipAttackers_Bombers_b")
	SobGroup_Create("MothershipDestroyer")
	SobGroup_Create("MothershipDestroyer2")
    for i=0,10,1 do
    ...
    for i = 1,7,1 do
        SobGroup_SpawnNewShipInSobGroup(3, "Vgr_MissileBomber", "MothershipAttackers_B8"..i, "MothershipAttackers_Bombers_3", "vol_SpawnMothershipAttackers")
    end 
    for i = 1,7,1 do
        SobGroup_SpawnNewShipInSobGroup(3, "Vgr_MissileBomber", "MothershipAttackers_B8"..i, "MothershipAttackers_Bombers_a", "vol_SpawnMothershipAttackers")
    end 
    for i = 1,7,1 do
        SobGroup_SpawnNewShipInSobGroup(3, "Vgr_MissileBomber", "MothershipAttackers_B7"..i, "MothershipAttackers_Bombers_b", "vol_SpawnMothershipAttackers")
    end
    for i = 1,5,1 do
        SobGroup_SpawnNewShipInSobGroup(3, "Vgr_MissileBomber", "MothershipAttackers_B3"..i, "MothershipAttackers_Bombers_4", "vol_SpawnMothershipAttackers")
    end 	
    for i = 1,5,1 do
        SobGroup_SpawnNewShipInSobGroup(3, "Vgr_AssaultFrigate", "MothershipAttackers_B4"..i, "MothershipAttackers_Bombers_4", "vol_SpawnMothershipAttackers")
    end 
    for i = 1,5,1 do
        SobGroup_SpawnNewShipInSobGroup(3, "vgr_mortarcorvette", "MothershipAttackers_B5"..i, "MothershipAttackers_Bombers_5", "vol_SpawnMothershipAttackers")
    end
    for i = 1,1,1 do
        SobGroup_SpawnNewShipInSobGroup(3, "vgr_pulsedestroyer", "MothershipAttackers_B6"..i, "MothershipDestroyer", "vol_SpawnMothershipAttackers")
    end
    for i = 1,1,1 do
        SobGroup_SpawnNewShipInSobGroup(3, "Vgr_Cruiser", "MothershipAttackers_B6"..i, "MothershipDestroyer", "vol_SpawnMothershipAttackers")
    end
    for i = 1,1,1 do
        SobGroup_SpawnNewShipInSobGroup(3, "Vgr_LightCruiser", "MothershipAttackers_B6"..i, "MothershipDestroyer2", "vol_SpawnMothershipAttackers")
    end
    ...
    SobGroup_Attack(3, "MothershipAttackers_Bombers_a", "Tanis_Structure_1")
    SobGroup_Attack(3, "MothershipAttackers_Bombers_b", "Tanis_Structure_2")
	SobGroup_Attack(3, "MothershipAttackers_Bombers_3", "Mothership")
    SobGroup_Attack(3, "MothershipAttackers_Bombers_4", "Tanis_Structure_1")
    SobGroup_Attack(3, "MothershipAttackers_Bombers_5", "Tanis_Structure_2")
    SobGroup_Attack(3, "MothershipDestroyer", "Tanis_Structure_2")
	SobGroup_Attack(3, "MothershipDestroyer2", "Tanis_Structure_1")
...
function Rule_MothershipHasLaunched()
	...
	Rule_Add("Animate_MothershipDoorClose")
		...
		-- Enable Mothership's Defensive Guns. It'll need it LOL
...
function CreateMoreAttackers()
    ...
    if  numberOfInterceptors>=5 then
        numberOfNewAttackBombers = numberOfInterceptors / 1
        --numberOfNewAttackBombers = numberOfNewAttackBombers / 2
...
function Rule_PlayerHasNoBombers()
    if  Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(0, "Hgn_AttackBomber")==1 then
        Player_SetRU(0, (Player_GetRU(0) + 700))
