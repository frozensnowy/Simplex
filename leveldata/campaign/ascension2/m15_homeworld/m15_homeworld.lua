...
g_planet_killer_timer_interval = 360		--180 let me have more fun please
...
Events.intelevent_enemyfleetsdetected = 
    { 
        ...
        { HW2_Wait(5), }, 
        { 
            { "g_beginentry = 1", "", }, HW2_Wait(2), }, 
        { 
            { "Camera_Interpolate( 'here', 'camera_focusOnStart', 0)", "", }, HW2_Wait(12), }, 
        ...
        { 
            ...
            { "g_pointer_default_3 = HW2_CreateEventPointerSobGroup(  'Vaygr_Force_3'  )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$47013", 7), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$47015", 3), }, 
        { HW2_Wait(1), }, 
        { 
            { "obj_prim_destroyvaygr_id=Objective_Add( obj_prim_destroyvaygr , OT_Primary )", "", }, 
            { "Objective_AddDescription( obj_prim_destroyvaygr_id, '$47351')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$47014", 4), }, 
        { 
            { "EventPointer_Remove(g_pointer_default_1)", "", }, 
            { "EventPointer_Remove(g_pointer_default_2)", "", }, 
            { "EventPointer_Remove(g_pointer_default_3)", "", }, 
            { "Camera_Interpolate( 'here', 'camera_returntoFleet', 2)", "", }, HW2_Wait(2), }, 
        { 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Timer_Resume(0)", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
            { "Camera_SetLetterboxStateNoUI(0,2)", "", }, HW2_Wait(2), 
...
Events.intelevent_planetkillers = 
    { 
        { 
            { "Universe_EnableSkip(1)", "", }, 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Pause(1), HW2_Letterbox(1), 
            { "Sensors_Toggle( 1 )", "", }, HW2_Wait(2), 
        ...
        { 
            ...
            { "Ping_AddDescription(ping_planet_killer_id, 0, '$47343')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$47020", 5), }, 
        { HW2_Wait(1), }, 
        ...
        { 
            ...
            { "Sensors_Toggle( 0 )", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, HW2_Letterbox(0), HW2_Pause(0), HW2_Wait(4), }, 
    }
...
Events.intelevent_missilelaunched = 
    { 
        { 
            { "Universe_EnableSkip(1)", "", }, 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Pause(1), HW2_Letterbox(1), HW2_Wait(2), }, 
        { 
        ...
        { 
            ...
            { "EventPointer_Remove(g_pointer_default_2)", "", }, 
            { "EventPointer_Remove(g_pointer_default_3)", "", }, 
            { "Sensors_Toggle( 0 )", "", }, HW2_Letterbox(0), HW2_Pause(0), HW2_Wait(4), 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
            { "Universe_EnableSkip(0)", "", }, 
        }, 
...
Events.speechevent_victoryisours = 
    { 
        ...
        { 
            ...
            { "SobGroup_SetTactics('Player_Ships0', PassiveTactics)", "", }, HW2_Wait(1), HW2_Letterbox(1), }, 
        { 
            { "Camera_FocusSobGroupWithBuffer( Sajuuk, 1000, 1000, 3 )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$47130", 5), }, 
        { HW2_Wait(2), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$47131", 5), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$47133", 5), }, 
        { HW2_Wait(2), }, 
        --{ "UI_SetScreenEnabled('ComplexLogo', 1)", "", }, 		--doesn't work, seems all screens are automatically shut down when an event is playing
        --{ "UI_SetScreenVisible('ComplexLogo', 1)", "", }, 
        --{ Subtitle_Message("COMPLEX SIMPLE\n\n\nan idea by\n\n\nsomeone\n\n\n\n\n", 10), }, 
        --{ HW2_LocationCardEvent("COMPLEX SIMPLE\n\n\nan idea by\n\n\nsomeone\n\n\n\n\n", 10), }, 
        { HW2_Wait(10), }, 
        { 
...
Events.speechevent_playerloses = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, 
            { "Subtitle_TimeCounterEnd()", "", }, HW2_Pause(1), HW2_Letterbox(1), HW2_Fade(1), HW2_Wait(2), }, 
        { HW2_LocationCardEvent("$47005", 4), }, 
        { 
            { "setMissionComplete( 0 )", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
...
function Rule_Init()
    for i = 1,getn(missilesAccelerated),1 do
...
function SetupPlayer_1()
    ...
    SetAlliance(1, 3)
    SetAlliance(1, 4)
    Player_SetPlayerNameAdvanced(1, "Vaygr Blockade")
    ...
    SobGroup_CreateSubSystem("VF1_Carrier1", "vgr_carrier_shield")
    SobGroup_CreateSubSystem("VF1_Carrier2", "vgr_carrier_shield")
    SobGroup_CreateSubSystem("VF1_Carrier1", "vgr_carrier_shield1")
    SobGroup_CreateSubSystem("VF1_Carrier2", "vgr_carrier_shield1")
    SobGroup_CreateSubSystem("VF1_Carrier1", "Vgr_C_Module_Defensefield")
    SobGroup_CreateSubSystem("VF1_Carrier2", "Vgr_C_Module_Defensefield")
...
function SetupPlayer_2()
    ...
    SetAlliance(2, 3)
    SetAlliance(2, 4)
    Player_SetPlayerNameAdvanced(2, "Vaygr Blockade")
    ...
    HW2_InitializeBuilder("VF2_Shipyard", "tempSobGroup_SP")
    SobGroup_CreateSubSystem("VF2_Shipyard", "Vgr_MS_Module_Defensefield")
    SobGroup_CreateSubSystem("VF2_Shipyard", "vgr_shipyard_shield")
    SobGroup_CreateSubSystem("VF2_Shipyard", "vgr_shipyard_shield1")
    SobGroup_CreateSubSystem("VF2_Shipyard", "vgr_ms_plasma")
...
function SetupPlayer_3()
    ...
    SetAlliance(3, 2)
    SetAlliance(3, 4)
    Player_SetPlayerNameAdvanced(3, "Vaygr Blockade")
    ...
    HW2_InitializeBuilder("VF3_Shipyard", "tempSobGroup_SP")
    SobGroup_CreateSubSystem("VF3_Shipyard", "Vgr_MS_Module_Defensefield")
    SobGroup_CreateSubSystem("VF3_Shipyard", "vgr_shipyard_shield")
    SobGroup_CreateSubSystem("VF3_Shipyard", "vgr_shipyard_shield1")
    SobGroup_CreateSubSystem("VF3_Shipyard", "vgr_ms_plasma")
...
function SetupPlayer_4()
    ...
    SetAlliance(4, 2)
    SetAlliance(4, 3)
    Player_SetPlayerNameAdvanced(4, "Vaygr Blockade")
    Player_SetDefaultShipTactic(4, AggressiveTactics)
    CPU_Enable(4, 0)
end

function SetupPlayer_5()
    Player_SetPlayerNameAdvanced(5, "Hiigaran Navy")
    CPU_Enable(5, 1)	--was 0
end
...
function Move_Missile()
    for i = 1,3,1 do
        if  g_pkillerstate[i]==1 then
            Player_FillProximitySobGroup("tempSobGroup_SP", 4, "Planet_Killer_"..i, 5000)
            SobGroup_FillShipsByType("missilesInitialized", "tempSobGroup_SP", "Vgr_PlanetKillerMissile")
...
function Rule_AccelerateMissiles()
    for i = 1,3,1 do
        if Player_IsShipInVolume(4, "Accel_Missile_Destination_"..i)==1 then		--was "while do", dead loop!
            for j = 1,getn(missilesAccelerated),1 do
...
function Rule_Missile_Impact()
	...
	local camerafactor = 9999999/440000
	if (g_missiles_hit_hiigara == 1) then
	g_hiigara_population = 102
	Event_Start("speechevent_firstimpact")
	FX_PlayEffectOnBackgroundVolume("dmg_capital_explosion_combo_planet_killer", "fx_missile_explosion_1", 500*camerafactor)
	...
	FX_PlayEffectOnBackgroundVolume("dmg_capital_explosion_combo_planet_killer", "fx_missile_explosion_2", 500*camerafactor)
	Sound_SFXPlay3D("data:sound/sfx/etg/sp_elements/sp_elements_planet_killer_missle_hit", "Missile_Destination_"..i)
	elseif (g_missiles_hit_hiigara == 3) then
	g_hiigara_population = 21
	Event_Start("speechevent_thirdimpactdetected")
	FX_PlayEffectOnBackgroundVolume("dmg_capital_explosion_combo_planet_killer", "fx_missile_explosion_3", 500*camerafactor)
	Sound_SFXPlay3D("data:sound/sfx/etg/sp_elements/sp_elements_planet_killer_missle_hit", "Missile_Destination_"..i)
	elseif (g_missiles_hit_hiigara == 4) then
	g_hiigara_population = 15000
	Event_Start("speechevent_fourthimpact")
	FX_PlayEffectOnBackgroundVolume("dmg_capital_explosion_combo_planet_killer", "fx_missile_explosion_4", 500*camerafactor)
	Sound_SFXPlay3D("data:sound/sfx/etg/sp_elements/sp_elements_planet_killer_missle_hit", "Missile_Destination_"..i)
	elseif (g_missiles_hit_hiigara == 5) then
	g_hiigara_population = 5333
	Event_Start("speechevent_fifthimpact")
	FX_PlayEffectOnBackgroundVolume("dmg_capital_explosion_combo_planet_killer", "fx_missile_explosion_5", 500*camerafactor)
	Sound_SFXPlay3D("data:sound/sfx/etg/sp_elements/sp_elements_planet_killer_missle_hit", "Missile_Destination_"..i)
	elseif (g_missiles_hit_hiigara == 6) then
	g_hiigara_population = 0
	Event_Start("speechevent_hiigaradestroyed")
	FX_PlayEffectOnBackgroundVolume("dmg_capital_explosion_combo_planet_killer", "fx_missile_explosion_6", 500*camerafactor)
	Sound_SFXPlay3D("data:sound/sfx/etg/sp_elements/sp_elements_planet_killer_missle_hit", "Missile_Destination_"..i)
	Rule_Remove("Rule_Missile_Impact")
	Rule_Add("Rule_PlayerLoses")
	end
...
function Rule_PlayerWins()
	...
	Rule_AddInterval("Rule_FinalCreditsForSimplex", 15)
	end
end

function Rule_FinalCreditsForSimplex()
	Rule_Remove("time")
	Rule_Remove("accolades")
	Rule_Remove("interfacebuttonsFast")
	Rule_Remove("Watch_MusicMenu")
	Subtitle_Message("\n\n\n\n\nSIMPLEX CAMPAIGN\n\n\n\n\nan idea by\n\n\n\n\nsomeone\n\n\n\n\n", 30)
	Rule_Remove("Rule_FinalCreditsForSimplex")
end
...
function VaygrFlee()
	...
	for i = 1,getn(vaygrShipList),1 do
	    for j = 1,4,1 do
	        SobGroup_FillShipsByType("tempSobGroup_SP", "Player_Ships"..j, vaygrShipList[i][1])
	        if  SobGroup_Empty("tempSobGroup_SP")==0 then
	            ...
	            elseif  vaygrShipList[i][2]==1 then
	                SobGroup_EnterHyperSpaceOffMap("tempSobGroup_SP")
	            elseif  vaygrShipList[i][2]==2 then
	                SobGroup_Kamikaze("tempSobGroup_SP", "Player_Ships0")
	            end 
