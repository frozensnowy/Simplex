...
g_playersRUs = 0
g_save_id = 0
AvailableStrikeGroups = 
    { "movers", "wall", "tortoise", "inverted leaping goose", }
SP_abilityList = 
    { AB_Move, AB_Attack, AB_Steering, AB_Targeting, AB_Sensors, AB_Lights, AB_Parade, AB_Retire, }
Events = {}
Events.intelevent_oracleinincontrol = 
    { 
        { 
            ...
            { "Universe_EnableSkip(1)", "", }, HW2_LocationCardEvent("$42520", 5), }, 
        { HW2_Wait(15), }, 
        ...
        { 
            ...
            { "Objective_AddDescription( obj_prim_startresourcing_id, '$42800')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$42534", 4), }, 
        { HW2_Wait(1), }, 
        { 
            { "Timer_Resume(0)", "", }, HW2_Letterbox(0), HW2_Wait(2), 
...
Events.speechevent_mscorestatus_1 = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$42560", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_mscorestatus_2 = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$42561", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_mscorestatus_3 = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$42562", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.intelevent_debrishulks = 
    { 
        ...
        { 
            { "Camera_Interpolate( 'here', 'camera_focusOnHulk', 2)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$42540", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.intelevent_moversattack = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, 
            { "Universe_EnableSkip(1)", "", }, HW2_Letterbox(1), HW2_Wait(2), HW2_Pause(1), }, 
        { 
            { "Sensors_Toggle( 1 )", "", }, HW2_Wait(2), }, 
        { 
            { "g_pointer_default = HW2_CreateEventPointerSobGroup(  'NIS_Movers' )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$42550", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42551", 5), }, 
        { 
            { "obj_prim_defendfleet_id = Objective_Add( obj_prim_defendfleet, OT_Primary )", "", }, 
            { "Objective_AddDescription( obj_prim_defendfleet_id, '$42810')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$42552", 5), }, 
        { 
            { "EventPointer_Remove(g_pointer_default)", "", }, HW2_Wait(0.1), }, 
        { 
            { "Sensors_Toggle( 0 )", "", }, HW2_Letterbox(0), HW2_Wait(2), HW2_Pause(0), 
            { "Universe_EnableSkip(0)", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.intelevent_mothershipisjumping = 
    { 
        ...
        { 
            { "Camera_Interpolate( 'here', 'camera_returnCameraToMothership', 2)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$42571", 5), 
...
Events.intelevent_mothershiphasreturned = 
    { 
        ...
        { 
            ...
            { "Sensors_Toggle( 0 )", "", }, 
            { "Camera_Interpolate( 'here', 'camera_MothershipExitsHyperspace_1', 2)", "", }, HW2_Wait(4), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$42580", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$42581", 5), }, 
        { 
            { "Sensors_Toggle( 1 )", "", }, 
            { "Camera_Interpolate( 'here', 'camera_MSLocationInSensorsManager', 2)", "", }, HW2_Wait(2), }, 
        { 
            { "g_pointer_default = HW2_CreateEventPointerSobGroup(  'DebrisHulk_StageTwo_1' )", "", }, 
            { "g_pointer_default_1 = HW2_CreateEventPointerSobGroup(  'DebrisHulk_StageTwo_2' )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$42583", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42584", 5), }, 
        { 
            { "EventPointer_Remove(g_pointer_default)", "", }, 
            { "EventPointer_Remove(g_pointer_default_1)", "", }, HW2_Wait(0.1), 
            { "Sensors_EnableCameraZoom( 1 )", "", }, 
            { "Sensors_Toggle( 0 )", "", }, 
        }, 
        { 
            { "Timer_Start( 0, g_delaytosecondhyperspace )", "", }, 
            { "Subtitle_TimeCounter( 0, 42523 )", "", }, HW2_Letterbox(0), HW2_Wait(2), 
            { "Universe_EnableSkip(0)", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.intelevent_derelictmoverdetected = 
    { 
        ...
        { 
            ...
            { "Sensors_EnableCameraZoom( 0 )", "", }, 
            { "Sensors_Toggle( 0 )", "", }, HW2_Wait(4), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42591", 5), }, 
        { HW2_Wait(2), }, 
        { 
            { "ping_aliencraft_id = Ping_AddSobGroup( ping_aliencraft, 'anomaly', 'Derelict_Mover' )", "", }, 
            { "Ping_AddDescription(ping_aliencraft_id, 0, '$42930')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$42592", 5), }, 
        { 
            { "Sensors_Toggle( 1 )", "", }, HW2_Wait(2), }, 
        { 
            { "obj_prim_salvagederelict_id = Objective_Add( obj_prim_salvagederelict, OT_Primary )", "", }, 
            { "g_playersalvagingmover = 1", "", }, 
            { "Objective_AddDescription( obj_prim_salvagederelict_id, '$42815')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$42593", 5), }, 
        { 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Sensors_EnableCameraZoom( 1 )", "", }, 
            { "Camera_Interpolate( 'here', 'camera_focusOnFleet2', 2)", "", }, HW2_Wait(2), }, 
        { 
            { "Sensors_Toggle( 0 )", "", }, HW2_Letterbox(0), HW2_Wait(2), HW2_Pause(0), 
            { "Universe_EnableSkip(0)", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
...
Events.intelevent_derelictengineered = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42620", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42621", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42622", 5), }, 
...
Events.intelevent_mothershipreenters = 
    { 
        ...
        { 
            ...
            { "Universe_EnableSkip(1)", "", }, HW2_Letterbox(1), HW2_Wait(2), }, 
        { 
            { "Camera_Interpolate( 'here', 'camera_FocusOnMSExitingHS_3', 2)", "", }, HW2_Wait(2), }, 
        ...
        { 
            { "Sensors_EnableCameraZoom( 0 )", "", }, 
            { "Sensors_Toggle( 1 )", "", }, 
            { "Camera_Interpolate( 'here', 'camera_focusOnLighthouse', 2)", "", }, HW2_Wait(2), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42642", 5), 
            { "g_pointer_default = HW2_CreateEventPointerSobGroup(  'Lighthouse' )", "", }, 
        }, 
        { HW2_Wait(1), }, 
        { 
            { "EventPointer_Remove(g_pointer_default)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$42643", 5), }, 
        { 
            { "Camera_Interpolate( 'here', 'camera_focusOnFleet_3', 2)", "", }, HW2_Wait(2), }, 
        { 
            { "Sensors_Toggle( 0 )", "", }, 
...
Events.intelevent_mothershipreacheslighthouse = 
    { 
        ...
        { 
            ...
            { "PowerOffMovers()", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$42650", 5), }, 
        ...
        { 
            { "SobGroup_EnterHyperSpaceOffMap( 'Player_Ships0' )", "", }, HW2_Wait(12), }, 
        { 
...
function Rule_Init()
    ...
    Player_SetPlayerNameAdvanced(2, "Derelict Hulk")
    Player_SetPlayerNameAdvanced(3, "Derelict Hulk")
    ...
    SobGroup_Create("tempSobGroup_SPOne")
...
function Rule_BuildFromHulk()
    Player_FillShipsByType("tempSobGroup_SP", 2, "Kpr_Mover")
    if  SobGroup_Count("tempSobGroup_SP")>=g_movermax then
        BuildAttackList()
        SobGroup_Attack(2, "tempSobGroup_SP", "g_Players_Ships_To_Attack")
        return
    end 
...
function BuildMover(hulk)
	if SobGroup_Empty(hulk)==0 then
		if Player_GetRace(SobGroup_OwnedBy(hulk)) == Race_Keeper and SobGroup_CanDoAbility(hulk, AB_Builder) == 1 then		--the megalith is not captured or destroyed
	    local mover_temp = SobGroup_CreateShip(hulk, "Kpr_Mover")
	    if  g_stage==1 then
	        SobGroup_SobGroupAdd("NewlyCreatedMovers", mover_temp)
	    elseif  g_stage==2 then
	        if  hulk=="DebrisHulk_StageTwo_1" then
	            SobGroup_SobGroupAdd("NewlyCreatedMovers_1", mover_temp)
	        else
	            SobGroup_SobGroupAdd("NewlyCreatedMovers_2", mover_temp)
	        end 
	    ...
	    elseif  hulk=="DebrisHulk_StageThree_3" then
	        SobGroup_SobGroupAdd("NewlyCreatedMovers_3", mover_temp)
	    else
	        SobGroup_SobGroupAdd("NewlyCreatedMovers_4", mover_temp)
	    end 
	  end
	end
...
function BuildAttackList()
    ...
    SobGroup_SobGroupAdd("g_Players_Ships_To_Attack", "fighters0")
    SobGroup_SobGroupAdd("g_Players_Ships_To_Attack", "corvettes0")
    SobGroup_SobGroupAdd("g_Players_Ships_To_Attack", "frigates0")
    SobGroup_SobGroupAdd("g_Players_Ships_To_Attack", Players_Mothership)
    --for i = 1,getn(nonAttackList),1 do
...
function Rule_Movers_Attack()
    ...
    elseif  g_stage==2 then
        hulks_to_test = 
    { "DebrisHulk_StageTwo_1", "DebrisHulk_StageTwo_2", }
    elseif  g_stage==3 then
        hulks_to_test = 
    { "DebrisHulk_StageThree_1", "DebrisHulk_StageThree_2", "DebrisHulk_StageThree_2", "Lighthouse", }
    else
        return
    end 

    if  g_stage==1 then
        Player_FillProximitySobGroup("tempSobGroup_SP", 2, hulks_to_test, 4000)
        SobGroup_FillShipsByType("tempSobGroup_SPOne", "tempSobGroup_SP", "Kpr_Mover")
        if SobGroup_Empty("tempSobGroup_SPOne")==0 then		--was "while do", dead loop!
            if  SobGroup_Count("tempSobGroup_SPOne")<g_minmoverstoattack then
                SobGroup_FormStrikeGroup("tempSobGroup_SPOne", AvailableStrikeGroups[1])
            end 

            BuildAttackList()
            SobGroup_Attack(2, "tempSobGroup_SPOne", "g_Players_Ships_To_Attack")
        end 

    else
        for i = 1,getn(hulks_to_test),1 do
            Player_FillProximitySobGroup("tempSobGroup_SP", 2, hulks_to_test[i], 4000)
            SobGroup_FillShipsByType("tempSobGroup_SPOne", "tempSobGroup_SP", "Kpr_Mover")
            if  SobGroup_Empty("tempSobGroup_SPOne")==0 then
                if  SobGroup_Count("tempSobGroup_SPOne")<g_minmoverstoattack then
                    SobGroup_FormStrikeGroup("tempSobGroup_SPOne", AvailableStrikeGroups[1])
                end 

                if  g_stage==3 and hulks_to_test[i]=="Lighthouse" then
                    SobGroup_Attack(2, "tempSobGroup_SPOne", Players_Mothership)
                else
                    BuildAttackList()
                    SobGroup_Attack(2, "tempSobGroup_SPOne", "g_Players_Ships_To_Attack")
                end 
...
function Rule_SaveAfterMoverReengineerdEvent()
    if  Event_IsDone("intelevent_derelictengineered")==1 then
        ...
        SobGroup_CreateSubSystem(Players_Mothership, "SP_AntiMoverOption")
...
function Rule_MothershipAtLighthouse()
    if  SobGroup_FillSobGroupInVolume("tempSobGroup_SP", Players_Mothership, "vol_Lighthouse")==1 then
...
function PowerOffMovers()
    Player_FillShipsByType("tempSobGroup_SP", 2, "Kpr_Mover")
    for i = 1,getn(SP_abilityList),1 do
        SobGroup_AbilityActivate("tempSobGroup_SP", SP_abilityList[i], 0)
    end 
    SobGroup_Stop(2, "tempSobGroup_SP")
end
