...
Events.intelevent_clearinhibitors = 
    { 
        { 
            ...
            { "Camera_Interpolate( 'here', 'Camera_Startpos', 0 )", "", }, HW2_Wait(5), }, 
        { HW2_LocationCardEvent("$41521", 6), }, 
        { 
            { "Sound_EnterIntelEvent()", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$41530", 8), }, 
        { HW2_Wait(1), }, 
        { HW2_Letterbox(1), 
            { "Universe_EnableSkip(1)", "", }, HW2_Pause(1), HW2_Wait(2), }, 
        { 
            { "Sensors_Toggle( 1 )", "", }, HW2_Wait(2), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41532", 8), 
        ...
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41533", 8), }, 
        { HW2_Wait(1), 
        ...
        { 
            ...
            { "EventPointer_Remove(g_pointer_inhibitor3_id)", "", }, HW2_Wait(2), 
            { "Camera_Interpolate( 'here', 'Camera_CommLong', 2)", "", }, 
        }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41534", 8), 
            { "g_pointer_comm_station_id = HW2_CreateEventPointerSobGroup('Communications_Station' )", "", }, 
        }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41535", 8), }, 
        { HW2_Wait(1), }, 
        { 
            { "EventPointer_Remove(g_pointer_comm_station_id)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$41536", 8), 
        ...
        { 
            ...
            { "Objective_AddDescription( obj_prim_destroy_inhibitors_id, '$41980')", "", }, HW2_Pause(0), HW2_Letterbox(0), 
...
Events.intelevent_minefield = 
    { 
        ...
        { 
            { "Universe_EnableSkip(1)", "", }, HW2_Pause(1), HW2_Letterbox(1), 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Wait(2), }, 
        { 
            { "Camera_Interpolate( 'here', g_minediscovered, 2)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$41540", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41541", 10), }, 
        { HW2_Wait(1), 
        ...
        { 
            ...
            { "Objective_AddDescription( obj_sec_build_minelayer_id, '$41955')", "", }, HW2_Letterbox(0), HW2_Pause(0), HW2_Wait(2), 
            { "Universe_EnableSkip(0)", "", }, 
...
Events.autofocus_minelayerbuilt = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$41550", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41551", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41552", 10), 
...
Events.autofocus_gate = 
    { 
        ...
        { 
            ...
            { "FOW_ForceUpdate()", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$41560", 10), }, 
        { HW2_Pause(0), HW2_SubTitleEvent(Actor_FleetIntel, "$41561", 10), }, 
        { HW2_Wait(1), }, 
        { 
            ...
            { "Objective_AddDescription( obj_sec_capture_gate_id, '$41991')", "", }, HW2_Letterbox(0), HW2_Wait(2), 
            { "Universe_EnableSkip(0)", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.voiceover_comm_stage_1 = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$41570", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41571", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41572", 10), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.voiceover_comm_stage_2 = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$41575", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41576", 10), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.voiceover_comm_stage_3 = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$41580", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41581", 10), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.voiceover_carrier_destroyed = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$41588", 10), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.intelevent_stationoperational = 
    { 
        ...
        { 
            { "Camera_FocusSobGroupWithBuffer( 'Communications_Station', 2000, 2000, 2)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$41585", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41586", 10), }, 
...
Events.speechevent_onedown = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41590", 10), }, 
    }
Events.speechevent_twodown = 
    { 
        { 
            { "evt_speechevent_onedown_started = 1", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$41595", 5), }, 
    }
Events.speechevent_alldown = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41600", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41601", 5), }, 
    }
Events.intelevent_tacjumpon = 
    { 
        { 
            { "evt_intelevent_tacjumpon_started = 1", "", }, 
            { "evt_isplaying = 1", "", }, HW2_Wait(4), }, 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$41620", 10), }, 
        { HW2_Letterbox(1), 
            { "Camera_AllowControl(0)", "", }, 
            { "Universe_AllowPlayerOrders( 0 )", "", }, 
            { "SobGroup_DeSelectAll()", "", }, HW2_Wait(2), 
        ...
        { 
            ...
            --{ "SobGroup_ForceStayDockedIfDocking( 'g_Players_Ships_Docked' )", "", }, 
            --{ "SobGroup_DockSobGroupInstant_Smart ('g_Players_Ships_Docked', Players_Mothership)", "", }, 
            HW2_Wait(2), }, 
        { HW2_Fade(0), HW2_Wait(2), }, 
        { 
            { "SobGroup_Stop(0, Players_Mothership)", "", },		--g_Ships_To_Exit_Hyperspace
            { "SobGroup_EnterHyperSpaceOffMap(Players_Mothership)", "", }, 		--g_Ships_To_Exit_Hyperspace
        }, 
        { HW2_Wait(10), }, 
        { 
...
Events.intelevent_tacjumpon_2 = 
    { 
        { 
            { "SobGroup_ExitHyperSpace(Players_Mothership, 'HyperspaceDestination')", "", }, HW2_Wait(0.5), }, 
            --{ "SobGroup_Launch( 'g_Players_Ships_Docked', Players_Mothership )", "", }, 
        { 
        ...
        { 
            ...
            { "Universe_AllowPlayerOrders( 1 )", "", }, HW2_Wait(4), }, 
        { 
            ...
            { "Ping_AddDescription(ping_communications_station_id, 0, '$41960')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$41534", 10), }, 
        { 
            ...
            { "Objective_AddDescription( obj_prim_destroyvaygr_id, '$41995')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$41535", 10), }, 
        { 
            { "EventPointer_Remove(g_pointer_default)", "", }, HW2_Wait(1), 
...
Events.speechevent_stationattacks = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41640", 10), 
...
Events.intelevent_eliminatecommstation = 
    { 
        { 
            { "evt_isplaying = 1", "", }, HW2_Pause(1), 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Letterbox(1), 
            { "Universe_EnableSkip(1)", "", }, HW2_Wait(2), }, 
        { 
            { "Camera_Interpolate( 'here', 'Camera_CommShort', 2)", "", }, HW2_Wait(2), }, 
        { 
            { "g_pointer_default = HW2_CreateEventPointerSobGroup( 'Communications_Station' )", "", }, 
            { "ping_communications_station_id = Ping_AddSobGroup( ping_communications_station, 'anomaly', 'Communications_Station' )", "", }, 
            { "Ping_AddDescription(ping_communications_station_id, 0, '$41960')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$41534", 10), }, 
        { HW2_Wait(1), }, 
        { 
            { "EventPointer_Remove(g_pointer_default)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$41535", 10), 
            { "obj_prim_destroy_comms_subsystem_id = Objective_Add( obj_prim_destroy_comms_subsystem , OT_Primary )", "", }, 
            { "Objective_AddDescription( obj_prim_destroy_comms_subsystem_id, '$41985')", "", }, 
            { "obj_prim_destroyvaygr_id = Objective_Add( obj_prim_destroyvaygr , OT_Primary )", "", }, 
        ...
        { 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Universe_EnableSkip(0)", "", }, HW2_Letterbox(0), HW2_Pause(0), HW2_Wait(2), 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
            { "evt_isplaying = 0", "", }, 
        }, 
...
Events.intelevent_vaygrandcommdestroyed = 
    { 
        ...
        { 
            ...
            { "Universe_EnableSkip(1)", "", }, 
            { "Camera_FocusSobGroupWithBuffer( Players_Mothership, 2000, 2000, 2)", "", }, 
            { "Universe_AllowPlayerOrders( 0 )", "", }, HW2_Wait(2), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41650", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41651", 10), }, 
        { HW2_Fade(1), HW2_Wait(2), }, 
        { 
        ...
        { HW2_Fade(0), HW2_Wait(2), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$41652", 10), }, 
        { 
            { "SobGroup_EnterHyperSpaceOffMap( 'Player_Ships0' )", "", }, HW2_Wait(15), }, 
        { 
...
Events.speechevent_stationdown_vaygrleft = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41650", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41653", 10), 
...
Events.intelevent_vayrgkilled_aftersub = 
    { 
        ...
        { 
            ...
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Letterbox(1), 
            { "Camera_FocusSobGroupWithBuffer( Players_Mothership, 2000, 2000, 2)", "", }, HW2_Wait(2), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41651", 10), }, 
        { 
            { "Universe_AllowPlayerOrders( 0 )", "", }, HW2_Fade(1), HW2_Wait(2), }, 
        { 
            { "Player_InstantlyGatherAllResources( 0 )", "", }, 
            --{ "Player_InstantDockAndParade( 0, Players_Mothership, 0 )", "", }, 
            { "SP_SobGroup_DockOrParadeSobGroupAtEnd( 'Player_Ships0', Players_Mothership)", "", }, 
...
Events.speechevent_anticorvettefrigatesavailable = 
    { 
        { HW2_Wait(5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41610", 10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41611", 10), }, 
    }
Events.speechevent_carrieravailable = 
    { 
        { HW2_Wait(5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$41630", 10), }, 
    }
...
function Enable_ResearchOptions()
    ...
    Player_RestrictResearchOption(0, "IonFrigateTech")
    Player_RestrictResearchOption(0, "DefenseFieldFrigateShield")
		Player_RestrictResearchOption(0, "DestroyerTech")
		Player_RestrictResearchOption(0, "SweeperDestroyerTech")
		Player_RestrictResearchOption(0, "MissileDestroyerTech")
		Player_RestrictResearchOption(0, "IonDestroyerTech")
		Player_RestrictResearchOption(0, "AdvDestroyerTech")
		Player_RestrictResearchOption(0, "ArtilleryDestroyerTech")
		Player_RestrictResearchOption(0, "JuggernaughtTech")
...
function Rule_AI_Init_1()
    Player_SetPlayerNameAdvanced(1, "Vaygr Fleet")
    Player_SetRU(1, 1000)
...
function Rule_AI_Init_2()
    CPU_Enable(2, 0)
    Player_SetPlayerNameAdvanced(2, "Vaygr Fleet")
...
function Rule_AI_Init_4()
    Player_SetPlayerNameAdvanced(4, "Vaygr Command Outpost")
    SobGroup_SetCaptureState("Communications_Station", 0)
    Player_RestrictBuildOption(4, "vgr_qje_quadflechette_stbd_cf")
    Player_RestrictBuildOption(4, "vgr_ion1")
    Player_RestrictBuildOption(4, "hgn_commandfortress_defencefacility")
    SetAlliance(4, 1)
    SetAlliance(4, 2)
    SetAlliance(4, 3)
    ...
    if SobGroup_GetHardPointHealth("Communications_Station", "Production 1") == 0 then
    	SobGroup_CreateSubSystem_OnStart("Communications_Station", "hgn_commandfortress_comunicationfacility")
    end
...
function AI_BulkResearchGrant(AI_Number)
    ...
    Player_GrantResearchOption(AI_Number, "HeavyMissileFrigate")
    Player_GrantResearchOption(AI_Number, "MultiCannonTech")
    Player_GrantResearchOption(AI_Number, "SupportFrigateArmedTech")
end
...
function Rule_End_Tacjump()
    if  evt_intelevent_tacjumpon_ended==1 then
        if  SobGroup_AreAllInHyperspace(Players_Mothership)==1 then		--g_Ships_To_Exit_Hyperspace
...
function Rule_Defend_Station()
    if  Player_FillProximitySobGroup("tempSobGroup_SP", 0, "Communications_Station", 8000)==1 then
...
function CleanPlayersGroup()
    ...
    local nonHyperspaceList = {"hgn_viper", "hgn_minermissile", "hgn_minermissile1", "hgn_tangomine", "hgn_ecmprobe", "hgn_proximitysensor", "hgn_evacuationcell", "hgn_probe", "hgn_massiveturret"}
    for i = 1,getn(nonHyperspaceList),1 do
    ...
    local nonDockList = {"hgn_scaver", "hgn_researchstation", "hgn_power", "hgn_crewstation", "hgn_hyperspacestation", "hgn_hscore", "hgn_mothership", "hgn_lightcarrier", "hgn_carrier"}
    for i = 1,getn(nonDockList),1 do
