...
ConvoyDamaged = 
    { 0, 0, 0, 0, 0, 0, }
convoyGroups = 
    { "Convoy_1", "Convoy_2", "Convoy_3", "Convoy_4", "Convoy_5", "Convoy_6", }
interceptorGroups = 
    { "Convoy2Interceptors2", "Convoy2Interceptors3", }
targetGroups = 
    { "Convoy2Bombers2", "Convoy2Bombers3", }
Events = {}
Events.intelevent_convoysUnderAttack = 
    { 
        { 
            { "Rule_Add ('Rule_PlaySaveGameLocationCard')", "", }, HW2_Wait(1), }, 
        { 
            { "g_save_id = g_save_id + 1", "", }, 
            { "Campaign_QuickSaveNb( g_save_id, '$6403' )", "", }, 
        }, 
        { HW2_Wait(2), }, 
        { HW2_LocationCardEvent("$40020", 6), 
            { "Sound_EnableAllSpeech( 1 )", "", }, 
            { "Camera_UsePanning(1)", "", }, 
        }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$40024", 8), }, 
        { HW2_Wait(1.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$40018", 4), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40025", 10), }, 
        { HW2_Wait(2), }, 
        { HW2_Letterbox(1), 
        ...
        { 
            { "Camera_FocusSave()", "", }, 
            { "Sensors_Toggle( 1 )", "", }, 
            { "FOW_RevealGroup('Convoy3Bombers1', 1)", "", }, 
            { "FOW_RevealGroup('Convoy3Interceptors1', 1)", "", }, 
            { "FOW_RevealGroup('Convoy4Bombers1', 1)", "", }, 
            { "FOW_RevealGroup('Convoy4Interceptors1', 1)", "", }, 
            { "FOW_RevealGroup('Convoy5Bombers1', 1)", "", }, 
            { "FOW_RevealGroup('Convoy5Interceptors1', 1)", "", }, 
            { "FOW_RevealGroup('Convoy6Bombers1', 1)", "", }, 
            { "FOW_RevealGroup('Convoy6Interceptors1', 1)", "", }, 
            { "FOW_ForceUpdate()", "", }, 
        }, 
        { 
            { "Camera_Interpolate( 'here', 'camera3', 1)", "", }, HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40039", 8), 
            { "ping_Convoy_1_id = Ping_AddSobGroup( ping_Convoy_1, 'anomaly', 'Convoy_1' )", "", }, 
        ...
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40019", 8), 
            { "pointer_enemyCarrier_id = HW2_CreateEventPointerSobGroup('EnemyCarrier')", "", }, 
        }, 
        { HW2_Wait(2), }, 
        { 
            { "EventPointer_Remove(pointer_enemyCarrier_id)", "", }, 
            { "Camera_FocusSobGroup( 'Convoy_1', 1, 13000, 1 )", "", }, 
        }, 
        { HW2_Wait(1.5), }, 
        { 
            { "pointer_convoy1_id = HW2_CreateEventPointerSobGroup('Convoy_1')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$40027", 10), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40029", 10), 
        ...
        { HW2_Wait(1), }, 
        { 
            { "EventPointer_Remove(pointer_convoy1_id)", "", }, 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Camera_FocusRestore()", "", }, HW2_Pause(0), HW2_Letterbox(0), 
        ...
        { 
            ...
            { "EventPlaying = 0", "", }, 
            { "Rule_Add ('Rule_IntelEvent_RecommendCollectors')", "", }, 
        }, 
    }
Events.intelevent_RecommendCollectors = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40023", 8), 
        ...
        { 
            ...
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
        }, 
    }
Events.intelevent_firstMSMove = 
    { 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$40090", 4), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$40091", 4), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_corvetteSubsystemComplete = 
    { 
        { 
            { "Objective_SetState( obj_sec_buildCorvetteFacility_id, OS_Complete )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$40230", 5), 
            { "Objective_SetState( obj_sec_buildCorvetteFacility_id, OS_Complete )", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40231", 8), 
            { "UI_FlashButton('NewTaskbar', 'btnBuild', 10)", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40232", 8), }, 
        { 
            { "Rule_AddInterval ('Rule_intelevent_recommendCorvettes', 3)", "", }, HW2_Wait(0.5), }, 
        { 
            { "Sound_SetMuteActor('')", "", }, 
...
Events.intelevent_pulsarCorvetteAvailable = 
    { 
        ...
        { 
            ...
            { "Player_UnrestrictResearchOption(0, 'PulsarCorvetteTech')", "", }, 
            { "Player_GrantResearchOption_Smart(0, 'PulsarCorvetteTech')", "", }, 
            HW2_SubTitleEvent(Actor_FleetIntel, "$40235", 8), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40236", 8), }, 
        { 
            { "Sound_SetMuteActor('')", "", }, 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.intelevent_recommendCorvettes = 
    { 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40239", 8), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_convoy_1_Lost = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40030", 4), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_convoy_2_Lost = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40040", 4), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_convoy_3_Lost = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40050", 4), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_convoy_4_Lost = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40060", 4), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_convoy_5_Lost = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40070", 4), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_convoy_6_Lost = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40080", 4), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_3convoys_Lost = 
    { 
        { HW2_Pause(1), HW2_Letterbox(1), HW2_Fade(1), HW2_Wait(2), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40150", 10), 
...
Events.intelevent_convoy_1_Saved = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40031", 6), 
            { "Ping_Remove( ping_Convoy_1_id )", "", }, 
        }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.intelevent_convoy_2_Saved = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40041", 6), 
            { "Ping_Remove( ping_Convoy_2_id )", "", }, 
        }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.intelevent_convoy_3_Saved = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40051", 6), 
            { "Ping_Remove( ping_Convoy_3_id )", "", }, 
        }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.intelevent_convoy_4_Saved = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40061", 6), 
            { "Ping_Remove( ping_Convoy_4_id )", "", }, 
        }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.intelevent_convoy_5_Saved = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40071", 6), 
            { "Ping_Remove( ping_Convoy_5_id )", "", }, 
        }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.intelevent_convoy_6_Saved = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40081", 6), 
...
Events.intelevent_convoy_CriticalDamage_1 = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40034", 6), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40035", 6), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_convoy_CriticalDamage_2 = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40044", 6), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40045", 6), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_convoy_CriticalDamage_3 = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40054", 6), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40055", 6), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_convoy_CriticalDamage_4 = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40064", 6), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40065", 6), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_convoy_CriticalDamage_5 = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40074", 6), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40075", 6), }, 
        { HW2_Wait(2), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_convoy_CriticalDamage_6 = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40084", 6), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40085", 6), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_enemyReinforcements = 
    { 
        { HW2_Wait(0.5), }, 
        { 
            { "Rule_Add ('Rule_PlayBattleMusic')", "", }, HW2_Letterbox(1), 
            { "Universe_EnableSkip(1)", "", }, HW2_Wait(4), }, 
        { 
            { "Camera_FocusSobGroup( 'EnemyCarrier', 1, 1500, 1 )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$40200", 8), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40201", 10), 
        ...
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40202", 8), }, 
        { HW2_Wait(3), }, 
        { 
            { "EventPointer_Remove(pointer_fighterFacility_id)", "", }, HW2_Wait(0.5), }, 
        { HW2_Letterbox(0), }, 
        { 
            { "Universe_EnableSkip(0)", "", }, 
        ...
        { 
            { "g_save_id = g_save_id + 1", "", }, 
            { "Campaign_QuickSaveNb( g_save_id, '$6404' )", "", }, 
        }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.intelevent_TEST_UNLOCK = 
    { 
        ...
        { 
            ...
            { "Player_GrantResearchOption( 0, 'SensorsBackToNormal1' )", "", }, 
            { "Player_GrantResearchOption( 0, 'SensorsBackToNormal2' )", "", }, 
            { "Player_GrantResearchOption( 0, 'SensorsBackToNormal3' )", "", }, 
        }, 
    }
Events.intelevent_Reward1 = 
    { 
        { 
            { "rewardEventHasStarted = 1", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$40100", 3), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$40101", 3), }, 
        { HW2_Wait(0.5), }, 
        { 
            { "rewardEventPlaying = 0", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$40103", 6), 
            { "UI_FlashButton('NewTaskbar', 'btnBuild', 10)", "", }, 
            { "Rule_AddInterval ('Rule_checkCorvetteSubsystemComplete', 3)", "", }, 
            { "Player_UnrestrictBuildOption(0, 'CorvetteProduction')", "", }, 
            { "pilotrecruitList[1] = pilotmaxList[1]", "", }, 		--add pilots
            { "officerrecruitList[1] = officermaxList[1]", "", }, 		--add officers
        }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40104", 8), 
        ...
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(3), }, 
        { 
...
Events.intelevent_Reward2 = 
    { 
        { 
            { "rewardEventHasStarted = 1", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$40100", 3), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$40111", 3), }, 
        { HW2_Wait(0.5), }, 
        { 
            { "rewardEventPlaying = 0", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$40113", 10), 
...
Events.intelevent_Reward3 = 
    { 
        { 
            { "rewardEventHasStarted = 1", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$40100", 3), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$40106", 3), }, 
        { HW2_Wait(0.5), }, 
        { 
            { "rewardEventPlaying = 0", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$40108", 6), 
            { "Player_UnrestrictResearchOption( 0, 'SensorsBackToNormal1' )", "", }, 
            { "Player_UnrestrictResearchOption( 0, 'SensorsBackToNormal2' )", "", }, 
            { "Player_UnrestrictResearchOption( 0, 'SensorsBackToNormal3' )", "", }, 
            { "Player_GrantResearchOption( 0, 'SensorsBackToNormal1' )", "", }, 
...
Events.intelevent_Reward4 = 
    { 
        { 
            { "rewardEventHasStarted = 1", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$40100", 3), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$40121", 3), }, 
        { HW2_Wait(0.5), }, 
        { 
            { "rewardEventPlaying = 0", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$40123", 6), 
            { "SobGroup_SetSpeed('PlayerMothership', 1.0)", "", }, 
        }, 
        { HW2_Wait(10), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40126", 8), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(3), }, 
        { 
            { "rewardEventHasStarted = 0", "", }, 
...
Events.intelevent_Reward5 = 
    { 
        { 
            { "rewardEventHasStarted = 1", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$40100", 3), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$40131", 3), }, 
        { HW2_Wait(0.5), }, 
        { 
            { "rewardEventPlaying = 0", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$40134", 3), 
...
Events.intelevent_Reward6 = 
    { 
        { 
            { "rewardEventHasStarted = 1", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$40100", 3), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$40141", 3), }, 
        { HW2_Wait(0.5), }, 
        { 
            { "rewardEventPlaying = 0", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$40144", 8), 
...
Events.intelevent_frigateAttack = 
    { 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$40160", 3), 
            { "FOW_RevealGroup('FrigateAttackers', 1)", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { HW2_Letterbox(1), 
            { "Universe_EnableSkip(1)", "", }, HW2_Wait(4), }, 
        { 
            { "Camera_FocusSobGroup( 'FrigateGuardFocus', 1, 500, 1 )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$40161", 8), 
            { "ping_frigateAttackers_id = Ping_AddSobGroup( ping_frigateAttackers, 'anomaly', 'FrigateAttackers' )", "", }, 
            { "Ping_AddDescription(ping_frigateAttackers_id, 0, '$40427')", "", }, 
        }, 
        { HW2_Wait(3), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40162", 8), }, 
        { HW2_Wait(1), }, 
        { HW2_Letterbox(0), 
            { "Universe_EnableSkip(0)", "", }, 
            { "Sensors_EnableToggle(1)", "", }, 
...
Events.intelevent_MelarnIsComing = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40167", 8), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40168", 4), }, 
        { 
...
Events.intelevent_WithHelpOfMelarn = 
    { 
        ...
        { 
            { "g_save_id = g_save_id + 1", "", }, 
            { "Campaign_QuickSaveNb( g_save_id, '$6405' )", "", }, 
        }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40170", 8), }, 
        { HW2_Wait(1), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.intelevent_frigatesDestroyed = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40165", 8), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_melarnDamaged = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40240", 8), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40241", 8), 
            { "ping_melarnSoban_id = Ping_AddSobGroup( ping_melarnSoban, 'anomaly', 'MelarnSoban' )", "", }, 
        ...
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40242", 3), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_melarnCriticallyDamaged = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40243", 8), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40242", 3), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
...
Events.intelevent_melarnDestroyed = 
    { 
        { HW2_Pause(1), HW2_Letterbox(1), HW2_Fade(1), HW2_Wait(2), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40245", 8), }, 
        { HW2_LocationCardEvent("$40021", 4), }, 
        { 
            { "setMissionComplete( 0 )", "", }, 
        }, 
...
Events.intelevent_carrierFleeing = 
    { 
        { 
            { "Universe_EnableSkip(1)", "", }, HW2_Letterbox(1), }, 
        { HW2_Wait(0.5), }, 
        { HW2_Pause(1), }, 
        { HW2_Wait(3), }, 
        { 
        ...
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40175", 6), 
            { "pointer_enemyCarrier_id = HW2_CreateEventPointerSobGroup('EnemyCarrier')", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40176", 10), 
            ...
            { "ping_enemyCarrier_id = Ping_AddSobGroup( ping_enemyCarrier, 'anomaly', 'EnemyCarrier' )", "", }, 
        ...
        { 
            { "EventPointer_Remove(pointer_enemyCarrier_id)", "", }, HW2_Wait(2), }, 
        { 
            { "Universe_EnableSkip(0)", "", }, HW2_Pause(0), HW2_Letterbox(0), 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Rule_AddInterval('Rule_intelevent_carrierEscaped',3)", "", }, 
        }, 
        { 
            { "Rule_Add ('Rule_PlaySaveGameLocationCard')", "", }, HW2_Wait(1), }, 
        { 
            { "g_save_id = g_save_id + 1", "", }, 
            { "Campaign_QuickSaveNb( g_save_id, '$6406' )", "", }, 
        }, 
        { HW2_Wait(2), 
            { "Sound_ExitIntelEvent()", "", }, 
        }, 
...
Events.intelevent_carrierEscaped = 
    { 
        { HW2_Letterbox(1), HW2_Wait(4), }, 
        { 
            { "Camera_FocusSobGroup( 'EnemyCarrier', 1, 1500, 1 )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$40177", 7), 
            { "Objective_SetState( obj_sec_destroyFighterFacility_id, OS_Failed )", "", }, 
            { "Ping_Remove( ping_enemyCarrier_id )", "", }, 
            { "Ping_Remove( ping_carrierExitPoint_id )", "", }, 
        }, 
        { HW2_Wait(2), }, 
        { HW2_Fade(2), HW2_Wait(2), }, 
        { HW2_LocationCardEvent("$40021", 4), }, 
        { 
            { "setMissionComplete( 0 )", "", }, 
        }, 
...
Events.intelevent_carrierDestroyed = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40178", 6), 
            { "carrierDestroyed = 1", "", }, 
            { "Objective_SetState( obj_prim_destroycarrier_id, OS_Complete )", "", }, 
            { "Ping_Remove( ping_carrierExitPoint_id )", "", }, HW2_Wait(4), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Rule_AddInterval ('Rule_intelevent_sobanLeaving', 2)", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_sobanLeaving = 
    { 
        { 
            { "Universe_EnableSkip(1)", "", }, HW2_Letterbox(1), HW2_Wait(4), }, 
        { HW2_Wait(0.5), }, 
        { 
            ...
            { "SobGroup_Stop( 4, 'MelarnSoban')", "", }, 
            { "SobGroup_Stop( 3, 'MelarnFleet')", "", }, 
            { "Ping_Remove( ping_melarnSoban_id )", "", }, 
            { "SobGroup_FormStrikeGroup( 'MelarnFleetAll', 'tortoise')", "", }, 
            { "SobGroup_Move( 4, 'MelarnSoban', 'MelarnMovePoint' )", "", }, 
            { "SobGroup_Move( 3, 'MelarnFleet', 'MelarnMovePoint' )", "", }, HW2_SubTitleEvent(Actor_Talorn, "$40179", 2), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_Talorn, "$40180", 7), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_Talorn, "$40181", 6), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_Talorn, "$40182", 6), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_Talorn, "$40183", 8), }, 
        { 
            { "Rule_Add ('Rule_melarnHyperspaceOut')", "", }, HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_Talorn, "$40185", 3), 
            { "tellMelarnToHyperspaceOut = 1", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { 
            { "Rule_Add('Rule_intelevent_standbyForHyperspace')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$40190", 8), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40191", 7), }, 
        { HW2_Wait(1), }, 
        { 
            { "SobGroup_SetInvulnerability( 'Player_Ships0', 0 )", "", }, HW2_Letterbox(0), 
            { "Universe_EnableSkip(0)", "", }, 
            { "Sensors_EnableToggle(1)", "", }, 
        }, 
        { 
        ...
        { 
            { "g_save_id = g_save_id + 1", "", }, 
            { "Campaign_QuickSaveNb( g_save_id, '$6407' )", "", }, 
        }, 
        { HW2_Wait(2), 
            { "Sound_ExitIntelEvent()", "", }, 
        }, 
...
Events.intelevent_standbyForHyperspace = 
    { 
        ...
        { 
            ...
            { "Camera_FocusSobGroup( 'PlayerMothership', 1, 2500, 1 )", "", }, HW2_Wait(1), }, 
        { 
            { "Rule_Add ('Rule_convoysReturnHome')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$40197", 5), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$40192", 6), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$40193", 5), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$40195", 5), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$40194", 6), 
        ...
        { HW2_Wait(2.5), }, 
        { 
            { "Rule_Remove ('Rule_convoyLostWatch')", "", }, 
            { "Rule_Remove ('Rule_intelevent_convoysDamaged')", "", }, 
            { "SobGroup_Despawn( 'Convoy_1' )", "", }, 
            { "SobGroup_Despawn( 'Convoy_2' )", "", }, 
            { "SobGroup_Despawn( 'Convoy_3' )", "", }, 
            { "SobGroup_Despawn( 'Convoy_4' )", "", }, 
            { "SobGroup_Despawn( 'Convoy_5' )", "", }, 
            { "SobGroup_Despawn( 'Convoy_6' )", "", }, 
            --{ "Player_InstantDockAndParade( 0, 'PlayerMothership', 0 )", "", 0, }, 
            { "SP_SobGroup_DockOrParadeSobGroupAtEnd( 'Player_Ships0', 'PlayerMothership')", "", }, 
...
Events.intelevent_fighterFacilityDestroyed = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$40252", 8), 
...
function OnStartOrLoad_m02()
    FX_PlayEffectOnBackground("m02_explosion_spray", 
    { -1.5, -0.1, -1, }, 10)
end
...
function Enable_ResearchOptions()
		Player_UnrestrictBuildOption(0, "FireControlTower")
		Player_UnrestrictBuildOption(0, "Research")
		Player_RestrictResearchOption(0, "GraviticAttractionMines")
		Player_RestrictBuildOption(0, "hgn_ms_module_hyperspace")
    Player_RestrictBuildOption(0, "hgn_lc_module_hyperspace")
    Player_RestrictBuildOption(0, "hgn_c_module_hyperspace")
		--Player_UnrestrictBuildOption(0, "AdvancedResearch")
		--Player_UnrestrictBuildOption(0, "AdvancedResearch1")
...
function Rule_Init2()
    ...
    Player_SetPlayerNameAdvanced(1, "Vaygr")
    ...
    SobGroup_CreateSubSystem_OnStart("EnemyCarrier", "FighterProduction")
    ...
    Player_RestrictBuildOption(0, "CapShipProduction")
    Player_RestrictBuildOption(0, "RepairSystem")
    Player_RestrictBuildOption(0, "PlatformProduction")
    Player_RestrictBuildOption(0, "FireControlTower")
    Player_RestrictBuildOption(0, "Research")
		Player_RestrictBuildOption(0, "AdvancedResearch")
		Player_RestrictBuildOption(0, "AdvancedResearch1")
    ...
    Player_RestrictResearchOption(0, "PulsarCorvetteTech")
...
function EscortSetup()
    ...
    if  BomberEscortsGiven==2 then
        ...
        SobGroup_SetTeamColours("EscortBombers1", 
    { 0.365, 0.553, 0.667, } , 
    { 0.8, 0.8, 0.8, }, "DATA:Badges/Hiigaran.tga")
        SobGroup_ParadeSobGroup("EscortBombers1", "PlayerMothership", 0)
        SobGroup_SetTeamColours("EscortBombers2", 
    { 0.365, 0.553, 0.667, } , 
    { 0.8, 0.8, 0.8, }, "DATA:Badges/Hiigaran.tga")
...
function Rule_spawnEliteFighters1()
    EliteFighters1 = SobGroup_CreateShip("PlayerMothership", "hgn_strategicbomberl")		--Hgn_AttackBomberElite
    SobGroup_SetTeamColours(EliteFighters1, 
    { 0.752, 0.694, 0.556, } , 
...
function Rule_spawnEliteFighters2()
    EliteFighters2 = SobGroup_CreateShip("PlayerMothership", "hgn_strategicbomberl")		--Hgn_AttackBomberElite
    SobGroup_SetTeamColours(EliteFighters2, 
    { 0.752, 0.694, 0.556, } , 
    { 1, 1, 1, }, "DATA:Badges/Hiigaran.tga")
...
function Rule_spawnEliteFighters3()
    EliteFighters3 = SobGroup_CreateShip("PlayerMothership", "hgn_attackbomberheavyl")		--Hgn_AttackBomberElite
    SobGroup_SetTeamColours(EliteFighters3, 
    { 0.752, 0.694, 0.556, } , 
    { 1, 1, 1, }, "DATA:Badges/Hiigaran.tga")
...
function Rule_spawnEliteFighters4()
    EliteFighters4 = SobGroup_CreateShip("PlayerMothership", "hgn_attackbomberheavyl")		--Hgn_AttackBomberElite
    SobGroup_SetTeamColours(EliteFighters4, 
    { 0.752, 0.694, 0.556, } , 
    { 1, 1, 1, }, "DATA:Badges/Hiigaran.tga")
...
function Rule_spawnEliteCorvettes1()
    EliteCorvettes1 = SobGroup_CreateShip("PlayerMothership", "hgn_gunshipcoevettel")		--Hgn_AssaultCorvetteElite
    SobGroup_SetTeamColours(EliteCorvettes1, 
    { 0.752, 0.694, 0.556, } , 
    { 1, 1, 1, }, "DATA:Badges/Hiigaran.tga")
...
function Rule_spawnEliteCorvettes2()
    EliteCorvettes2 = SobGroup_CreateShip("PlayerMothership", "hgn_gunshipcoevettel")		--Hgn_AssaultCorvetteElite
    SobGroup_SetTeamColours(EliteCorvettes2, 
    { 0.752, 0.694, 0.556, } , 
    { 1, 1, 1, }, "DATA:Badges/Hiigaran.tga")
...
function Rule_SlowConvoy3Down()
    if  SobGroup_FillProximitySobGroup("tempSobGroup_SP", "PlayerMothership", "Convoy_3", 3000)==1 then
...
function Rule_SlowConvoy5Down()
    if  SobGroup_FillProximitySobGroup("tempSobGroup_SP", "PlayerMothership", "Convoy_5", 3000)==1 then
...
function Rule_SlowConvoy6Down()
    if  SobGroup_FillProximitySobGroup("tempSobGroup_SP", "PlayerMothership", "Convoy_6", 3000)==1 then
...
function Rule_reinforcementWatch()
    if  Player_FillProximitySobGroup("tempSobGroup_SP", 0, "EnemyCarrier", 5000)==1 then
        SobGroup_FillShipsByType("BombersNearEnemyCarrier", "tempSobGroup_SP", "Hgn_AttackBomber")
...
function Rule_Convoy3Setup()
    ...
    interceptor3Groups = 
    { "Convoy3Interceptors1", "Convoy3Interceptors2", "Convoy3Interceptors3", }
    target3Groups = 
    { "Convoy3Bombers1", Convoy3Bombers2, Convoy3Bombers3, }
...
function Rule_Convoy4Setup()
    ...
    interceptor4Groups = 
    { "Convoy4Interceptors1", "Convoy4Interceptors2", "Convoy4Interceptors3", }
    target4Groups = 
    { "Convoy4Bombers1", Convoy4Bombers2, Convoy4Bombers3, }
...
function Rule_Convoy5Setup()
    ...
    interceptor5Groups = 
    { "Convoy5Interceptors1", "Convoy5Interceptors2", "Convoy5Interceptors3", }
    target5Groups = 
    { "Convoy5Bombers1", Convoy5Bombers2, Convoy5Bombers3, }
...
function Rule_Convoy6Setup()
    ...
    interceptor6Groups = 
    { "Convoy6Interceptors1", "Convoy6Interceptors2", "Convoy6Interceptors3", }
    target6Groups = 
    { "Convoy6Bombers1", Convoy6Bombers2, Convoy6Bombers3, }
...
function Rule_retaliateAgainstMelarn()
    if  NIS02BCompleted==1 and SobGroup_FillProximitySobGroup("tempSobGroup_SP", "MelarnFleet", "FrigateAttackers", 6000)==1 then
        SobGroup_FillShipsByType("tempSobGroup_SP", "Player_Ships3", "Hgn_TorpedoFrigate")
        SobGroup_Attack(1, "FrigateAttackers", "tempSobGroup_SP")
...
function Rule_melarnSetup()
    ...
    Player_SetPlayerNameAdvanced(3, "Ferin Sha Fleet")
    Player_SetPlayerNameAdvanced(4, "Ferin Sha Fleet")
    SobGroup_SetTactics("MelarnSoban", PassiveTactics)
    SobGroup_SetTactics("MelarnFleet", PassiveTactics)
