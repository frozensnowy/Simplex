...
SpawnShipList = 
    { 
        ...
        { "vgr_missilebomber", 20, 10, }, 
        { "vgr_heavyfighter", 20, 10, }, 
        { "vgr_plasmacorvette", 20, 10, }, 
        { "vgr_elitefighter", 30, 15, }, 
        { "vgr_multilancecorvette", 30, 15, }, 
        { "vgr_defender", 30, 15, }, 
        { "vgr_mortarcorvette", 30, 15, }, 
        { "vgr_standvette", 20, 10, }, 
        { "Vgr_Bioship", 20, 10, }, 
    }
Events = {}
Events.intelevent_destroyvaygr = 
    { 
        { 
            { "FOW_RevealGroup('vaygr_ambush', 1)", "", }, HW2_LocationCardEvent("$44021", 6), 
            { "Universe_EnableSkip(1)", "", }, 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, 
        }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44030", 5), }, 
        { HW2_Wait(1), }, 
        { 
            { "Sensors_EnableCameraZoom( 0 )", "", }, 
            { "Sensors_Toggle( 1 )", "", }, 
            { "Camera_Interpolate( 'here', 'Camera_Dreadnaught', 2)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44034", 5), }, 
        { HW2_Wait(1), }, 
        { 
            { "g_pointer_default = HW2_CreateEventPointerSobGroup('Dreadnaught')", "", }, 
            { "SobGroup_AttackPlayer('vaygr_ambush', 0)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44035", 5), }, 
        { 
            { "Camera_Interpolate( 'here', 'Camera_IntroEnd', 2)", "", }, HW2_Wait(2), }, 
        { 
            { "Sensors_EnableCameraZoom( 1 )", "", }, 
            { "Sensors_Toggle( 0 )", "", }, HW2_Letterbox(0), HW2_Pause(0), HW2_Wait(3), 
        ...
        { 
            { "Campaign_QuickSaveNb( g_save_id, '$6436' )", "", }, 
        }, 
    }
Events.speechevent_yarddamaged = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44095", 5), }, 
        { HW2_Wait(1), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
...
Events.speechevent_yarddestroyed = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44100", 5), }, 
        { HW2_Wait(1), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
...
Events.speechevent_enginesonline = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44045", 5), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44046", 5), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44033", 5), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44036", 5), }, 
        { HW2_Wait(1), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
...
Events.intelevent_shipyardarrives = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, 
            { "Universe_EnableSkip(1)", "", }, HW2_Letterbox(1), HW2_Wait(3), }, 
        { 
            { "Sensors_EnableCameraZoom( 0 )", "", }, 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Camera_Interpolate( 'here', 'Camera_Shipyard_Entry', 2)", "", }, HW2_Wait(2), }, 
        { 
            { "Sensors_EnableCameraZoom( 1 )", "", }, HW2_SubTitleEvent(Actor_Shipyard, "$44050", 5), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_Shipyard, "$44051", 5), }, 
        { HW2_Wait(1), }, 
        { 
            { "Sensors_EnableCameraZoom( 0 )", "", }, 
            { "Sensors_Toggle( 1 )", "", }, 
            ...
            { "g_pointer_default_1 = HW2_CreateEventPointerSobGroup('Dreadnaught')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44052", 5), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44053", 5), }, 
        { 
            { "Sensors_EnableCameraZoom( 1 )", "", }, HW2_Wait(1), }, 
        { 
        ...
        { 
            { "Campaign_QuickSaveNb( g_save_id, '$6437' )", "", }, 
        }, 
        { HW2_Wait(1), }, 
    }
Events.speechevent_dreaddamaged = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44105", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44106", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44107", 5), }, 
        { HW2_Wait(1), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
...
Events.intelevent_dreaddestroyed = 
    { 
        ...
        { 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Camera_FocusSobGroupWithBuffer( 'Dreadnaught', 1500, 0,2 )", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$44110", 5), }, 
        { HW2_Wait(8), }, 
        { 
...
Events.intelevent_dreadrepairstart = 
    { 
        { 
            ...
            { "Sound_SetMuteActor('Fleet')", "", }, 
            { "Universe_EnableSkip(1)", "", }, HW2_Letterbox(1), HW2_Wait(3), }, 
        { HW2_Wait(2), HW2_Pause(1), }, 
        { 
            { "Sensors_EnableCameraZoom( 0 )", "", }, 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Camera_FocusSobGroupWithBuffer( 'Shipyard', 1800, 0, 2 )", "", }, HW2_Wait(3), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44077", 5), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_Shipyard, "$44088", 5), }, 
        ...
        { 
            { "Rule_Add ('Rule_PlaySaveGameLocationCard')", "", }, HW2_Pause(0), 
            { "Rule_Add('Rule_Start_Timer')", "", }, HW2_Wait(1), 
            { "g_save_id = g_save_id + 1", "", }, 
        }, 
        { 
            { "Campaign_QuickSaveNb( g_save_id, '$6438' )", "", }, 
        }, 
        { HW2_Wait(1), }, 
    }
Events.intelevent_dreadrepaired = 
    { 
        ...
        { 
            { "Sensors_EnableCameraZoom( 0 )", "", }, 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Camera_FocusSobGroupWithBuffer( 'Dreadnaught', 1500, 0,2 )", "", }, HW2_SubTitleEvent(Actor_Shipyard, "$44115", 5), }, 
        { HW2_SubTitleEvent(Actor_Shipyard, "$44116", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44117", 5), }, 
        { 
            { "Camera_Interpolate( 'here', 'Camera_Battlecruiser', 3)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44118", 5), 
        ...
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44119", 5), }, 
        { HW2_Letterbox(0), 
            { "Universe_EnableSkip(0)", "", }, 
            { "SobGroup_AttackPlayer( 'Player_Ships1', 0 )", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
            { "Sensors_EnableCameraZoom( 1 )", "", }, HW2_Wait(4), }, 
        { 
            { "Rule_Add ('Rule_PlaySaveGameLocationCard')", "", }, HW2_Wait(1), 
            { "g_save_id = g_save_id + 1", "", }, 
            { "SobGroup_SetInvulnerability('Vgr_Final_Attack_1', 0)", "", }, 
            { "SobGroup_SetInvulnerability('Vgr_Final_Attack_2', 0)", "", }, 
            { "SobGroup_SetInvulnerability('Vgr_Final_Attack_3', 0)", "", }, 
        }, 
        { 
            { "Campaign_QuickSaveNb( g_save_id, '$6439' )", "", }, 
        }, 
        { HW2_Wait(1), }, 
    }
Events.intelevent_vaygrdestroyed = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, 
            { "Universe_EnableSkip(1)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44125", 5), }, 
        ...
        { 
            { "Sensors_EnableCameraZoom( 1 )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44126", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44131", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$44132", 5), }, 
        { 
            { "Universe_AllowPlayerOrders( 0 )", "", }, 
        }, 
        { 
            { "SobGroup_EnterHyperSpaceOffMap( 'Player_Ships0' )", "", }, HW2_Wait(10), }, 
        { HW2_Fade(1), HW2_Wait(1), }, 
        { 
            { "Player_InstantlyGatherAllResources( 0 )", "", }, HW2_Wait(1), }, 
        { 
...
Events.speechevent_vaygrgate = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44040", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44041", 5), 
...
Events.speechevent_gatedown = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44055", 5), }, 
        { HW2_Wait(1), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
...
Events.speechevent_vaygrcarrier_1 = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44060", 5), }, 
        { HW2_Letterbox(1), 
            { "Universe_EnableSkip(1)", "", }, 
            { "Camera_FocusSave()", "", }, 
        }, 
        ...
        { 
            ...
            { "g_pointer_default = HW2_CreateEventPointerSobGroup('Carrier_5')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44061", 5), }, 
        { HW2_Wait(1), }, 
        { HW2_Wait(1), 
            { "EventPointer_Remove(g_pointer_default_1)", "", }, 
...
Events.speechevent_vaygrcarrier_2 = 
    { 
        { 
            ...
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Wait(1), }, 
        { 
            { "Sound_MusicPlayType( 'data:sound/music/battle/Battle_01', MUS_Battle )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44065", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44066", 5), }, 
        { HW2_Wait(1), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
...
Events.speechevent_vaygrsupercapapproach = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44071", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44072", 5), }, 
        { HW2_Wait(1), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
...
Events.speechevent_carrierdestroyed = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$44070", 5), }, 
        { HW2_Wait(1), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
...
Events.speechevent_reminder = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$44052", 5), }, 
        { HW2_Wait(1), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
...
function Setup_AI()
    ...
    SobGroup_CreateSubSystem("Carrier_1", "vgr_carrier_shield")
    SobGroup_CreateSubSystem("Carrier_2", "vgr_carrier_shield")
    SobGroup_CreateSubSystem("Carrier_3", "vgr_carrier_shield")
    SobGroup_CreateSubSystem("Carrier_4", "vgr_carrier_shield")
    SobGroup_CreateSubSystem("Carrier_5", "vgr_carrier_shield")
    SobGroup_CreateSubSystem("Carrier_1", "vgr_carrier_shield1")
    SobGroup_CreateSubSystem("Carrier_2", "vgr_carrier_shield1")
    SobGroup_CreateSubSystem("Carrier_3", "vgr_carrier_shield1")
    SobGroup_CreateSubSystem("Carrier_4", "vgr_carrier_shield1")
    SobGroup_CreateSubSystem("Carrier_5", "vgr_carrier_shield1")
    SobGroup_CreateSubSystem("Carrier_1", "vgr_carrier_shield1")
    SobGroup_CreateSubSystem("Carrier_2", "vgr_carrier_shield1")
    SobGroup_CreateSubSystem("Carrier_3", "vgr_carrier_shield1")
    SobGroup_CreateSubSystem("Carrier_4", "vgr_carrier_shield1")
    SobGroup_CreateSubSystem("Carrier_5", "vgr_carrier_shield1")
    SobGroup_CreateSubSystem("Carrier_1", "Vgr_C_Module_Defensefield")
    SobGroup_CreateSubSystem("Carrier_2", "Vgr_C_Module_Defensefield")
    SobGroup_CreateSubSystem("Carrier_3", "Vgr_C_Module_Defensefield")
    SobGroup_CreateSubSystem("Carrier_4", "Vgr_C_Module_Defensefield")
    SobGroup_CreateSubSystem("Carrier_5", "Vgr_C_Module_Defensefield")
    ...
    SobGroup_CreateSubSystem("Vgr_Shipyard", "Vgr_MS_Module_Defensefield")
    SobGroup_CreateSubSystem("Vgr_Shipyard", "vgr_shipyard_shield")
    SobGroup_CreateSubSystem("Vgr_Shipyard", "vgr_shipyard_shield1")
...
function Rule_DisableBuilderInterval()
    HW2_DisableBuilderOnCapture("tempSobGroup_SP")
end

function Rule_Init()
    Sound_EnterIntelEvent()
    Player_SetPlayerNameAdvanced(0, "Hiigaran Navy")
    Player_SetPlayerNameAdvanced(1, "Vaygr Staging Force")
    Player_SetPlayerNameAdvanced(2, "Vaygr Staging Force")
    Player_SetPlayerNameAdvanced(5, "Vaygr Staging Force")
    ...
    SobGroup_SetInvulnerability_Smart("Shipyard", 1)
    ...
    SobGroup_SetInvulnerability("Carrier_1", 1)
    SobGroup_SetInvulnerability("Carrier_2", 1)
    SobGroup_SetInvulnerability("Carrier_3", 1)
    SobGroup_SetInvulnerability("Carrier_4", 1)
    SobGroup_SetInvulnerability("Carrier_5", 1)
    SobGroup_SetInvulnerability("Vgr_Final_Attack_1", 1)
    SobGroup_SetInvulnerability("Vgr_Final_Attack_2", 1)
    SobGroup_SetInvulnerability("Vgr_Final_Attack_3", 1)
    SobGroup_SetInvulnerability("Vgr_Shipyard_TheFreakingShipReally", 1)
...
function Rule_Dreadnaught_Engine_Repaired()
    if  SobGroup_HealthPercentage("Dreadnaught")>=0.3 then
    		SobGroup_SetInvulnerability("Dreadnaught", 0)
...
function Rule_Shipyard_RocksUp()
    ...
    SobGroup_SetInvulnerability_Smart("Shipyard", 0)
...
function Rule_Carrier_Arrive_1()
    ...
    SobGroup_SetInvulnerability("Carrier_1", 0)
    SobGroup_SetInvulnerability("Carrier_2", 0)
    SobGroup_SetInvulnerability("Carrier_5", 0)
...
function Rule_Carrier_Arrive_2()
    ...
    SobGroup_SetInvulnerability("Carrier_3", 0)
    SobGroup_SetInvulnerability("Carrier_4", 0)
...
function Rule_Check_For_New_Shipyard()
    ...
    SobGroup_SobGroupAddPlayerShipsByType("Shipyard", 0, "Hgn_Shipyard_SPG")
    SobGroup_SobGroupAddPlayerShipsByType("Shipyard", 0, "hgn_shipyard")
    SobGroup_SobGroupAddPlayerShipsByType("Shipyard", 0, "hgn_shipyard_g")
...
function SwitchOffDread()
		SobGroup_SetInvulnerability("Dreadnaught", 1)
    SobGroup_SetSpeed("Dreadnaught", 0)
...
function Setup_Shipyard()
    ...
    SobGroup_CreateSubSystem("Shipyard", "Hgn_MS_Module_repair")
    SobGroup_CreateSubSystem("Shipyard", "Hgn_MS_Module_Hyperspace")
    SobGroup_CreateSubSystem("Shipyard", "Hgn_SY_Module_PlatformControl")
...
function Spawn_Annoying_Vaygr_Ships()
    ...
    for g = 1,g_numberOfShipsPerGroup,1 do
        local lowestShipValue = 1000000000.0
        for i = 1,getn(SpawnShipList),1 do
    ...
    CPU_RemoveSobGroup(SobGroup_OwnedBy("Vgr_Spawned_Group"), "Vgr_Spawned_Group")
