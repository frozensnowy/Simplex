...
{ 
	{ 
		...
		HW2_LocationCardEvent( "Postmortem Tutorial - Mission 9", 5 ), 
	}, 
	{ 
		HW2_Letterbox( 1 ), 
		HW2_Wait( 2 ), 
	...
	{
		{
			[[obj_prim_newobj_id = Objective_Add( "Find a Ship", OT_Primary )]],
			[[]]
		}, 
		{
			[[Objective_AddDescription( obj_prim_newobj_id, "Find the enemy carrier to win the mission.")]],
			[[]]
		}, 
		HW2_SubTitleEvent( Actor_FleetIntel, "Find the enemy carrier to win the mission.", 4 ),
	},
	{
		HW2_Wait( 1 ), 
	},
