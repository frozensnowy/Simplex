...
SP_Campaign_Level_ID = 13
Chunk1DeadONCE = 0
Chunk2DeadONCE = 0
Chunk3DeadONCE = 0
StartGateFX = 0
g_save_id = 0
EnemiesAttackingLarge = 
    { 0, 0, 0, }
EnemiesAttackingSmall = 
    { 0, 0, 0, }
Events = {}
Events.intelevent_stopthem = 
    { 
        ...
        { 
            ...
            { "Campaign_QuickSaveNb( g_save_id, '$6451' )", "", }, 
        }, 
        { HW2_Wait(2), }, 
        { HW2_LocationCardEvent("$46020", 6), }, 
        { HW2_Wait(1.5), }, 
        { 
            { "Sound_EnableAllSpeech( 1 )", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$46029", 6), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$46025", 4), }, 
        { 
        ...
        { 
            { "Camera_Interpolate( 'here', 'camera2', 1.5)", "", }, HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46030", 8), 
        ...
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46031", 6), 
            ...
            { "obj_prim_stopvaygr_id = Objective_Add(obj_prim_stopvaygr, OT_Primary)", "", }, 
        ...
        { 
            ...
            { "EventPointer_Remove(pointer_chunk3_id)", "", }, HW2_Letterbox(0), 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Camera_FocusRestore()", "", }, 
            { "Universe_EnableSkip(0)", "", }, HW2_Pause(0), }, 
        { 
...
Events.speechevent_generatorLowHealthNoGeneratorsSaved = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46038", 5), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46037", 12), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.speechevent_lost1GeneratorNoneSaved = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46040", 4), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46041", 6), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46042", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.speechevent_saved1Generator = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46045", 2), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46046", 2), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.speechevent_lost1GeneratorSavedOne = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46050", 4), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.speechevent_lost2GeneratorsNoneSaved = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46055", 4), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46056", 4), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.speechevent_saved2Generators = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46060", 3), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46061", 3), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.speechevent_lost2GeneratorsSavedOne = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46065", 4), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.speechevent_lost3Generators = 
    { 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$46070", 4), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$46071", 5), }, 
        { HW2_Wait(3), }, 
        { 
...
Events.speechevent_saved3Generators = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46051", 4), }, 
        { 
            { "Rule_Add ('Rule_PlaySaveGameLocationCard')", "", }, HW2_Wait(1), }, 
        { 
            { "g_save_id = g_save_id + 1", "", }, 
            { "Campaign_QuickSaveNb( g_save_id, '$6452' )", "", }, 
        }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.intelevent_shipyardDetected = 
    { 
        ...
        { HW2_Wait(0.5), }, 
        { 
            { "pointer_vaygrshipyard_id = HW2_CreateEventPointerSobGroup('VaygrShipyard')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$46100", 3), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46101", 7), 
            { "ping_shipyard_id = HW2_PingCreateWithLabel( ping_shipyard, 'VaygrShipyard' )", "", }, 
            { "Ping_AddDescription(ping_shipyard_id, 0, '$46425')", "", }, 
            { "obj_prim_destroyshipyard_id = Objective_Add(obj_prim_destroyshipyard, OT_Primary)", "", }, 
            { "Objective_AddDescription( obj_prim_destroyshipyard_id, '$46455')", "", }, 
            { "Rule_Add( 'Rule_speechevent_gateReadyForUse' )", "", }, 
        }, 
        { 
            { "EventPointer_Remove(pointer_vaygrshipyard_id)", "", }, HW2_Wait(0.5), }, 
        { HW2_Letterbox(0), 
            { "Universe_EnableSkip(0)", "", }, HW2_Pause(0), 
            { "Sensors_Toggle( 0 )", "", }, 
        }, 
        ...
        { 
            { "g_save_id = g_save_id + 1", "", }, 
            { "Campaign_QuickSaveNb( g_save_id, '$6453' )", "", }, 
        }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.speechevent_shipyardDestroyed = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46105", 5), 
            { "Objective_SetState( obj_prim_destroyshipyard_id, OS_Complete )", "", }, 
        }, 
        { 
            { "Rule_Add ('Rule_PlaySaveGameLocationCard')", "", }, HW2_Wait(1), }, 
        { 
            { "g_save_id = g_save_id + 1", "", }, 
            { "Campaign_QuickSaveNb( g_save_id, '$6454' )", "", }, 
        }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.speechevent_dreadnaughtDamaged = 
    { 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$46120", 7), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46121", 5), 
            { "obj_prim_protectdreadnaught_id = Objective_Add(obj_prim_protectdreadnaught, OT_Primary)", "", }, 
            { "Objective_AddDescription( obj_prim_protectdreadnaught_id, '$46467')", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46122", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.speechevent_sendScoutToInvestigate = 
    { 
        ...
        { HW2_Wait(0.5), }, 
        { 
            { "pointer_powersignature_id = HW2_CreateEventPointerSobGroup('VaygrShipyard')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$46106", 4), 
            { "ping_shipyardLocation_id = HW2_PingCreateWithLabel( ping_shipyardLocation, 'VaygrShipyard' )", "", }, 
            { "Ping_AddDescription(ping_shipyardLocation_id, 0, '$46425')", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46107", 3), 
            { "obj_prim_findshipyard_id = Objective_Add(obj_prim_findshipyard, OT_Primary)", "", }, 
            { "Objective_AddDescription( obj_prim_findshipyard_id, '$46460')", "", }, 
        }, 
        { 
            { "EventPointer_Remove(pointer_powersignature_id)", "", }, HW2_Wait(0.5), }, 
        { HW2_Letterbox(0), 
            { "Universe_EnableSkip(0)", "", }, HW2_Pause(0), 
            { "Sensors_Toggle( 0 )", "", }, 
        }, 
...
Events.speechevent_gateReadyForUse = 
    { 
        ...
        { 
            { "Camera_FocusSobGroup( Players_Dreadnaught, 1, 1200, 1 )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$46110", 7), }, 
        { HW2_Wait(0.5), }, 
        { 
        ...
        { HW2_Wait(3), }, 
        { 
            { "Camera_Interpolate( 'here', 'camera3', 1)", "", }, HW2_Wait(1), }, 
        { 
            { "FX_StartEvent( 'Balcora_Gate', 'Gate_Trigger' )", "", }, 
        }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$46115", 3), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$46116", 3), }, 
        { HW2_Wait(0.5), }, 
        { 
            { "Universe_Fade( 1, 1.5 )", "", }, 
        }, 
        ...
        { 
            ...
            { "NISLoad( 'nis/NIS13B' )", "", }, HW2_Wait(1), }, 
        { 
            { "Universe_Fade( 0, 1.5 )", "", }, 
            { "k_currentNISPlaying_id = NISPlay( 'nis/NIS13B' )", "", }, 
            { "Rule_Add ('Rule_watchForNIS13BDone')", "", }, 
        }, 
    }
...
Events.speechevent_playerlosesDreadnaught = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$46125", 5), }, 
        { HW2_Wait(1), }, 
        { HW2_Pause(1), HW2_Letterbox(1), HW2_Fade(1), HW2_Wait(2), }, 
        { HW2_LocationCardEvent("$46023", 4), }, 
        { 
...
function OnStartOrLoad_m13()
    ...
    if  StartGateFX==1 then
    		SobGroup_Create("Balcora_Gate")
    		if SobGroup_Empty("Balcora_Gate") == 1 and Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(2, "meg_balcoragate") > 0 then
    			SobGroup_FillShipsByType("Balcora_Gate", "Player_Ships2", "meg_balcoragate")
...
function Rule_Init_1()
    ...
    SobGroup_SetInvulnerability("Balcora_Gate", 1)
...
function Rule_watchForNISDoneFromTimer()
    if  NISOver==0 then
        ...
        SobGroup_SetInvulnerability("Balcora_Gate", 1)
        SobGroup_SetInvulnerability("VaygrShipyard", 1)		--shipyard should be invulnerable until it's discovered 
...
function Rule_Init()
    ...
    Player_SetPlayerNameAdvanced(2, "Progenitor")
    Player_SetPlayerNameAdvanced(3, "Vaygr")
    CPU_Enable(0, 0)
    CPU_Enable(2, 0)
    CPU_Enable(3, 0)
    ...
    SobGroup_CreateSubSystem("VaygrShipyard", "Vgr_MS_Module_Hyperspace")
    SobGroup_CreateSubSystem("VaygrShipyard", "AdvancedArray")
    SobGroup_CreateSubSystem("VaygrShipyard", "vgr_magnetron1")
    SobGroup_CreateSubSystem("VaygrShipyard", "vgr_magnetron2")
    SobGroup_CreateSubSystem("VaygrShipyard", "vgr_ms_plasma")
    SobGroup_CreateSubSystem("VaygrShipyard", "vgr_power_sy")
    SobGroup_CreateSubSystem("VaygrShipyard", "Vgr_MS_Module_Defensefield")
    SobGroup_CreateSubSystem("VaygrShipyard", "vgr_shipyard_shield")
    SobGroup_CreateSubSystem("VaygrShipyard", "vgr_shipyard_shield1")
    HW2_SetResearchLevel(13)
    SobGroup_SetTactics("VaygrShipyard", AggressiveTactics)
    ...
    Player_GrantResearchOption(1, "SP_ShipyardHealthUpgrade")
    ...
    SobGroup_SobGroupAddPlayerShipsByType(Players_Carrier, 0, "hgn_battlecarrier")
    ...
    SobGroup_SobGroupAddPlayerShipsByType(Players_Battlecruiser, 0, "hgn_battlecruiserNUKE")
    SobGroup_SobGroupAddPlayerShipsByType(Players_Battlecruiser, 0, "hgn_vortex")
    SobGroup_SobGroupAddPlayerShipsByType(Players_Battlecruiser, 0, "hgn_battleship")
    ...
    SobGroup_SobGroupAddPlayerShipsByType(Players_Shipyard, 0, "hgn_ark")
    SobGroup_SobGroupAddPlayerShipsByType(Players_Shipyard, 0, "hgn_shipyard_g")
    SobGroup_SobGroupAddPlayerShipsByType(Players_Shipyard, 0, "Hgn_battleshipyard")
    SobGroup_SobGroupAddPlayerShipsByType(Players_Shipyard, 0, "hgn_commandfortress")
...
function Rule_speechevent_generatorLowHealthNoGeneratorsSaved()
    if  SobGroup_GetHardPointHealth("Balcora_Gate", "Generator1")<0.5 or SobGroup_GetHardPointHealth("Balcora_Gate", "Generator2")<0.5 or SobGroup_GetHardPointHealth("Balcora_Gate", "Generator3")<0.5 then
...
function Rule_seenShipyardWatch()
    if  SobGroup_PlayerIsInSensorRange("VaygrShipyard", 0)==1 or SobGroup_UnderAttack("VaygrShipyard")==1 then
        if  EventPlaying==0 then
            ...
            SobGroup_SetInvulnerability("VaygrShipyard", 0)
    ...
    for i = 1,3,1 do
        if  SobGroup_UnderAttack("ChunkAttackersLarge"..i)==1 then
            if  EnemiesAttackingLarge[i]==0 then
                ...
                SobGroup_FillShipsByType("tempSobGroup_SP", "AttackingLarge"..i, "Hgn_AssaultFrigate")
                if  SobGroup_Empty("tempSobGroup_SP")==0 then
                    print("This large group found some Assault Frigates: "..i)
                    SobGroup_SobGroupAdd("LargeTargets"..i, "tempSobGroup_SP")
                end 

                SobGroup_FillShipsByType("tempSobGroup_SP", "AttackingLarge"..i, "Hgn_TorpedoFrigate")
                if  SobGroup_Empty("tempSobGroup_SP")==0 then
                    print("This large group found some Torpedo Frigates: "..i)
                    SobGroup_SobGroupAdd("LargeTargets"..i, "tempSobGroup_SP")
                end 

                SobGroup_FillShipsByType("tempSobGroup_SP", "AttackingLarge"..i, "Hgn_MarineFrigate")
                if  SobGroup_Empty("tempSobGroup_SP")==0 then
                    print("This large group found some Marine Frigates: "..i)
                    SobGroup_SobGroupAdd("LargeTargets"..i, "tempSobGroup_SP")
                end 

                SobGroup_FillShipsByType("tempSobGroup_SP", "AttackingLarge"..i, "Hgn_IonCannonFrigate")
                if  SobGroup_Empty("tempSobGroup_SP")==0 then
                    print("This large group found some Ion Cannon Frigates: "..i)
                    SobGroup_SobGroupAdd("LargeTargets"..i, "tempSobGroup_SP")
                end 

                SobGroup_FillShipsByType("tempSobGroup_SP", "AttackingLarge"..i, "Hgn_Destroyer")
                if  SobGroup_Empty("tempSobGroup_SP")==0 then
                    print("This large group found some Destroyers: "..i)
                    SobGroup_SobGroupAdd("LargeTargets"..i, "tempSobGroup_SP")
                end 

                SobGroup_FillShipsByType("tempSobGroup_SP", "AttackingLarge"..i, "Hgn_BattleCruiser")
                if  SobGroup_Empty("tempSobGroup_SP")==0 then
                    print("This large group found some Battlecruisers: "..i)
                    SobGroup_SobGroupAdd("LargeTargets"..i, "tempSobGroup_SP")
                end 

                SobGroup_FillShipsByType("tempSobGroup_SP", "AttackingLarge"..i, "Hgn_IonTurret")
                if  SobGroup_Empty("tempSobGroup_SP")==0 then
...
function Rule_chunkAttackerRetaliateWATCH()
    for i = 1,3,1 do
        if  EnemiesAttackingLarge[i]==1 then
            if  SobGroup_Empty("LargeTargets"..i)==1 and SobGroup_IsShipNearPoint("ChunkAttackersLarge"..i, "ChunkPoint"..i, 2500)==1 then
