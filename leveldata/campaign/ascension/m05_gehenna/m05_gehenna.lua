...
Events.intelevent_situationreport = 
    { 
        ...
        { 
            ...
            { "Campaign_QuickSaveNb( g_save_id, '$6417' )", "", }, 
        }, 
        { HW2_Wait(2), }, 
        { HW2_LocationCardEvent("$42020", 6), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$42030", 4), }, 
        { HW2_Wait(1.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$42031", 5), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42032", 6), }, 
        { HW2_Wait(1.5), }, 
        { HW2_Letterbox(1), }, 
        { HW2_Wait(0.5), }, 
        { HW2_Pause(1), }, 
        ...
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42033", 6), 
            { "pointer_oracle_id = HW2_CreateEventPointerSobGroup('Gehenna')", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42040", 10), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42037", 8), 
            ...
            { "ping_gehenna_id = Ping_AddSobGroup( ping_gehenna, 'anomaly', 'Gehenna' )", "", }, 
            { "Ping_AddDescription(ping_gehenna_id, 0, '$42450')", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42038", 6), }, 
        { HW2_Wait(1), }, 
        { 
            { "EventPointer_Remove(pointer_oracle_id)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$42039", 6), 
            { "pointer_dustVein1_id = HW2_CreateEventPointerVolume('DustVeinPointer1')", "", }, 
            { "pointer_dustVein2_id = HW2_CreateEventPointerVolume('DustVeinPointer2')", "", }, 
            { "pointer_dustVein3_id = HW2_CreateEventPointerVolume('DustVeinPointer3')", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42035", 7), }, 
        { HW2_Wait(0.5), }, 
        { 
            { "EventPointer_Remove(pointer_dustVein1_id)", "", }, 
            { "EventPointer_Remove(pointer_dustVein2_id)", "", }, 
            { "EventPointer_Remove(pointer_dustVein3_id)", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { 
            { "Sensors_Toggle( 0 )", "", }, 
...
Events.intelevent_DestroyGarrisons = 
    { 
        ...
        { 
            { "Camera_Interpolate( 'here', 'camera2', 1)", "", }, HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42044", 8), 
            { "pointer_garrison1_id = HW2_CreateEventPointerSobGroup('Garrison_1')", "", }, 
            { "pointer_garrison2_id = HW2_CreateEventPointerSobGroup('Garrison_2')", "", }, 
            { "pointer_garrison3_id = HW2_CreateEventPointerSobGroup('Garrison_3')", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42042", 8), 
        ...
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42043", 5), 
        ...
        { 
            { "EventPointer_Remove(pointer_garrison1_id)", "", }, 
            { "EventPointer_Remove(pointer_garrison2_id)", "", }, 
            { "EventPointer_Remove(pointer_garrison3_id)", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { 
            { "Sensors_Toggle( 0 )", "", }, 
...
Events.intelevent_garrison1destroyed = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42076", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_garrison2destroyed = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42080", 4), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42081", 4), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_garrison3destroyed = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42086", 5), 
        ...
        { 
            { "g_save_id = g_save_id + 1", "", }, 
            { "Campaign_QuickSaveNb( g_save_id, '$6418' )", "", }, 
        }, 
        { HW2_Wait(2), 
            { "Sound_ExitIntelEvent()", "", }, 
        }, 
...
Events.intelevent_FirstPatrolFound = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42090", 5), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42091", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_SecondPatrolFound = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42110", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_ThirdPatrolFound = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42116", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_FirstPatrolDestroyed = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42100", 5), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42101", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_SecondAndThirdPatrolDestroyed = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42126", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.autofocus_leftfield = 
    { 
        { 
            { "PlayStagingMusicONCE = 1", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$42146", 4), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42149", 4), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42148", 4), }, 
        { HW2_Wait(0.5), }, 
        { 
            { "Timer_Start( 0, 40 )", "", }, 
...
Events.intelevent_detectedbyvaygr = 
    { 
        { 
            { "Rule_Add ('Rule_PlayBattleMusic')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$42150", 5), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42151", 7), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42152", 5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.intelevent_ShipyardDiscovered = 
    { 
        ...
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42170", 7), 
            { "pointer_enemyShipyard_id = HW2_CreateEventPointerSobGroup('Vgr_Shipyard_1')", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$42176", 8), 
            ...
            { "ping_shipyard_id = Ping_AddSobGroup( ping_shipyard, 'anomaly', 'Vgr_Shipyard_1' )", "", }, 
            { "Ping_AddDescription(ping_shipyard_id, 0, '$42440')", "", }, 
        }, 
        { 
            { "EventPointer_Remove(pointer_enemyShipyard_id)", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { 
            { "Sensors_Toggle( 0 )", "", }, HW2_Pause(0), HW2_Letterbox(0), 
            { "Universe_EnableSkip(0)", "", }, 
        }, 
        { 
            { "Rule_Add ('Rule_PlaySaveGameLocationCard')", "", }, HW2_Wait(1), }, 
        { 
            { "g_save_id = g_save_id + 1", "", }, 
            { "Campaign_QuickSaveNb( g_save_id, '$6419' )", "", }, 
        }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.intelevent_ShipyardDestroyed = 
    { 
        { 
            { "Rule_Add ('Rule_PlayStagingMusic')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$42177", 5), 
        ...
        { 
            { "g_save_id = g_save_id + 1", "", }, 
            { "Campaign_QuickSaveNb( g_save_id, '$6420' )", "", }, 
        }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.speechevent_ioncannonsavailable = 
    { 
        { 
            --{ "Player_UnrestrictBuildOption( 0, 'Hgn_IonCannonFrigate' )", "", }, 
            --{ "Player_UnrestrictResearchOption( 0, 'IonCannonFrigateHealthUpgrade1' )", "", }, 
            --{ "Player_UnrestrictResearchOption( 0, 'IonCannonFrigateMAXSPEEDUpgrade1' )", "", }, 
            { "Player_GrantResearchOption_Smart( 0, 'IonFrigateTech' )", "", }, 
            HW2_SubTitleEvent(Actor_FleetIntel, "$42130", 5), }, 
        { 
            { "Sound_SetMuteActor('')", "", }, 
            { "Sound_ExitIntelEvent()", "", }, HW2_Wait(2), }, 
        { 
...
Events.intelevent_MissionEnd = 
    { 
        ...
        { 
            { "g_save_id = g_save_id + 1", "", }, 
            { "Campaign_QuickSaveNb( g_save_id, '$6421' )", "", }, 
        }, 
        { HW2_Wait(2), }, 
        { 
        ...
        { 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Wait(0.5), }, 
        { 
            { "Universe_Fade( 1, 2.5 )", "", }, HW2_SubTitleEvent(Actor_AllShips, "$42200", 3), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_AllShips, "$42201", 3), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_AllShips, "$42202", 3), 
            { "Objective_SetState( obj_prim_retrieveOracle_id, OS_Complete )", "", }, 
        }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_AllShips, "$42203", 3), }, 
        { HW2_Wait(0.5), }, 
        { 
        ...
        { HW2_Wait(1.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$42204", 4), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$42205", 3), }, 
        { HW2_Wait(0.5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$42207", 6), }, 
        { HW2_Wait(0.5), }, 
        { 
...
function Rule_Init()
    ...
    Player_GrantResearchOption(1, "CapitalTech")
    ...
    Player_SetPlayerNameAdvanced(1, "Gehenna Defence Fleet")
    Player_SetPlayerNameAdvanced(2, "Oracle Dig Site")
...
function Rule_checkForShipsDockedWithGehenna()
    ...
    if  SobGroup_Empty("ShipsDockedWithGehenna")~=1 then
        SobGroup_FillShipsByType("tempSobGroup_SP", "ShipsDockedWithGehenna", "Hgn_MarineFrigate")
        if  SobGroup_Empty("tempSobGroup_SP")~=1 then
...
function ShipsInNebula()
	SobGroup_Create("SP_CheckPlayerOutsideCloudSOB")
	SobGroup_Clear("SP_CheckPlayerOutsideCloudSOB")
	SobGroup_SobGroupAdd("SP_CheckPlayerOutsideCloudSOB", "Player_Ships0")
	SobGroup_RemoveType("SP_CheckPlayerOutsideCloudSOB", "supporter")
    if  SobGroup_AreAnySquadronsOutsideDustCloud("SP_CheckPlayerOutsideCloudSOB", "Nebula4_OLD, Nebula4_OLD1, Nebula2_OLD1, Nebula2_OLD2, Nebula2_OLD3, Nebula2_OLD4, Nebula2_OLD5, Nebula2_OLD7, Nebula5_OLD, Nebula7_OLD, Nebula3_OLD, Nebula2_OLD, Nebula8_OLD")==1 then
        return 1
    else
        return 0
    end 
...
function Rule_AddShipToAttackGroup()
    if  g_vaygrShipLastBuiltChanged~=g_vaygrShipLastBuilt then
        ...
        local waveToAddTo = 0
        for i = 1,getn(VaygrFleetWaveSize),1 do
...
function Rule_PatrolWatchForEnemies()
    for i = 1,3,1 do
        Player_FillProximitySobGroup("tempSobGroup_SP", 0, "Patrol"..i, 5000)
        if  SobGroup_Empty("tempSobGroup_SP")==0 then
            if  EnemiesNearPatrol[i]==0 then
                EnemiesNearPatrol[i] = 1
                PatrolDetected[i] = 1
                SobGroup_Attack(1, "Patrol"..i, "tempSobGroup_SP")
            end 
