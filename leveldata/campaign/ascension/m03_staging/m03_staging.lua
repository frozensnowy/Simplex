...
Events.IntelEvent_Staging = 
    { 
        ...
        { 
            ...
            { "Sensors_Toggle( 1 )", "", }, 
            { "Camera_Interpolate( 'here', 'camera6', 2)", "", }, HW2_Wait(1), }, 
        { 
            { "pointer_shipyardexit_id = HW2_CreateEventPointerSobGroup( 'Shipyard')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$41031", 4), 
...
Events.IntelEvent_ShipyardSafe = 
    { 
        ...
        { 
            ...
            { "Camera_FocusRestore()", "", }, HW2_Wait(2), 
            { "Universe_EnableSkip(0)", "", }, 
            { "EventPlaying = 0", "", }, 
        }, 
    }
...
Events.IntelEvent_ShipyardRepaired = 
    { 
        ...
        { HW2_Wait(1), }, 
        { 
            { "Camera_FocusSobGroupWithBuffer( 'Shipyard', 2, 1000, 1.5 )", "", }, HW2_SubTitleEvent(Actor_Shipyard, "$41070", 4), }, 
...
Events.IntelEvent_DefendShipyard = 
    { 
        { 
            ...
            { "Sound_EnterIntelEvent()", "", }, HW2_Letterbox(1), }, 
        { 
            { "Camera_FocusSobGroupWithBuffer( 'Shipyard', 2, 1000, 2 )", "", }, HW2_SubTitleEvent(Actor_Shipyard, "$41091", 3), }, 
        { HW2_Wait(1), }, 
        ...
        { 
            ...
            { "EventPointer_Remove(pointer_Vaygr_ShipyardInf_02_id)", "", }, HW2_Wait(1), }, 
        { 
...
Events.IntelEvent_InfsAreAllDead = 
    { 
        ...
        { HW2_Wait(2), }, 
        { 
            { "Sensors_Toggle( 0 )", "", }, HW2_Letterbox(0), 
            { "Universe_Pause(0, 1.5)", "", }, 
            { "Universe_EnableSkip(0)", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
            { "EventPlaying = 0", "", }, 
...
Events.IntelEvent_ShipyardBoarded = 
    { 
        { 
            ...
            { "Sound_EnterIntelEvent()", "", }, HW2_Letterbox(1), }, 
        { 
            { "Camera_FocusSobGroupWithBuffer( 'Shipyard', 2, 1000, 2 )", "", }, HW2_SubTitleEvent(Actor_Shipyard, "$41105", 3), }, 
        { HW2_Wait(1), }, 
        ...
        { 
            { "EventPointer_Remove(pointer_VaygreCarrierInfs_id)", "", }, 
            { "EventPointer_Remove(pointer_VaygreCarrierInfs_01_id)", "", }, HW2_Wait(1), }, 
        { HW2_Letterbox(0), 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Universe_Pause(0, 1.5)", "", }, 
            { "Universe_EnableSkip(0)", "", }, 
...
Events.IntelEvent_Shipyard_Is_Ours = 
    { 
        { 
            ...
            { "Sound_EnterIntelEvent()", "", }, HW2_Letterbox(1), }, 
        { 
            { "Sensors_Toggle( 1 )", "", }, HW2_Wait(1), HW2_Pause(1), }, 
        ...
        { HW2_Wait(2), }, 
        { 
            { "Sensors_Toggle( 0 )", "", }, HW2_Letterbox(0), HW2_Pause(0), 
            { "Universe_EnableSkip(0)", "", }, 
            { "EventPlaying = 0", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
        }, 
...
Events.MSLost = 
    { 
        { 
            { "Camera_FocusSobGroupWithBuffer( Players_Mothership, 1, 1000, 1 )", "", }, HW2_Wait(8), }, 
    }
...
Events.MissionWon = 
    { 
        { 
            { "Universe_EnableSkip(1)", "", }, 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_EnableAllSpeech( 1 )", "", }, HW2_Letterbox(1), }, 
        { 
            { "Camera_FocusSobGroupWithBuffer( Players_Mothership, 1, 1000, 1 )", "", }, HW2_Wait(2), }, 
        ...
        { 
            ...
            { "SP_SobGroup_DockOrParadeSobGroupAtEnd( 'Player_Ships0', Players_Mothership)", "", }, HW2_Wait(1), }, 
        { 
...
function Rule_Init()
    ...
    Player_SetPlayerNameAdvanced(1, "Vaygr Raiders")
    Player_SetPlayerNameAdvanced(2, "Hiigaran Defence Fleet")
    Player_SetPlayerNameAdvanced(3, "Vaygr Raiders")
    print(g_player_RU)
...
function Rule_IntelEvent_StagingComplete()
    if  Event_IsDone("IntelEvent_Staging")==1 then
        ...
        Player_RestrictResearchOption(0, "MarineTech")
        ...
        Player_RestrictResearchOption(0, "TorpedoTech")
...
function Rule_TurretsReady()
    if  platform[g_playerID+1]>=1 then		--Stats_ShipsCreated(g_playerID)>=1 then
...
function Rule_IntelEvent_ShipyardSafe_Complete()
    if  Event_IsDone("IntelEvent_ShipyardSafe")==1 then
        ...
        local num_emptyslot = 0
        for i=1,4,1 do
        	if SobGroup_GetHardPointHealth(Players_Mothership, "Generic "..i) == 0 then
        		num_emptyslot = num_emptyslot + 1
        	end
        end
        if num_emptyslot > 0 and SobGroup_IsBuilding(Players_Mothership, "Hgn_MS_Module_Repair") == 0 and Player_CanResearch(0, "SP_hasrepairsystem" ) == 0 then
        	SobGroup_CreateSubSystem(Players_Mothership, "Hgn_MS_Module_Repair")
        end
        local num_new_emptyslot = 0
        for i=1,4,1 do
        	if SobGroup_GetHardPointHealth(Players_Mothership, "Generic "..i) == 0 then
        		num_new_emptyslot = num_new_emptyslot + 1
        	end
        end
        if num_new_emptyslot == num_emptyslot then
        	Player_GrantResearchOption(0, "RepairAbility")
        	print("Failed to install Repair System on Mothership, grant Collector Repair Ability instead")
        else
        	print("Repair System successfully installed on Mothership")
        end
...
function Rule_CreateCarrier()
    ...
    pilotrecruitList[1] = pilotmaxList[1]
    officerrecruitList[1] = officermaxList[1]
    print("Recruited more pilots and officers")
...
function Rule_Probes_Detected()
    if  SobGroup_PlayerIsInSensorRange("V_Probes", 0) + SobGroup_PlayerIsInSensorRange("V_Probes", 2)>=1 then
...
function Rule_Pointer_Probe01()
    if  SobGroup_PlayerIsInSensorRange("V_Probe_1", 0) + SobGroup_PlayerIsInSensorRange("V_Probe_1", 2)>=1 then
...
function Rule_Pointer_Probe02()
    if  SobGroup_PlayerIsInSensorRange("V_Probe_2", 0) + SobGroup_PlayerIsInSensorRange("V_Probe_2", 2)>=1 then
...
function Rule_Pointer_Probe03()
    if  SobGroup_PlayerIsInSensorRange("V_Probe_3", 0) + SobGroup_PlayerIsInSensorRange("V_Probe_3", 2)>=1 then
...
function Rule_IntelEvent_VaygrWave01_Complete()
    if  Event_IsDone("IntelEvent_VaygrWave01") + Event_IsDone("IntelEvent_VaygrWave01_NonFRO")>=1 then
...
function Rule_VaygrShipyard_Attackers_Detected()
    if  SobGroup_PlayerIsInSensorRange("V_Inf_01", 0)+SobGroup_PlayerIsInSensorRange("V_Inf_02", 0)+SobGroup_PlayerIsInSensorRange("V_Inf_01", 2)+SobGroup_PlayerIsInSensorRange("V_Inf_02", 2)>=1 then
...
function Rule_IntelEvent_DefendShipyardComplete()
    if  Event_IsDone("IntelEvent_DefendShipyard")==1 then
        ...
        if Player_HasResearch(0, "MarineTech") == 0 then
	        Player_UnrestrictResearchOption(0, "MarineTech")
	        Player_GrantResearchOption(0 , "MarineTech")
	      end
...
function Rule_MarineKillas()
    SobGroup_FillShipsByType("tempSobGroup_SP", "Player_Ships0", "Hgn_MarineFrigate")
    if  SobGroup_Count("tempSobGroup_SP")>=1 then
...
function Rule_Infiltrator_ReinforcementsFromCarrier()
    SobGroup_FillShipsByType("tempSobGroup_SP", "Player_Ships1", "Vgr_InfiltratorFrigate")
    if  SobGroup_Count("tempSobGroup_SP")<=2 then
