...
Events.intelevent_cleardebris = 
    { 
        ...
        { HW2_Wait(3), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$43020", 8), }, 
        { 
            { "Universe_EnableSkip(1)", "", }, HW2_Letterbox(1), HW2_Wait(3), }, 
        { 
            { "Sensors_EnableCameraZoom( 0 )", "", }, 
            { "Sensors_Toggle( 1 )", "", }, 
            { "Camera_Interpolate( 'here', 'Camera_Longview', 2)", "", }, HW2_Wait(2), }, 
        { 
            { "Sensors_EnableCameraZoom( 1 )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$43021", 8), }, 
        { 
            { "g_pointer_default_1 = HW2_CreateEventPointerSobGroup('Foundry')", "", }, HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43022", 8), }, 
        { HW2_Wait(1), }, 
        { 
            { "EventPointer_Remove(g_pointer_default_1)", "", }, 
        }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43024", 8), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43025", 8), 
        ...
        { 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Sensors_EnableCameraZoom( 0 )", "", }, 
            { "Camera_Interpolate( 'here', 'Camera_EndOpening', 2)", "", }, HW2_Wait(3), }, 
        { 
            { "Sensors_EnableCameraZoom( 1 )", "", }, HW2_Wait(0.3), }, 
        { 
        ...
        { 
            { "Campaign_QuickSaveNb( g_save_id, '$6429' )", "", }, 
        }, 
    }
Events.intelevent_probe = 
    { 
        ...
        { 
            { "Camera_FocusSave()", "", }, 
            { "Sensors_Toggle( 1 )", "", }, HW2_Pause(1), 
            { "FOW_RevealGroup('Command', 1)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$43030", 8), }, 
        { 
            { "Camera_Interpolate( 'here', 'Camera_Probe_Long', 3)", "", }, 
            { "SobGroup_Move( 1, 'Command', 'probe_dest' )", "", }, 
            { "SobGroup_SetSpeed('Command', 0.5 )", "", }, 
            { "g_pointer_default_2 = HW2_CreateEventPointerSobGroup('Command' )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$43031", 8), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43032", 8), 
            { "ping_probe_id = Ping_AddSobGroup( ping_probe, 'anomaly', 'Command' )", "", }, 
            { "Ping_AddDescription(ping_probe_id, 0, '$43124')", "", }, 
        }, 
        { 
            { "EventPointer_Remove(g_pointer_default_2)", "", }, HW2_Wait(1), }, 
...
Events.intelevent_vaygrincoming = 
    { 
        ...
        { 
            ...
            { "Sensors_EnableCameraZoom( 0 )", "", }, HW2_Letterbox(1), HW2_Wait(3), }, 
        { 
            { "Sensors_Toggle( 1 )", "", }, 
            { "Camera_Interpolate( 'here', 'Camera_Carrier_Entry', 2)", "", }, 
            { "Sound_MusicPlayType( 'data:sound/music/staging/STAGING_01', MUS_Staging )", "", }, HW2_Wait(2), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43045", 8), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43046", 8), }, 
        { HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43047", 8), }, 
        { 
            { "Sensors_Toggle( 0 )", "", }, HW2_Wait(0.3), }, 
...
Events.intelevent_radiationdamage = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_Letterbox(1), HW2_Wait(2), HW2_Pause(1), 
            { "EventPlaying = 1", "", }, 
        }, 
        { 
            { "Sensors_Toggle( 1 )", "", }, HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43049", 8), }, 
        { HW2_Wait(1), }, 
        { 
            { "Camera_Interpolate( 'here', 'Camera_All_Hulks', 2)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$43052", 8), 
...
Events.intelevent_radiationdamage_end_with_mover = 
    { 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43061", 8), }, 
        { HW2_Pause(0), HW2_Letterbox(0), 
            { "Sensors_Toggle( 0 )", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
...
Events.intelevent_chunksscouted = 
    { 
        ...
        { 
            ...
            { "FOW_ForceUpdate()", "", }, 
            { "Camera_FocusSobGroupWithBuffer('Mover_'..g_mover_investigated, 3000, 100, 2)", "", }, HW2_Wait(2), }, 
        { 
            { "Sensors_EnableCameraZoom( 1)", "", }, 
            { "g_pointer_default_1 = HW2_CreateEventPointerSobGroup('Mover_'..g_mover_investigated)", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$43053", 8), }, 
        { 
            { "EventPointer_Remove(g_pointer_default_1)", "", }, HW2_Wait(1), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43055", 8), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43056", 8), 
...
Events.intelevent_moversundercontrol = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, 
            { "EventPlaying = 1", "", }, HW2_Wait(2), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$43060", 8), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43057", 8), }, 
        { 
            ...
            { "Ping_AddDescription(ping_chunk_7_id, 0, '$43120')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$43051", 8), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        ...
        { 
            { "Campaign_QuickSaveNb( g_save_id, '$6430' )", "", }, 
        }, 
        { HW2_Wait(15), }, 
        { 
            { "EventPlaying = 0", "", }, 
...
Events.speechevent_destroyvaygr = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, 
            { "EventPlaying = 1", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$43090", 10), }, 
        { 
...
Events.speechevent_probeaway = 
    { 
        { 
            { "EventPlaying = 1", "", }, 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$43035", 8), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43036", 8), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_probecaught = 
    { 
        { 
            { "EventPlaying = 1", "", }, 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$43040", 8), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43041", 8), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43042", 8), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_destroyfirstdebris = 
    { 
        { 
            { "EventPlaying = 1", "", }, 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$43065", 8), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43066", 8), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
        }, 
...
Events.speechevent_clearedradiation = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, 
            { "Sound_MusicPlayType( 'data:sound/music/ambient/AMB_07', MUS_Ambient )", "", }, HW2_SubTitleEvent(Actor_FleetIntel, "$43075", 8), }, 
        { HW2_SubTitleEvent(Actor_FleetIntel, "$43076", 8), }, 
        { HW2_Wait(5), }, 
        { 
            { "Sound_ExitIntelEvent()", "", }, 
            { "Sound_SetMuteActor('')", "", }, 
...
Events.intelevent_lets_go = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$43080", 8), }, 
        { HW2_Wait(1), }, 
        { 
            { "Universe_EnableSkip(1)", "", }, 
            { "Sensors_Toggle( 0 )", "", }, HW2_Letterbox(1), HW2_Wait(2), }, 
        { 
            { "Camera_FocusSobGroupWithBuffer( Players_Mothership, 2000, 2000, 2)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$43081", 8), }, 
        ...
        { HW2_SubTitleEvent(Actor_FleetCommand, "$43082", 8), }, 
        { 
...
function Rule_Init()
    ...
    Player_SetPlayerNameAdvanced(1, "Vaygr Forward Assault")
    Player_SetPlayerNameAdvanced(2, "Progenitor")
    Player_SetPlayerNameAdvanced(3, "Progenitor Relic")
...
function Rule_AI_Init()
    ...
    CPU_Enable(2, 0)
    CPU_Enable(3, 1)
    Player_GrantResearchOption_Smart(1, "VaygrRadiationImmunityHack")
    Player_GrantResearchOption_Smart(2, "VaygrRadiationImmunityHack")
    for i = 1,7,1 do
...
function AI_BulkResearchGrant(AI_Number)
    ...
    Player_GrantResearchOption(AI_Number, "CapitalTech")
    Player_GrantResearchOption(AI_Number, "ImprovedTorpedoShipyard")
    Player_GrantResearchOption(AI_Number, "ImprovedTorpedoDestroyer")
    Player_GrantResearchOption(AI_Number, "MineDestroyer")
end
...
function Rule_ReInit()
    ...
    Rule_AddInterval("Rule_Probe_Fire_Anyway", 300)
...
function Rule_Movers_Built()
    if  SobGroup_GetHardPointHealth("Players_Mothership", "MoverConstruction 1")>0 then
        ...
        Rule_RandomInterval("Rule_Movers_Spam", 6, 1)
...
function Rule_Movers_Spam()
		if SobGroup_GetHardPointHealth("Players_Mothership", "MoverConstruction 1")>0 then
			if Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(g_playerID, "kpr_mover")<10 then
				SobGroup_CreateShip("Players_Mothership", "kpr_mover")
			end
		end
end

function Rule_Movers_Actually_Built()
    if  Player_GetNumberOfSquadronsOfTypeAwakeOrSleeping(g_playerID, "kpr_mover")>=1 then 		--Stats_ShipsCreated(g_playerID)>=1 then
