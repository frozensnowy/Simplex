...
function Rule_PlayerWins()
	if (SobGroup_GetHardPointHealth("EnyGroup", "Production 1") == 0) then
...
{ 
	{ 
		...
		HW2_LocationCardEvent( "Postmortem Tutorial - Mission 6", 5 ), 
	}, 
	{ 
		HW2_Letterbox( 1 ), 
		HW2_Wait( 2 ), 
	...
	{
		{
			[[obj_prim_newobj_id = Objective_Add( "Destroy Enemy Subsystem", OT_Primary )]],
			[[]]
		}, 
		{
			[[Objective_AddDescription( obj_prim_newobj_id, "Destroy the carrier's fighter module to win the mission.")]],
			[[]]
		}, 
		HW2_SubTitleEvent( Actor_FleetIntel, "Destroy the carrier's fighter module to win the mission.", 4 ),
	},
	{
		HW2_Wait( 1 ), 
	},
