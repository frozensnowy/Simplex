...
{ 
    ...
    id = 0, 
    desc = "$50303", }
objectives.selectfocus = 
{ 
    title = "$50004", 
    id = 0, 
    desc = NIL, }
objectives.selectboth = 
{ 
    title = "$50005", 
    id = 0, 
    desc = "$50305", }
...
Events.intelevent_intro = 
    { 
        ...
        --
       --   { "UI_FlashButton('SubtitleInputScreen', 'btnSubtitleOk', -1)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50030", 5), HW2_Wait(2), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$50350", 5), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$50351", 5), }, 
        { 
        ...
        { HW2_SubTitleEvent(Actor_FleetCommand, "$50410", 5), }, --50410	You can minimize the Taskbar by clicking on the flashing icon or pressing BACKSPACE.
        { HW2_SubTitleEvent(Actor_FleetCommand, "$50411", 5), }, --Do this now.
        { 
            { "Sound_SetMuteActor('')", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
        }, 
		{ 
            { "Introductionfinished = 1", "", }, 
            { "EventPlaying = 0", "", }, 
			{ "Taskbardown = 0", "", }
        }, 
    }
...
Events.intelevent_intro_objectives = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetCommand, "$50420", 5), HW2_Wait(1), }, 
...
Events.intelevent_ATI = 
    { 
        ...
        { 
            { "showGraphic('gfc1',1)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50423", 5), }, 
        { 
            { "showGraphic('gfc2',1)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50424", 5), }, 
        { 
            { "showGraphic('gfc3',1)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50425", 5), }, 
...
Events.intelevent_selection = 
    { 
        ...
        { 
            ...
            { "Camera_FocusSobGroupWithBuffer( 'Carrier', 500, 500, 2)", "", }, 
        }, 
        ...
        { 
            { "Camera_FocusSobGroupWithBuffer (Scout_2, 400, 400, 3)", "", }, 
            { "SobGroup_DeSelectAll()", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50081", 5), }, 
        { 
            { "Sound_SetMuteActor('')", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
        }, 
...
Events.intelevent_dragselection = 
    { 
        ...
        { 
            { "EventPointer_Remove(scout2_ptr_id)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50087", 1), HW2_Wait(3), }, 
        { 
        ...
        { 
            { "addObjective('selectboth')", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50090", 5), }, 
        { 
            { "Sound_SetMuteActor('')", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
        }, 
...
Events.intelevent_dragselection_active = 
    { 
        ...
        { 
            { "SobGroup_DeSelectAll()", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50091", 1), }, 
        { 
            { "Sound_SetMuteActor('')", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
        }, 
...
Events.intelevent_rotate = 
    { 
        ...
        { 
            { "Universe_AllowSelect(0)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50040", 5), }, 
        { 
            { "UI_FlashButton('NewTaskbar', 'btnShip01', -1)", "", }, 
            { "UI_FlashButton('NewTaskbar', 'btnShip02', -1)", "", }, 
        }, 
        { 
            { "UI_ShowScreen('NewTaskbar',1)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50097", 5), }, 
...
Events.dialogevent_basics_end = 
    { 
        ...
        { 
            { "Universe_AllowSelect(1)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50070", 2), }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$50071", 5), }, 
        { HW2_Wait(1), HW2_SubTitleEvent(Actor_FleetCommand, "$50072", 5), }, 
        { 
            { "Sound_SetMuteActor('')", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
        }, 
...
Events.intelevent_sensors2 = 
    { 
        ...
        { 
            ...
            { "scout2_ptr_id = EventPointer_AddSobGroup(Scout_2, 65280, 0.05)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50131", 5), }, 
        { 
            { "asteroid_ptr_id2 = EventPointer_AddVolume('Asteroid_Volume', 65280, 4.0)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50132", 5), 
            { "EventPointer_Remove(scout1_ptr_id)", "", }, 
            { "EventPointer_Remove(scout2_ptr_id)", "", }, 
        }, 
        { 
            { "asteroid_ptr_id = HW2_PingCreateWithLabelPoint ( '$50015', 'Asteroid_Volume' )", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50133", 1), }, 
...
Events.intelevent_relativemove = 
    { 
        ...
        { 
            ...
            { "Camera_AltFocusWithVolume('sob_BothFighters',1,'AsteroidPtr_Volume')", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50150", 3), }, 
        { 
            { "Sound_SetMuteActor('')", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
        }, 
...
Events.intelevent_relativemoveIssued = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetCommand, "$50153", 5), }, 
...
Events.intelevent_relativemove2 = 
    { 
        ...
        { 
            { "Camera_ZoomClose(0)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50164", 5), }, 
        { 
            { "Sound_SetMuteActor('')", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
        }, 
...
Events.intelevent_relativemove2_active = 
    { 
        ...
        { 
            ...
            { "Camera_ZoomClose(0)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50164", 1), }, 
        { 
...
Events.intelevent_movediscdone = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetCommand, "$50173", 5), HW2_Wait(3), }, 
...
Events.intelevent_complete = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetCommand, "$50181", 5), HW2_Wait(2), }, 
        { 
            { "UI_SetElementEnabled('InGameMenu', 'm_btnNextTutorial', 0)", "", }, 
...
function Rule_IntroTaskbar()
    ...
    if  Event_IsDone("intelevent_intro")==1 and Taskbardown==0 then
	print("Testing if this is running already. It shouldn't")
        Event_Start("intelevent_intro_taskbar_active")
        UI_StopFlashButton("NewTaskbar", "btnHide1")
		if  EventPlaying==0 and Introductionfinished==1 then
		print("Testing if this is called at start of level or not")
...
function Rule_MoveDisc3DShipSelect()
    local sel1 = SobGroup_Selected(Scout_1)
    local sel2 = SobGroup_Selected(Scout_2)
    local sel3 = SobGroup_Selected("Carrier")
