...
{ 
    ...
    id = 0, 
    desc = "$50513", }
objectives.researchm = 
{ 
    title = "$50502", 
    id = 0, 
    desc = "$50514", }
objectives.researchs = 
{ 
    title = "$50503", 
    id = 0, 
    desc = "$50515", }
objectives.researcho = 
{ 
    title = "$50504", 
    id = 0, 
    desc = "$50516", }
objectives.researchp = 
{ 
    title = "$50505", 
    id = 0, 
    desc = "$50517", }
...
Events.intelevent_researchmodule = 
    { 
        ...
        { HW2_SubTitleEvent(Actor_FleetCommand, "$50534", 3), HW2_Wait(3), }, 
        { 
            { "Camera_FocusSobGroup( 'Carrier' , 0, 150, 2)", "", }, 
            { "carrier_ptr_id = EventPointer_AddSobGroup('Carrier', 65280, 0.05)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50540", 5), }, 
        { 
...
Events.intelevent_researchmodule_buildopened = 
    { 
        ...
        { 
            { "UI_FlashButton('NewBuildMenu', 'btnItemHgn_Scout', -1)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50541", 4), 
            { "addObjective('scouts')", "", }, 
        }, 
        { 
            { "Sound_SetMuteActor('')", "", }, 
...
Events.intelevent_subsystem = 
    { 
        ...
        { 
            ...
            { "SobGroup_SelectSobGroup( 'ResearchStation' )", }, 
            { "Camera_FocusSobGroup( 'ResearchStation' , 0, 150, 2)", }, 
        }, 
        { 
            { "UI_ShowScreen('NewBuildMenu',1)", "", }, 
            { "UI_FlashButton('NewBuildMenu', 'SubSystemModuleResearch', 10)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50560", 5), }, 
        { 
        ...
        { 
            { "UI_ShowScreen('NewBuildMenu',1)", "", }, 
            { "Player_UnrestrictBuildOption( 0, 'Research' )", "", }, 
            { "UI_FlashButton('NewBuildMenu', 'btnItemHgn_MS_Module_Research', -1)", "", }, 
        }, 
...
Events.intelevent_subsystemdone = 
    { 
        { 
            { "Sound_EnterIntelEvent()", "", }, 
            { "Sound_SetMuteActor('Fleet')", "", }, 
            { "UI_StopFlashButton('NewBuildMenu', 'btnItemHgn_MS_Module_Research')", "", }, 
        }, 
        { 
            { "HW2_Wait(1)", "", }, 
            { "Camera_FocusSobGroup( 'ResearchStation' , 1, 10, 1)", "", }, 
        }, 
        { 
            { "researchmod_ptr_id = HW2_CreateEventPointerSubSystem('Hgn_MS_Module_Research', 'ResearchStation')", "", }, 
            { "UI_HideScreen('NewBuildMenu')", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50565", 5), }, 
        { 
...
Events.intelevent_researchmenu = 
    { 
        ...
        { 
            { "Player_UnrestrictResearchOption( 0, 'ScoutPingAbility' )", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50580", 5), }, 
...
Events.intelevent_unlockingtech = 
    { 
        ...
        { 
            { "UI_HideScreen('NewResearchMenu')", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50596", 5), }, 
        ...
        { 
            { "bomber_ptr_id = EventPointer_AddSobGroup(BomberSquad, 65280, 0.05)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$50601", 5), }, 
        { 
            { "Sound_SetMuteActor('')", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
        }, 
...
function OnInit()
	...
	SobGroup_Create("Station_Research")
    ...
    SobGroup_CreateSubSystem("Carrier", "AdvancedArray")
	SobGroup_CreateSubSystem("Carrier", "Hgn_C_Module_Mine") -- harvest control module. Might help resourcing?
	
    Resourcer = SobGroup_CreateShip("Carrier", "Hgn_ResourceCollector")
	Station = SobGroup_CreateShip("Carrier", "hgn_researchstation")
    SobGroup_FillUnion("RC_Carrier", "Carrier", Resourcer)
	SobGroup_FillUnion("RC_Carrier", "Carrier", Station)
	Player_FillShipsByType("Station_Research", 2, "hgn_researchstation")
	SobGroup_CreateSubSystem("Station_Research", "Hgn_MS_Module_Research") -- Research Division
	SobGroup_CreateSubSystem("Station_Research", "Hgn_MS_Module_ResearchAdvanced") -- Science Division
	SobGroup_CreateSubSystem("Station_Research", "Hgn_MS_Module_ResearchAdvanced1") -- Engineering Division
	
    Rule_Add("checkspcl")
    Player_SetRU(0, 2500)
    Rule_Add("Rule_Harvest")
    SinglePlayer_OnInit()		--Simplex Oninit
end
...
function Rule_Harvest()
	--	Player_RestrictBuildOption( 0, "Research" )
		Player_RestrictResearchOption( 0, "ScoutPingAbility" )
...
function Rule_Building()
    ...
    SobGroup_FillShipsByType("tempSobGroup_SP", "Player_Ships0", "Hgn_Scout")
    if  Event_IsDone("intelevent_researchmodule_buildopened")==1 and hasQueued==1 or SobGroup_Count("tempSobGroup_SP")>=3 then
...
function Rule_Subsystem()
    SobGroup_FillShipsByType("tempSobGroup_SP", "Player_Ships0", "Hgn_Scout")
    if  Event_IsDone("intelevent_building")==1 and SobGroup_Count("tempSobGroup_SP")>=3 then
        UI_ShowScreen("NewBuildMenu", 1)
...
function Rule_SubsystemWait()
    if  SobGroup_ResearchModuleExistOrSelected("ResearchStation")>0 then
...
function Rule_Research()
    local rslt = SobGroup_ResearchModuleExistOrSelected("ResearchStation")
...
function Rule_ResearchCarrierSelected()
    if  Event_IsDone("intelevent_research")==1 and SobGroup_Selected("ResearchStation")==1 then
...
function Rule_Attacking()
    ...
    local bomberCount = SobGroup_Count("tempSobGroup_SP")
    if  Event_IsDone("intelevent_unlockingtech")==1 and Player_HasQueuedBuild(0, "Hgn_AttackBomber")==1 or bomberCount>=1 then
        ...
        SobGroup_FillUnion("bomberDrone", "tempSobGroup_SP", "EnemyFrigate")
