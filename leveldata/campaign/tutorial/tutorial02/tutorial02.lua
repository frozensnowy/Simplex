...
Events.intelevent_intro = 
    { 
        ...
        { 
            ...
            { "SobGroup_ExitHyperSpace ('ResearchStation', 'StartVolume2')", "", }, 
        }, 
        { 
            { "HW2_Wait(2)", "", }, 
        }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$50529", 5), HW2_Wait(4), }, 
        { 
            { "HW2_Wait(4)", "", }, 
        }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$50530", 6), }, 
...
Events.intelevent_researchmodule_buildopened = 
    { 
		...
		{ HW2_SubTitleEvent(Actor_FleetCommand, "$505431", 7), }, 
...
Events.intelevent_techtree = 
    { 
        ...
        { 
            ...
            HW2_SubTitleEvent(Actor_FleetCommand, "$50590", 5), HW2_Wait(4), }, 
...
function Rule_SubsystemWait()
    if  Event_IsDone("intelevent_subsystem")==1 and SobGroup_ResearchModuleExistOrSelected("ResearchStation")>0 then
...
function Rule_Attacking()
    ...
    if  Event_IsDone("intelevent_unlockingtech")==1 and bomberCount>=2 then --Player_HasQueuedBuild(0, "Hgn_AttackBomber")==1 or bomberCount>=2 then
        Sound_EnableAllSpeech(1)
