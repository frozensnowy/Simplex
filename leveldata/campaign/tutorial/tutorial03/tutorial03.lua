...
Events.intelevent_attack = 
    { 
        ...
        { 
            { "ping_frigate_attack_id = HW2_PingCreateWithLabel( ping_frigate_attack, 'Frigate' )", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$51060", 5), }, 
        { 
            { "Sound_SetMuteActor('')", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
        }, 
...
Events.intelevent_3dmovement = 
    { 
        ...
        { 
            ...
            { "Sensors_FlashWorldPlane(1)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$51080", 5), HW2_Wait(1), 
...
Events.intelevent_specialcommands = 
    { 
        ...
        { 
            { "Camera_FocusSobGroup( 'Carrier', 1 , 100, 2)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$51092", 5), }, 
        { 
            { "HW2_Wait(2)", "", }, 
...
Events.intelevent_activatecloaking = 
    { 
        ...
        { 
            { "addObjective('cloakC')", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$51103", 5), }, 
        { 
            { "Sound_SetMuteActor('')", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
        }, 
...
Events.intelevent_uncloaking = 
    { 
        ...
        { 
            { "addObjective('uncloakC')", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$51112", 5), }, 
        { 
            { "Sound_SetMuteActor('')", "", }, 
            { "Sound_ExitIntelEvent()", "", }, 
        }, 
...
Events.intelevent_capture = 
    { 
        ...
        { 
            { "SobGroup_ExitHyperSpace('Marine', 'Marine_Enter' )", "", }, HW2_Wait(2), }, 
        { 
            { "completeObjective('uncloakC')", "", }, 
            { "Camera_FocusSobGroup( 'Marine', 0 , 200, 3)", "", }, HW2_SubTitleEvent(Actor_FleetCommand, "$51120", 5), }, 
        { 
            { "SobGroup_ExitHyperSpace('Frigate_2', 'Frigate_2_Enter' )", "", }, 
        }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$51121", 5), HW2_Wait(2), }, 
        { 
            { "SobGroup_FillUnion('tempSobGroup_SP','Frigate_2','Marine')", "", }, 
        ...
        { 
            { "Camera_AltFocus('tempSobGroup_SP',1)", "", }, 
        }, 
...
Events.IntelEvent_Tactics = 
    { 
        ...
        { 
            { "UI_FlashButton('NewTaskbar', 'btnTactics', 10)", "", }, 
        }, 
...
Events.IntelEvent_StikeGroupsSelected = 
    { 
        ...
        { 
            { "UI_FlashButton('NewTaskbar', 'btnStrike', 10)", "", }, 
        }, 
        { 
            { "addObjective('strike')", "", }, 
        }, 
...
Events.IntelEvent_Waypoints = 
    { 
       ...
       -- { 
            { "UI_SetElementEnabled('InGameMenu', 'm_btnNextTutorial', 0)", "Exit?", }, 
       --     { "setMissionComplete(1)", "", }, 
     --   }, 
        { HW2_SubTitleEvent(Actor_FleetCommand, "$52016", 5), }, 
...
function OnInit()
    ...
    --CreateSubsystemOnShipHardpoint("EnemyCarrier", "Production 1", "FighterProduction")
...
function Rule_Skip()
    ...
    SobGroup_FillUnion("tempSobGroup_SP", "Interceptors", "Bombers")
    HW2_Wait(3)
...
function Rule_ActivateCloaking()
    if  UI_IsNamedElementVisible("NewTaskbar", "commandButtons")==1 and Event_IsDone("intelevent_specialcommands")==1 then		-- Event_IsDone("intelevent_specialcommands")==1 and UI_IsNamedElementVisible("NewTaskbar", "specialButtons")==1
...
function Rule_CapFin()
    ...
    SobGroup_FillShipsByType("tempSobGroup_SP", "Player_Ships0", "vgr_empfrigate")
    if  Event_IsDone("intelevent_capture")==1 and SobGroup_Count("tempSobGroup_SP")==1 then
...
function Rule_IntelEvent_StrikeGroupsSelected()
    isIn = SobGroup_Selected("tempSobGroup_SP")
...
function Rule_IntelEvent_StrikeGroupsStriked()
    isIn = SobGroup_InStrikeGroup("tempSobGroup_SP")
...
function Rule_SetFin()
    if  Event_IsDone("IntelEvent_Waypoints")==1 then
        ...
        SobGroup_Clear("tempSobGroup_SP")
        Rule_AddInterval("Rule_AttackWaves", 30)
        Rule_Remove("Rule_SetFin")
        if SobGroup_Empty("Carrier") == 0 then
        	SobGroup_CreateShip("Carrier", "hgn_power")
        	SobGroup_CreateShip("Carrier", "hgn_researchstation")
        	SobGroup_CreateShip("Carrier", "hgn_crewstation")
        end
    end 
...
function Rule_AttackWaves()
    ...
    if SobGroup_Count("tempSobGroup_SP") < random(300,500) then
	    if  g_attackMode==1 then
	        for i = 1,g_attacknum,1 do
	            newShips = SobGroup_CreateShip("EnemyCarrier", "Vgr_Scout")
	            SobGroup_SobGroupAdd("tempSobGroup_SP", newShips)
	            print("****Scouts created")
	        end 
	    else
	        for i = 1,g_attacknum,1 do
	            newShips = SobGroup_CreateShip("EnemyCarrier", Table_RandomElement(vaygrboostships))		--"Vgr_Bomber"
	            SobGroup_SobGroupAdd("tempSobGroup_SP", newShips)
...
function Rule_doAttack()
    SobGroup_AttackPlayer("tempSobGroup_SP", 0)
