displayName = "IN SERVICE OF HIIGARA - HGN Expeditionary Fleet, First Invasion Era"
Mission = {}
Mission[1] =
{
    postload = function ()
    ...
    displayName = "M01 - Tanis Base: Humble Beginnings",
    description = "The newly completed mothership is prepared for launch before schedule at Tanis Base upon receiving intelligence of accelerated Vagyr mobilisation.\n\nOversee prelaunch trials and deployment of the Mothership's pursuit squadron.", }
Mission[2] =
{
    ...
    displayName = "M02 - Angel Moon Orbit: Bid for Survival",
    description = "Survivor of a crippling surprise attack, the Mothership limps home to Hiigara on a skeleton crew where she is to take on critical supplies and military personnel with which to oppose the Vagyr menace. Seven heavy transporter ships have been hastily requisitioned by the Navy and are now proceeding on sublight drives to a predesignated emergency resupply point over the Angel Moon.\n\nA Vagyr War Priestess is moving to intercept the resupply convoy, and is to be defeated in order to allow the Mothership's survival. Expect long-range fighter strikes from Vagyr carrier groups in Hiigaran high orbit.", }
Mission[3] =
{
    postload = function ()
